...
//Name: unit_11.ma
//Last modified: Thu, Nov 06, 2025 01:54:04 PM
//Codeset: UTF-8
requires maya "2026";
requires "mtoa" "5.5.3";
...
fileInfo "UUID" "5151471C-2642-52E4-EC24-2AA8F795A939";
createNode transform -s -n "persp";
	rename -uid "4403E3DC-5845-683D-460A-FABB1FDD3E55";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -12.633132253571299 9.0202868985183873 -12.677479929915901 ;
	setAttr ".r" -type "double3" -22.799999999999702 5264.400000001061 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 19.278928579580864;
	setAttr ".ow" 0.1;
...
createNode transform -n "polySurface1" -p "pCylinder3";
	...
	setAttr ".s" -type "double3" 1.0386597061205152 1.0386597061205152 1.0386597061205152 ;
...
createNode transform -n "pCylinder4";
	...
	setAttr ".s" -type "double3" 1.0386597061205152 1.2443735834433822 1.0386597061205152 ;
