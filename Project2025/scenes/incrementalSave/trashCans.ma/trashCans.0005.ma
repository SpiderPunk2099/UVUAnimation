...
//Name: trashCans.ma
//Last modified: Fri, Feb 27, 2026 09:00:28 PM
//Codeset: UTF-8
...
fileInfo "UUID" "E7B4A1A9-924F-70FB-4D67-6BB3B93D7191";
createNode transform -s -n "persp";
	rename -uid "8D623A72-7847-520B-AE28-149770AEA97E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.7865604136760345 2.000307347744509 3.6821991683428377 ;
	setAttr ".r" -type "double3" -24.33835273041144 5.7999999999999412 1.9980754056985062e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 3.9143517200753015;
	setAttr ".ow" 0.1;
