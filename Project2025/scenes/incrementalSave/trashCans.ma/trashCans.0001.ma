...
//Name: trashCans.ma
//Last modified: Fri, Feb 27, 2026 07:46:19 PM
//Codeset: UTF-8
...
fileInfo "UUID" "3B368FC8-C44F-1638-A1B3-52A7DB8DB4D3";
createNode transform -s -n "persp";
	rename -uid "8D623A72-7847-520B-AE28-149770AEA97E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -4.1145422453108225 0.70692252991494253 1.0568417573621349 ;
	setAttr ".r" -type "double3" -7.5383527296034103 -84.599999999999923 -8.4491862868127505e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 3.2604548914842901;
	setAttr ".ow" 0.1;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr -s 55 ".pt";
	setAttr ".pt[32]" -type "float3" -0.044761095 0 0 ;
	setAttr ".pt[33]" -type "float3" -0.044761095 0 0 ;
	setAttr ".pt[34]" -type "float3" -0.042174906 0 0 ;
	setAttr ".pt[35]" -type "float3" -0.035109311 0 0 ;
	setAttr ".pt[36]" -type "float3" -0.025457613 0 0 ;
	setAttr ".pt[37]" -type "float3" 0.025457649 0 0 ;
	setAttr ".pt[38]" -type "float3" 0.035109356 0 0 ;
	setAttr ".pt[39]" -type "float3" 0.042174917 0 0 ;
	setAttr ".pt[40]" -type "float3" 0.044761095 0 0 ;
	setAttr ".pt[41]" -type "float3" 0.044761095 0 0 ;
	setAttr ".pt[42]" -type "float3" 0.042174917 0 0 ;
	setAttr ".pt[43]" -type "float3" 0.035109356 0 0 ;
	setAttr ".pt[44]" -type "float3" 0.025457649 0 0 ;
	setAttr ".pt[45]" -type "float3" -0.025457613 0 0 ;
	setAttr ".pt[46]" -type "float3" -0.035109311 0 0 ;
	setAttr ".pt[47]" -type "float3" -0.042174906 0 0 ;
	setAttr ".pt[48]" -type "float3" -0.044761095 0 0 ;
	setAttr ".pt[49]" -type "float3" -0.044761095 0 0 ;
	setAttr ".pt[50]" -type "float3" -0.042174898 0 0 ;
	setAttr ".pt[51]" -type "float3" -0.035109323 0 0 ;
	setAttr ".pt[52]" -type "float3" -0.025457611 0 0 ;
	setAttr ".pt[53]" -type "float3" 0.025457639 0 0 ;
	setAttr ".pt[54]" -type "float3" 0.035109356 0 0 ;
	setAttr ".pt[55]" -type "float3" 0.042174917 0 0 ;
	setAttr ".pt[56]" -type "float3" 0.044761095 0 0 ;
	setAttr ".pt[57]" -type "float3" 0.044761095 0 0 ;
	setAttr ".pt[58]" -type "float3" 0.042174917 0 0 ;
	setAttr ".pt[59]" -type "float3" 0.035109356 0 0 ;
	setAttr ".pt[60]" -type "float3" 0.025457639 0 0 ;
	setAttr ".pt[61]" -type "float3" -0.025457611 0 0 ;
	setAttr ".pt[62]" -type "float3" -0.035109323 0 0 ;
	setAttr ".pt[63]" -type "float3" -0.042174898 0 0 ;
	setAttr ".pt[64]" -type "float3" -0.069119498 0 0 ;
	setAttr ".pt[65]" -type "float3" -0.069119498 0 0 ;
	setAttr ".pt[66]" -type "float3" -0.065125935 0 0 ;
	setAttr ".pt[67]" -type "float3" -0.054215357 0 0 ;
	setAttr ".pt[68]" -type "float3" -0.039311305 0 0 ;
	setAttr ".pt[69]" -type "float3" 0.039311353 0 0 ;
	setAttr ".pt[70]" -type "float3" 0.054215401 0 0 ;
	setAttr ".pt[71]" -type "float3" 0.065125957 0 0 ;
	setAttr ".pt[72]" -type "float3" 0.069119498 0 0 ;
	setAttr ".pt[73]" -type "float3" 0.069119498 0 0 ;
	setAttr ".pt[74]" -type "float3" 0.065125957 0 0 ;
	setAttr ".pt[75]" -type "float3" 0.054215401 0 0 ;
	setAttr ".pt[76]" -type "float3" 0.039311353 0 0 ;
	setAttr ".pt[77]" -type "float3" -0.039311305 0 0 ;
	setAttr ".pt[78]" -type "float3" -0.054215357 0 0 ;
	setAttr ".pt[79]" -type "float3" -0.065125935 0 0 ;
