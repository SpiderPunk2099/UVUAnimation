...
//Name: fkLampRig.ma
//Last modified: Mon, Feb 09, 2026 09:47:09 PM
//Codeset: UTF-8
...
fileInfo "UUID" "B2194DCF-BE4F-66F4-7618-1DBA45ECBB9A";
createNode transform -s -n "persp";
	rename -uid "08C08C45-8641-AFC2-67E9-3FBF39B40908";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 27.11571675346638 3.8124706073155323 5.8503647855057528 ;
	setAttr ".r" -type "double3" 15.60000000000012 81.20000000000077 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 26.515697325997373;
...
createNode joint -n "tip_Joint" -p "base_Joint";
	...
	setAttr ".t" -type "double3" 0 1.4840874488152069 1.4791141972893971e-31 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
...
createNode fosterParent -n "lamp_modelRNfosterParent1";
	rename -uid "D1E026FC-6143-0E08-2737-BDB43BCE976E";
