...
//Name: fkLampRig.ma
//Last modified: Mon, Feb 09, 2026 09:42:43 PM
//Codeset: UTF-8
...
fileInfo "UUID" "0479DF3C-8D4F-0456-0555-15848DB4D8CB";
createNode transform -s -n "persp";
	rename -uid "08C08C45-8641-AFC2-67E9-3FBF39B40908";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -60.809424024996972 5.4785854538556675 1.7583805342548189 ;
	setAttr ".r" -type "double3" 8.39999999999986 -91.599999999999952 -5.0888874903416268e-14 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 58.901053413281751;
...
createNode joint -n "arm_Joint_1";
	...
	setAttr ".t" -type "double3" 0 3.09827080144494 -0.063165860126180667 ;
...
createNode joint -n "tip_Joint" -p "base_Joint";
	...
	setAttr ".t" -type "double3" -5.6898930012039273e-16 1.4840874488152069 9.8607613152626476e-32 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
...
createNode fosterParent -n "lamp_modelRNfosterParent1";
	rename -uid "75888F96-8745-323F-E473-43948E6E29EC";
...
createNode reference -n "lamp_modelRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		" 2"
		2 "lamp_model:geo_layer" "visibility" " 0"
