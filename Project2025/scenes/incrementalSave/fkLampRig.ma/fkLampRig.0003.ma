...
//Name: fkLampRig.ma
//Last modified: Mon, Feb 09, 2026 09:44:51 PM
//Codeset: UTF-8
...
fileInfo "UUID" "F0E2C8D2-2948-752A-B3E8-2ABCBFDF6F56";
...
createNode joint -n "tip_Joint" -p "base_Joint";
	...
	setAttr ".t" -type "double3" 0 1.4840874488152069 9.8607613152626476e-32 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
...
createNode fosterParent -n "lamp_modelRNfosterParent1";
	rename -uid "2E2D2135-784F-EE44-3842-8B8270E6C63F";
