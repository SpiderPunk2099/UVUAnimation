...
//Last modified: Sun, Feb 01, 2026 07:18:37 PM
//Codeset: UTF-8
...
fileInfo "UUID" "5EFA7838-4146-D099-9B69-EA9785F0B762";
createNode transform -s -n "persp";
	rename -uid "BEF3ED4B-C145-D9C8-D984-8887B9622330";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.34574428217309716 1.5579510820979539 24.760509369655672 ;
	setAttr ".r" -type "double3" -3.5999999999999845 0.79999999999999061 1.0872096277264068e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "020769EC-CD45-02FB-C381-93AB74B04498";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 24.811883924142698;
...
createNode transform -n "pPlane1";
	...
	setAttr ".t" -type "double3" 0 -1.8509879976862427 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "EB65EB0E-B64A-F29A-6C0D-3488E130A15C";
	setAttr -s 8 ".lnk";
	setAttr -s 8 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "3062E03B-F040-F0D9-5127-C7B1477E3666";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "1422A838-C84B-595B-3B7F-328BC114301D";
createNode displayLayerManager -n "layerManager";
	rename -uid "8B28913A-7F4C-3BC1-14C5-508D7E560BA3";
createNode displayLayer -n "defaultLayer";
	rename -uid "35BA30C9-994A-D229-AE90-38A9F454D9E6";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "043ECBED-1143-1A2A-7E69-1E89565F8F3F";
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 44 -max 62 -ast 2 -aet 160 ";
	setAttr ".st" 6;
createNode reference -n "Ultimate_Ball_v1_0_1RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" 0 0.36305827166618787 -0.25539734977563389"
		2 "|Ultimate_Ball_v1_0_1:AniM_ball_Main|Ultimate_Ball_v1_0_1:ball_Grp|Ultimate_Ball_v1_0_1:CNT_Grp|Ultimate_Ball_v1_0_1:CTRL_Top_Grp|Ultimate_Ball_v1_0_1:CTRL_Top" 
		"translateY" " -av"
		2 "|Ultimate_Ball_v1_0_1:AniM_ball_Main|Ultimate_Ball_v1_0_1:ball_Grp|Ultimate_Ball_v1_0_1:CNT_Grp|Ultimate_Ball_v1_0_1:CTRL_Top_Grp|Ultimate_Ball_v1_0_1:CTRL_Top" 
		"translateZ" " -av"
		...
		"translate" " -type \"double3\" 0 -0.023546562873576683 0.0061103772813775508"
		...
		"translate" " -type \"double3\" 0 0.031384250918947476 8.64485458255376216"
		2 "|Ultimate_Ball_v1_0_1:AniM_ball_Main|Ultimate_Ball_v1_0_1:ball_Grp|Ultimate_Ball_v1_0_1:CNT_Grp|Ultimate_Ball_v1_0_1:CTRL_Main_Grp|Ultimate_Ball_v1_0_1:CTRL_Main" 
		"translateY" " -av"
		2 "|Ultimate_Ball_v1_0_1:AniM_ball_Main|Ultimate_Ball_v1_0_1:ball_Grp|Ultimate_Ball_v1_0_1:CNT_Grp|Ultimate_Ball_v1_0_1:CTRL_Main_Grp|Ultimate_Ball_v1_0_1:CTRL_Main" 
		"translateZ" " -av"
		2 "|Ultimate_Ball_v1_0_1:AniM_ball_Main|Ultimate_Ball_v1_0_1:ball_Grp|Ultimate_Ball_v1_0_1:CNT_Grp|Ultimate_Ball_v1_0_1:CTRL_Main_Grp|Ultimate_Ball_v1_0_1:CTRL_Main" 
		"rotate" " -type \"double3\" 27.57811197557823846 0 0"
		2 "|Ultimate_Ball_v1_0_1:AniM_ball_Main|Ultimate_Ball_v1_0_1:ball_Grp|Ultimate_Ball_v1_0_1:CNT_Grp|Ultimate_Ball_v1_0_1:CTRL_Main_Grp|Ultimate_Ball_v1_0_1:CTRL_Main" 
		"rotateX" " -av"
...
createNode animCurveTL -n "CTRL_Main_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 18 ".ktv[0:17]"  2 0 7 0 10 0 13 0 16 0 19 0 22 0 25 0 28 0
		 31 0 34 0 37 0 41 0 44 0 47 0 50 0 53 0 59 0;
createNode animCurveTL -n "CTRL_Main_translateY";
	rename -uid "7019C399-6F47-7024-9EAC-8696B2A8AFE7";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 18 ".ktv[0:17]"  2 -1.8859221422663968 7 -1.8859221422663968
		 ...
		 47 -0.38997699740891667 50 -1.1360124366309341 53 -1.8972288588793895 59 0.031384250918947476;
createNode animCurveTL -n "CTRL_Main_translateZ";
	rename -uid "E6874F78-DC46-DD0E-5505-F7953694C1CC";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 18 ".ktv[0:17]"  2 0 7 0 10 0.82692135945353584 13 0.82692135945353584
		 ...
		 53 7.5449760988493715 59 8.6448545825537622;
createNode animCurveTA -n "CTRL_Main_rotateX";
	rename -uid "842830E2-254C-0DD4-C3A0-F9B68F51F09D";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 18 ".ktv[0:17]"  2 0 7 12.959007203081136 10 12.959007203081136
		 13 12.959007203081136 16 -13.843868634890008 19 -20.817946450003081 22 -9.5636930471646089
		 25 5.7910204441757083 28 23.31287381446165 31 23.31287381446165 34 0.47411531810499702
		 37 3.1734486197942999 41 14.54747981692827 44 23.052102979619953 47 -10.425883898616387
		 50 -9.2707418391758214 53 2.8840179767084924 59 27.578111975578238;
createNode animCurveTA -n "CTRL_Main_rotateY";
	rename -uid "C868D2E9-874D-5385-AAD3-908C37307611";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 0 7 0 50 0;
createNode animCurveTA -n "CTRL_Main_rotateZ";
	rename -uid "984356D3-4E4C-476B-E207-1CBEB83B9BE5";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 0 7 0 50 0;
createNode animCurveTL -n "CTRL_Top_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 19 ".ktv[0:18]"  2 0 7 0 10 0 13 0 16 0 19 0 22 0 25 0 28 0
		 31 0 34 0 37 0 41 0 44 0 47 0 50 0 53 0 56 0 59 0;
createNode animCurveTL -n "CTRL_Top_translateY";
	rename -uid "7D313D66-3940-4B3F-9333-F186ADC33E96";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 19 ".ktv[0:18]"  2 0 7 0.23226974008745663 10 0.090261194420439908
...
createNode animCurveTL -n "CTRL_Top_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 19 ".ktv[0:18]"  2 0 7 -0.060858264920163739 10 -0.028180007896709908
...
connectAttr "CTRL_Main_translateY.o" "Ultimate_Ball_v1_0_1RN.phl[4]";
connectAttr "CTRL_Main_translateX.o" "Ultimate_Ball_v1_0_1RN.phl[5]";
connectAttr "CTRL_Main_translateZ.o" "Ultimate_Ball_v1_0_1RN.phl[6]";
connectAttr "CTRL_Main_rotateX.o" "Ultimate_Ball_v1_0_1RN.phl[7]";
connectAttr "CTRL_Main_rotateY.o" "Ultimate_Ball_v1_0_1RN.phl[8]";
connectAttr "CTRL_Main_rotateZ.o" "Ultimate_Ball_v1_0_1RN.phl[9]";
