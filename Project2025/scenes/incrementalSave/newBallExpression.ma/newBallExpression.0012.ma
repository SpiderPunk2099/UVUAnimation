...
//Last modified: Mon, Feb 02, 2026 06:52:51 PM
//Codeset: UTF-8
...
fileInfo "UUID" "862F536F-2443-7DE0-A368-E3AB3546DBA6";
createNode transform -s -n "persp";
	rename -uid "BEF3ED4B-C145-D9C8-D984-8887B9622330";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 7.0412182631217011 0.71060911724027986 24.951741029758729 ;
	setAttr ".r" -type "double3" -4.8000000000000362 48.00000000000032 -5.941580483761694e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "020769EC-CD45-02FB-C381-93AB74B04498";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 23.145628851974585;
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 67 -max 108 -ast 2 -aet 160 ";
	setAttr ".st" 6;
...
createNode animCurveTL -n "CTRL_Main_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 31 ".ktv[0:30]"  2 0 7 0 10 0 13 0 16 0 19 0 22 0 25 0 28 0
		 31 0 34 0 37 0 41 0 44 0 47 0 50 0 53 0 59 0 62 0 65 0 68 0 71 0 74 0 77 0 80 0 83 0
		 86 0 89 0 92 0 95 0 98 0;
createNode animCurveTL -n "CTRL_Main_translateY";
	rename -uid "7019C399-6F47-7024-9EAC-8696B2A8AFE7";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 31 ".ktv[0:30]"  2 -1.8859221422663968 7 -1.8859221422663968
		 ...
		 98 -1.6733874989122324;
createNode animCurveTL -n "CTRL_Main_translateZ";
	rename -uid "E6874F78-DC46-DD0E-5505-F7953694C1CC";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 31 ".ktv[0:30]"  2 0 7 0 10 0.82692135945353584 13 0.82692135945353584
...
createNode animCurveTL -n "CTRL_Top_translateY";
	...
	setAttr -s 28 ".ktv[0:27]"  2 0 7 0.23226974008745663 10 0.090261194420439908
		 ...
		 98 -0.77736573669855902;
createNode animCurveTL -n "CTRL_Top_translateZ";
	rename -uid "F14B516D-4145-8FC6-A082-BC8CA695EFC5";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 28 ".ktv[0:27]"  2 0 7 -0.060858264920163739 10 -0.028180007896709908
...
createNode animCurveTL -n "CTRL_Bottom_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  3 0 46 -0.037 65 -0.063242815761543711 68 -0.083683690110595774
...
createNode animCurveTA -n "CTRL_Main_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  89 24.544477858267562 92 5.6321825508251884
		 95 5.6321825508251884 98 -2.2497297007174124;
createNode animCurveTA -n "CTRL_Main_rotateY";
	rename -uid "A35E4C36-3445-89BE-33A7-0F9F80DB4BF4";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  89 -1.0903410393885449 92 -1.0903410393885327
		 95 -1.0903410393885327 98 -1.0903410393885269;
createNode animCurveTA -n "CTRL_Main_rotateZ";
	rename -uid "F6E9DBB7-9144-77EB-4CD4-16B1D621001D";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  89 -0.55030916730025459 92 -0.55030916730024892
		 95 -0.55030916730024892 98 -0.55030916730024704;
createNode animCurveTL -n "camera1_translateX";
	rename -uid "D694747E-0546-48E0-9251-B3949482A27B";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  88 0.098192976474600402 89 0.098192976474600402
		 90 0.098192976474600402 98 0.098;
createNode animCurveTL -n "camera1_translateY";
	rename -uid "711E2F30-AC4F-7A1B-F867-A9811688D334";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  88 0.19024889191953753 89 0.19024889191953753
		 90 0.19024889191953753 98 0.19024889191953753;
createNode animCurveTL -n "camera1_translateZ";
	rename -uid "996ADC0A-2744-99AD-DD1E-87BCF0426378";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  88 20.930154404350017 89 20.930154404350017
		 90 20.930154404350017 98 20.930154404350017;
createNode animCurveTA -n "camera1_rotateX";
	rename -uid "9817DAA3-0446-15A7-043F-2CA44E0A0FB9";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  88 0 89 5.0794691899298403 90 -3.286057184000597
		 98 0;
createNode animCurveTA -n "camera1_rotateY";
	rename -uid "52AC27B7-DF42-1016-6C0B-56B79443BA85";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  88 0 89 0.1896085955632312 90 0.28952232027333957
		 98 0;
createNode animCurveTA -n "camera1_rotateZ";
	rename -uid "B49B63B4-B244-813C-4AFE-F48E25F30A84";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  88 0 89 -6.4089531288849475 90 4.5482553878034748
		 98 0;
select -ne :time1;
	setAttr ".o" 35;
	setAttr ".unw" 35;
