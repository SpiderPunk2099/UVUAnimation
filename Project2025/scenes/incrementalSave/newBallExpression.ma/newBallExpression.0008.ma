...
//Last modified: Mon, Feb 02, 2026 01:12:56 PM
//Codeset: UTF-8
...
fileInfo "UUID" "457C0620-0545-4636-BC15-A59CD5577B1C";
createNode transform -s -n "persp";
	rename -uid "BEF3ED4B-C145-D9C8-D984-8887B9622330";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.0390137403666504 -4.4408920985006262e-16 24.790119507560398 ;
	setAttr ".r" -type "double3" 0 2.3999999999999955 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "E60D894C-724F-6406-F2DD-289FFEB23AC8";
	setAttr -s 8 ".lnk";
	setAttr -s 8 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "E1C0B40C-5346-C9E4-1F8D-EB8728573A84";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "458A3CA4-4F40-7ED2-B06A-32A4E3A5545F";
createNode displayLayerManager -n "layerManager";
	rename -uid "EEBD0404-8C46-680C-34C3-14BFA6EA3937";
createNode displayLayer -n "defaultLayer";
	rename -uid "35BA30C9-994A-D229-AE90-38A9F454D9E6";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "BC091779-CC4E-34DA-9D76-1E9DCC845211";
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 62 -max 84 -ast 2 -aet 160 ";
	setAttr ".st" 6;
...
createNode animCurveTL -n "CTRL_Main_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 22 ".ktv[0:21]"  2 0 7 0 10 0 13 0 16 0 19 0 22 0 25 0 28 0
		 31 0 34 0 37 0 41 0 44 0 47 0 50 0 53 0 59 0 62 0 65 0 68 0 71 0;
createNode animCurveTL -n "CTRL_Main_translateY";
	rename -uid "7019C399-6F47-7024-9EAC-8696B2A8AFE7";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 22 ".ktv[0:21]"  2 -1.8859221422663968 7 -1.8859221422663968
...
createNode animCurveTL -n "CTRL_Main_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 22 ".ktv[0:21]"  2 0 7 0 10 0.82692135945353584 13 0.82692135945353584
		 ...
		 68 12.423105483590758 71 13.341786227454396;
createNode animCurveTA -n "CTRL_Main_rotateX";
	rename -uid "842830E2-254C-0DD4-C3A0-F9B68F51F09D";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 22 ".ktv[0:21]"  2 0 7 12.959007203081136 10 12.959007203081136
		 13 12.959007203081136 16 -13.84386863489001 19 -20.817946450003085 22 -9.5636930471646089
		 ...
		 50 -9.2707418391758232 53 2.8840179767084924 59 27.578111975578238 62 -0.73803633199278795
		 65 -9.8516292010548643 68 -9.8516292010548643 71 -9.8516292010548643;
...
createNode animCurveTL -n "CTRL_Top_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 23 ".ktv[0:22]"  2 0 7 0 10 0 13 0 16 0 19 0 22 0 25 0 28 0
		 31 0 34 0 37 0 41 0 44 0 47 0 50 0 53 0 56 0 59 0 62 0 65 0 68 0 71 0;
createNode animCurveTL -n "CTRL_Top_translateY";
	rename -uid "7D313D66-3940-4B3F-9333-F186ADC33E96";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 23 ".ktv[0:22]"  2 0 7 0.23226974008745663 10 0.090261194420439908
...
createNode animCurveTL -n "CTRL_Top_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 23 ".ktv[0:22]"  2 0 7 -0.060858264920163739 10 -0.028180007896709908
...
createNode animCurveTL -n "CTRL_Bottom_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  65 0 68 0 71 0;
createNode animCurveTL -n "CTRL_Bottom_translateY";
	rename -uid "70C6706B-DD4E-BEA9-1FF1-89BCF48F6109";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  65 -0.4229128135360265 68 -0.54062037667578011
		 71 -0.54062037667578011;
createNode animCurveTL -n "CTRL_Bottom_translateZ";
	rename -uid "BB313841-354F-5D5A-381B-9E87A716AFC3";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  65 -0.063242815761543711 68 -0.083683690110595774
		 71 -0.083683690110595774;
select -ne :time1;
	setAttr ".o" 71;
	setAttr ".unw" 71;
