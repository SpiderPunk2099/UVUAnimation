...
//Last modified: Mon, Feb 02, 2026 06:23:59 PM
//Codeset: UTF-8
...
fileInfo "UUID" "8784AAC4-EC4B-190A-F1D5-0BBC53DD5FA2";
createNode transform -s -n "persp";
	rename -uid "BEF3ED4B-C145-D9C8-D984-8887B9622330";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.014154605256602171 1.4483215397176896 32.099247269952812 ;
	setAttr ".r" -type "double3" -7.2000000000000242 -1.5999999999999479 -2.4857775121583885e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "020769EC-CD45-02FB-C381-93AB74B04498";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 32.02088298122495;
...
createNode transform -n "camera1";
	...
	setAttr ".t" -type "double3" 0 0 20.930154404350017 ;
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 2 -max 94 -ast 2 -aet 160 ";
	setAttr ".st" 6;
createNode reference -n "Ultimate_Ball_v1_0_1RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" 24.54447785826756245 -1.09034103938854487 -0.55030916730025459"
...
createNode animCurveTL -n "CTRL_Main_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 27 ".ktv[0:26]"  2 -1.8859221422663968 7 -1.8859221422663968
		 ...
		 86 -0.42815917407144422;
createNode animCurveTL -n "CTRL_Main_translateZ";
	rename -uid "E6874F78-DC46-DD0E-5505-F7953694C1CC";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 27 ".ktv[0:26]"  2 0 7 0 10 0.82692135945353584 13 0.82692135945353584
		 ...
		 80 15.849551211204139 83 17.701683058237027 86 17.701683058237027;
