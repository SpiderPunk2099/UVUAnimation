...
//Last modified: Sun, Feb 01, 2026 05:28:01 PM
//Codeset: UTF-8
...
fileInfo "UUID" "782EEEF7-1B47-59DB-F024-6CA388E5B6DC";
createNode transform -s -n "persp";
	rename -uid "BEF3ED4B-C145-D9C8-D984-8887B9622330";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.3464278786929178 5.9952043329758453e-15 24.809465182362125 ;
	setAttr ".r" -type "double3" 0 0.79999999999997262 0 ;
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 2 -max 20 -ast 2 -aet 160 ";
	setAttr ".st" 6;
...
createNode animCurveTL -n "CTRL_Main_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 0 7 0 10 0 13 0;
createNode animCurveTL -n "CTRL_Main_translateY";
	rename -uid "7019C399-6F47-7024-9EAC-8696B2A8AFE7";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 -1.8859221422663968 7 -1.8859221422663968
		 10 -1.4621202457047482 13 -0.8152162151196416;
createNode animCurveTL -n "CTRL_Main_translateZ";
	rename -uid "E6874F78-DC46-DD0E-5505-F7953694C1CC";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 0 7 0 10 0.82692135945353584 13 0.82692135945353584;
createNode animCurveTA -n "CTRL_Main_rotateX";
	rename -uid "842830E2-254C-0DD4-C3A0-F9B68F51F09D";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 0 7 12.959007203081136 10 12.959007203081136
		 13 12.959007203081136;
...
createNode animCurveTL -n "CTRL_Top_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 0 7 0.23226974008745663 10 0.090261194420439908
		 13 -0.10852938711192034;
createNode animCurveTL -n "CTRL_Top_translateZ";
	rename -uid "F14B516D-4145-8FC6-A082-BC8CA695EFC5";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 0 7 -0.060858264920163739 10 -0.028180007896709908
		 13 0.017564631530754479;
select -ne :time1;
	setAttr ".o" 16;
	setAttr ".unw" 16;
