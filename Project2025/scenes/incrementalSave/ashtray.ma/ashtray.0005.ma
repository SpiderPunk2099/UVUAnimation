...
//Name: ashtray.ma
//Last modified: Thu, Feb 26, 2026 02:58:35 PM
//Codeset: UTF-8
requires maya "2026";
...
fileInfo "UUID" "4CA26D40-8F46-5FF0-2277-3DA234EA1B43";
createNode transform -s -n "persp";
	rename -uid "F657D9D6-EE4A-5F2D-157D-0983054B6F1D";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 13.528747978854003 5.9428794995135421 3.3634104071205719 ;
	setAttr ".r" -type "double3" -7.5383527088180973 1153.7999999990566 -2.8500502457200661e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "CEF363FE-EB45-F5E0-1768-1893F2E682E6";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 14.950999521217483;
...
createNode mesh -n "polySurfaceShape2" -p "polySurface2";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.46038225293159485 0.28961771726608276 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode transform -n "fluid1";
	rename -uid "1E887089-4645-C3C1-8CEA-EB94B668A1D2";
	setAttr ".t" -type "double3" -0.894107052755714 5.2460902440822004 0 ;
	setAttr ".r" -type "double3" 0 -89.999999999999972 0 ;
createNode fluidShape -n "fluidShape1" -p "fluid1";
	rename -uid "966342D8-B04D-2E9C-0378-95A61F3BCA40";
	setAttr -k off ".v";
	setAttr ".rt" 1;
	setAttr ".iss" yes;
	setAttr ".covm[0]"  0 1 1;
...
createNode fluidEmitter -n "fluidEmitter1" -p "fluid1";
	rename -uid "D54853F5-3A4B-DB00-2345-E68C8EA194B2";
