...
//Name: ashtray.ma
//Last modified: Thu, Feb 26, 2026 03:19:19 PM
//Codeset: UTF-8
requires maya "2026";
...
fileInfo "UUID" "BC789308-2C48-0E04-E8D5-0FA53FFDAA43";
createNode transform -s -n "persp";
	rename -uid "F657D9D6-EE4A-5F2D-157D-0983054B6F1D";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 7.234375023601201 3.6859257131867325 3.9114300109916966 ;
	setAttr ".r" -type "double3" -18.338352711230268 1497.7999999987203 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "CEF363FE-EB45-F5E0-1768-1893F2E682E6";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 9.7300475883148234;
