...
//Name: ashtray.ma
//Last modified: Thu, Feb 26, 2026 02:45:59 PM
//Codeset: UTF-8
requires maya "2026";
...
fileInfo "UUID" "018FF4CA-F94E-0AA5-0EA3-CFADD4E58080";
createNode transform -s -n "persp";
	rename -uid "F657D9D6-EE4A-5F2D-157D-0983054B6F1D";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -12.56900000256465 2.1419388170487883 -0.66803723203621401 ;
	setAttr ".r" -type "double3" -7.5383527087212556 987.40000000103066 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "CEF363FE-EB45-F5E0-1768-1893F2E682E6";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 12.885624774928676;
