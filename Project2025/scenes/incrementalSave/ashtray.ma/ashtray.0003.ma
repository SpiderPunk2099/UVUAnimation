...
//Name: ashtray.ma
//Last modified: Thu, Feb 26, 2026 02:39:14 PM
//Codeset: UTF-8
requires maya "2026";
...
fileInfo "UUID" "96452B4C-6B48-0895-2C82-F1BAFC5EF7F2";
createNode transform -s -n "persp";
	rename -uid "F657D9D6-EE4A-5F2D-157D-0983054B6F1D";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 13.017688089084348 14.839231487743506 -0.57438997696832317 ;
	setAttr ".r" -type "double3" -49.53835273022947 815.3999999991014 2.5444437451708134e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "CEF363FE-EB45-F5E0-1768-1893F2E682E6";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 18.882870504970182;
