...
//Name: balldrop.ma
//Last modified: Thu, Mar 19, 2026 10:40:08 AM
//Codeset: UTF-8
...
fileInfo "UUID" "85814BF5-4E4A-1819-7771-CDB3FE1FF7F9";
createNode transform -s -n "persp";
	rename -uid "2506EE5A-824D-1571-ADC1-4D945ADDCC27";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.0348277093002469 6.8242955099773042 15.74273245698477 ;
	setAttr ".r" -type "double3" -0.20934462318247998 -10.711569459981378 0 ;
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 4 -max 103 -ast 2 -aet 150 ";
	setAttr ".st" 6;
...
createNode reference -n "Ultimate_Bony_v1_0_5RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" 0 0 -73.19194793686077105"
		2 "|Ultimate_Bony_v1_0_5:Bony|Ultimate_Bony_v1_0_5:Bony_Main_CNT|Ultimate_Bony_v1_0_5:Bony_lPalmCG|Ultimate_Bony_v1_0_5:Bony_lPalmC|Ultimate_Bony_v1_0_5:Bony_lFinger1J2CG|Ultimate_Bony_v1_0_5:Bony_lFinger1J2C" 
		"rotatePivotTranslate" " -type \"double3\" 0 0 0"
...
createNode animCurveTA -n "Bony_lShoulderFKC_rotateX";
	...
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  2 -219.24819157614081 21 -192.163 57 -192.163
		 61 -192.163 66 -192.163 70 -199.50046959411895 73 -199.50046959411895 77 -192.79365877441566;
	setAttr -s 8 ".kit[0:7]"  18 18 1 1 1 18 1 18;
	setAttr -s 8 ".kot[0:7]"  9 9 1 1 1 9 1 9;
	setAttr -s 8 ".kix[2:7]"  1 1 1 1 0.98734838225850186 1;
	setAttr -s 8 ".kiy[2:7]"  0 0 0 0 0.15856598642684758 0;
	setAttr -s 8 ".kox[2:7]"  0.93591517695854909 0.93591517695854909 
		0.93591517695854909 0.91562759494702073 0.98734838225850197 0.81833299589889019;
	setAttr -s 8 ".koy[2:7]"  -0.35222546974721708 -0.35222546974721708 
		-0.35222546974721708 -0.40202749579044272 0.1585659864268476 0.57474438476869605;
createNode animCurveTA -n "Bony_lShoulderFKC_rotateY";
	rename -uid "4D93A6C5-7741-DB7E-B0FF-A48E8AA983EE";
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  2 4.3335966005447357 21 -14.128140259984141
		 57 -14.128140259984141 61 -14.128140259984141 66 -14.128140259984141 70 -45.350216704665655
		 73 -45.350216704665655 77 -52.28557657711341;
	setAttr -s 8 ".kit[0:7]"  18 18 1 1 1 18 1 18;
	setAttr -s 8 ".kot[0:7]"  9 9 1 1 1 9 1 9;
	setAttr -s 8 ".kix[2:7]"  0.914008365117847 0.914008365117847 0.914008365117847 
		1 0.94569572613848296 1;
	setAttr -s 8 ".kiy[2:7]"  -0.40569533950318026 -0.40569533950318026 
		-0.40569533950318026 0 -0.3250532165098623 0;
	setAttr -s 8 ".kox[2:7]"  0.91400836511784678 0.91400836511784678 
		0.91400836511784678 0.47189569840102646 0.94569572613848307 0.80912215203622295;
	setAttr -s 8 ".koy[2:7]"  -0.40569533950318021 -0.40569533950318021 
		-0.40569533950318021 -0.88165438230102811 -0.32505321650986235 -0.58764048795523904;
createNode animCurveTA -n "Bony_lShoulderFKC_rotateZ";
	rename -uid "55BAFF5D-B346-BB31-34BB-B8A6656AA8BA";
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  2 -68.64963599867049 21 -63.285667549849052
		 57 -63.285667549849052 61 -63.285667549849052 66 -63.285667549849052 70 -54.21424408513581
		 73 -54.21424408513581 77 81.613894036091324;
	setAttr -s 8 ".kit[0:7]"  18 18 1 1 1 18 1 18;
	setAttr -s 8 ".kot[0:7]"  9 9 1 1 1 9 1 9;
	setAttr -s 8 ".kix[2:7]"  0.94244922172211532 0.94244922172211532 
		0.94244922172211532 1 0.95976366505504263 1;
	setAttr -s 8 ".kiy[2:7]"  0.33434931505145782 0.33434931505145782 
		0.33434931505145782 0 0.28080902271848696 0;
	setAttr -s 8 ".kox[2:7]"  0.84190489967392901 0.84190489967392901 
		0.84190489967392901 0.87886243477970383 0.73879336279870256 0.070131154279807817;
	setAttr -s 8 ".koy[2:7]"  0.53962592590148184 0.53962592590148184 
		0.53962592590148184 0.47707527784731285 0.67393201963149418 0.99753777933438781;
