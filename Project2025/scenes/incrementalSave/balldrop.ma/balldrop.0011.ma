...
//Name: balldrop.ma
//Last modified: Thu, Mar 19, 2026 01:38:50 PM
//Codeset: UTF-8
...
fileInfo "UUID" "61713EE3-6548-82C2-8873-21A2929B87F4";
createNode transform -s -n "persp";
	rename -uid "2506EE5A-824D-1571-ADC1-4D945ADDCC27";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.1012444221743367 8.7186868915437437 13.35009332522726 ;
	setAttr ".r" -type "double3" -6.2093446231807556 -1.1115694599802723 -8.6984661254369879e-17 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 14.782979570213977;
...
createNode parentConstraint -n "pSphere1_parentConstraint1" -p "pSphere1";
	...
	setAttr ".lr" -type "double3" -435.19277104875829 -14.036621242012254 9.2307256102875019 ;
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 37 -max 81 -ast 2 -aet 150 ";
	setAttr ".st" 6;
