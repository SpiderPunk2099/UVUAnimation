...
//Name: balldrop.ma
//Last modified: Thu, Mar 19, 2026 01:34:42 PM
//Codeset: UTF-8
...
fileInfo "UUID" "9F61A137-1242-1A21-F3FA-3B89913620E6";
createNode transform -s -n "persp";
	rename -uid "2506EE5A-824D-1571-ADC1-4D945ADDCC27";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.32521579320476235 10.997854508345334 21.06158226592839 ;
	setAttr ".r" -type "double3" -9.8093446231807349 -2.7115694599802218 -4.9751871948476166e-17 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 22.762880618243639;
...
createNode parentConstraint -n "pSphere1_parentConstraint1" -p "pSphere1";
	...
	setAttr ".lr" -type "double3" -453.411674203171 18.92789808229497 13.517879678465173 ;
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 2 -max 62 -ast 2 -aet 150 ";
	setAttr ".st" 6;
...
createNode reference -n "Ultimate_Bony_v1_0_5RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" 12.25742066555944199 0 0"
		2 "|Ultimate_Bony_v1_0_5:Bony|Ultimate_Bony_v1_0_5:Bony_Main_CNT|Ultimate_Bony_v1_0_5:Bony_ROOTCG|Ultimate_Bony_v1_0_5:Bony_ROOTC" 
