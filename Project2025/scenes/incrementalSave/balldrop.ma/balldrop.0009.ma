...
//Name: balldrop.ma
//Last modified: Thu, Mar 19, 2026 01:24:44 PM
//Codeset: UTF-8
...
fileInfo "UUID" "47911697-5A4B-7DD8-57A9-27808216A75C";
createNode transform -s -n "persp";
	rename -uid "2506EE5A-824D-1571-ADC1-4D945ADDCC27";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 10.633750394798287 7.6511463032772804 3.0324950682900917 ;
	setAttr ".r" -type "double3" -2.609344623180947 70.888430540019698 -6.0714534102722772e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 10.142228278074228;
...
createNode transform -n "pSphere1";
	...
	setAttr ".s" -type "double3" 0.50814321917964522 0.50814321917964522 0.50814321917964522 ;
...
createNode parentConstraint -n "pSphere1_parentConstraint1" -p "pSphere1";
	...
	setAttr ".lr" -type "double3" -429.63238130213824 -14.02470779758729 -0.025732599763413931 ;
...
createNode animCurveTA -n "Bony_lShoulderFKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 -219.24819157614081 21 -192.163 57 -192.163;
	setAttr -s 3 ".kit[2]"  1;
	setAttr -s 3 ".kot[0:2]"  9 9 1;
	setAttr -s 3 ".kix[2]"  1;
	setAttr -s 3 ".kiy[2]"  0;
	setAttr -s 3 ".kox[2]"  0.93591517695854909;
	setAttr -s 3 ".koy[2]"  -0.35222546974721708;
createNode animCurveTA -n "Bony_lShoulderFKC_rotateY";
	rename -uid "4D93A6C5-7741-DB7E-B0FF-A48E8AA983EE";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 4.3335966005447357 21 -14.128140259984141
		 57 -14.128140259984141;
	setAttr -s 3 ".kit[2]"  1;
	setAttr -s 3 ".kot[0:2]"  9 9 1;
	setAttr -s 3 ".kix[2]"  0.914008365117847;
	setAttr -s 3 ".kiy[2]"  -0.40569533950318026;
	setAttr -s 3 ".kox[2]"  0.91400836511784678;
	setAttr -s 3 ".koy[2]"  -0.40569533950318021;
createNode animCurveTA -n "Bony_lShoulderFKC_rotateZ";
	rename -uid "55BAFF5D-B346-BB31-34BB-B8A6656AA8BA";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 -68.64963599867049 21 -63.285667549849052
		 57 -63.285667549849052;
	setAttr -s 3 ".kit[2]"  1;
	setAttr -s 3 ".kot[0:2]"  9 9 1;
	setAttr -s 3 ".kix[2]"  0.94244922172211532;
	setAttr -s 3 ".kiy[2]"  0.33434931505145782;
	setAttr -s 3 ".kox[2]"  0.84190489967392901;
	setAttr -s 3 ".koy[2]"  0.53962592590148184;
...
createNode animCurveTA -n "Bony_lElbowFKC_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  2 109.75939530651777 39 89.230931043444514;
