...
//Name: balldrop.ma
//Last modified: Thu, Mar 19, 2026 10:14:01 AM
//Codeset: UTF-8
...
fileInfo "UUID" "0F333FF8-EF48-A6E3-A3E6-9BAD96D6B487";
createNode transform -s -n "persp";
	rename -uid "2506EE5A-824D-1571-ADC1-4D945ADDCC27";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.39084040071516091 3.9171315908862727 15.793713735352027 ;
	setAttr ".r" -type "double3" 9.3906553768175183 -2.711569459981332 -2.4875935974238098e-17 ;
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 29 -max 92 -ast 2 -aet 150 ";
	setAttr ".st" 6;
...
createNode animCurveTA -n "Bony_lShoulderFKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 -219.24819157614081 64 -199.50046959411895
		 67 -199.50046959411895 71 -192.79365877441566;
	setAttr -s 4 ".kit[2:3]"  1 18;
	setAttr -s 4 ".kot[0:3]"  9 9 1 9;
	setAttr -s 4 ".kix[2:3]"  0.98734838225850186 1;
	setAttr -s 4 ".kiy[2:3]"  0.15856598642684758 0;
	setAttr -s 4 ".kox[2:3]"  0.98734838225850197 0.81833299589889019;
	setAttr -s 4 ".koy[2:3]"  0.1585659864268476 0.57474438476869605;
createNode animCurveTA -n "Bony_lShoulderFKC_rotateY";
	rename -uid "4D93A6C5-7741-DB7E-B0FF-A48E8AA983EE";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 4.3335966005447357 64 -45.350216704665655
		 67 -45.350216704665655 71 -52.28557657711341;
	setAttr -s 4 ".kit[2:3]"  1 18;
	setAttr -s 4 ".kot[0:3]"  9 9 1 9;
	setAttr -s 4 ".kix[2:3]"  0.94569572613848296 1;
	setAttr -s 4 ".kiy[2:3]"  -0.3250532165098623 0;
	setAttr -s 4 ".kox[2:3]"  0.94569572613848307 0.80912215203622295;
	setAttr -s 4 ".koy[2:3]"  -0.32505321650986235 -0.58764048795523904;
createNode animCurveTA -n "Bony_lShoulderFKC_rotateZ";
	rename -uid "55BAFF5D-B346-BB31-34BB-B8A6656AA8BA";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 -68.64963599867049 64 -54.21424408513581
		 67 -54.21424408513581 71 81.613894036091324;
	setAttr -s 4 ".kit[2:3]"  1 18;
	setAttr -s 4 ".kot[0:3]"  9 9 1 9;
	setAttr -s 4 ".kix[2:3]"  0.95976366505504263 1;
	setAttr -s 4 ".kiy[2:3]"  0.28080902271848696 0;
	setAttr -s 4 ".kox[2:3]"  0.73879336279870256 0.070131154279807817;
	setAttr -s 4 ".koy[2:3]"  0.67393201963149418 0.99753777933438781;
...
createNode animCurveTA -n "Bony_lWristFKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  2 -278.40958373168098 22 -282.31928708771397
		 29 -281.95137022476945 36 -283.37746436405877 43 -288.7025071866309 50 -282.34939693249265
		 57 -280.94082135913294 64 -278.79978214507486;
...
createNode animCurveTA -n "Bony_lWristFKC_rotateY";
	...
	setAttr -s 8 ".ktv[0:7]"  2 8.2920221001885395 22 47.289786819504144
		 ...
		 57 -40.314486150940851 64 18.916763492605558;
	setAttr -s 8 ".kot[0:7]"  9 9 9 9 9 9 9 9;
createNode animCurveTA -n "Bony_lWristFKC_rotateZ";
	...
	setAttr -s 8 ".ktv[0:7]"  2 6.8209844629937164 22 -1.0741341349856621
		 ...
		 57 15.17121536323836 64 5.1693282838756698;
	setAttr -s 8 ".kot[0:7]"  9 9 9 9 9 9 9 9;
