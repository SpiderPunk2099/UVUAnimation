...
//Name: Run.ma
//Last modified: Tue, Oct 21, 2025 01:32:22 PM
//Codeset: UTF-8
...
fileInfo "UUID" "B5EA332A-A34F-7211-E0BB-08811092E17D";
createNode transform -s -n "persp";
	rename -uid "C0B330F1-4345-EFEA-BE9C-EF83DCC6FE1F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -18.286214220457456 5.6586028029288391 0.72515588707840273 ;
	setAttr ".r" -type "double3" -2.4000000000009605 -5129.1999999960872 1.4237365639946221e-14 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 19.578012456172868;
...
createNode reference -n "Ultimate_Bony_v1_0_5RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" 0 3.99565157100719315 -2.79637228979880748"
...
createNode animCurveTL -n "Bony_rFootIKC_translateY";
	...
	setAttr -s 11 ".ktv[0:10]"  1 0.012282282814967807 2 0 3 -0.58476625725339648
		 ...
		 8 -1.8935394245079173 9 -1.7783290624951058 10 -1.7746719522935444 11 -1.8688660071386418;
	setAttr -s 11 ".kit[7:10]"  1 1 1 18;
	setAttr -s 11 ".kot[7:10]"  1 1 1 18;
	setAttr -s 11 ".kix[7:10]"  1 0.74910474133214289 1 1;
	setAttr -s 11 ".kiy[7:10]"  0 -0.66245157295737722 0 0;
	setAttr -s 11 ".kox[7:10]"  1 0.74910474133214289 1 1;
	setAttr -s 11 ".koy[7:10]"  0 -0.66245157295737722 0 0;
createNode animCurveTL -n "Bony_rFootIKC_translateZ";
	...
	setAttr -s 11 ".ktv[0:10]"  1 -1.2537231280940722 2 -1.2537231280940722
		 ...
		 11 -2.6549250048472639;
	setAttr -s 11 ".kit[7:10]"  1 1 1 18;
	setAttr -s 11 ".kot[7:10]"  1 1 1 18;
	setAttr -s 11 ".kix[7:10]"  1 1 0.03274850402121144 1;
	setAttr -s 11 ".kiy[7:10]"  0 0 0.99946362389252197 0;
	setAttr -s 11 ".kox[7:10]"  1 1 0.03274850402121144 1;
	setAttr -s 11 ".koy[7:10]"  0 0 0.99946362389252197 0;
...
createNode animCurveTA -n "Bony_lShoulderFKC_rotateZ";
	...
	setAttr -s 10 ".ktv[0:9]"  1 18.656855208829686 2 11.807065293619004
		 ...
		 7 -16.085162123923034 8 -10.496077561186166 9 2.938 10 -45.063822555353518;
...
createNode animCurveTA -n "Bony_lShoulderFKC_rotateY";
	...
	setAttr -s 10 ".ktv[0:9]"  1 -53.132278711742224 2 -36.949216017404005
		 ...
		 7 50.705280416610833 8 40.206575386865957 9 19.773 10 -34.123792154979071;
	setAttr -s 10 ".kit[7:9]"  1 1 1;
	setAttr -s 10 ".kot[7:9]"  1 1 1;
...
createNode animCurveTA -n "Bony_rFootIKC_rotateZ";
	...
	setAttr -s 11 ".ktv[0:10]"  1 1.2206625605590489 2 0.12128366139886751
		 ...
		 7 -11.880460373917598 8 -4.309 9 0.60796756143132702 10 -1.638964601622813 11 -0.23549069883731083;
	setAttr -s 11 ".kit[7:10]"  1 1 1 18;
	setAttr -s 11 ".kot[7:10]"  1 1 1 18;
	setAttr -s 11 ".kix[7:10]"  1 0.84572262270335974 1 1;
	setAttr -s 11 ".kiy[7:10]"  0 -0.53362275574393447 0 0;
	setAttr -s 11 ".kox[7:10]"  1 0.84572262270335974 1 1;
	setAttr -s 11 ".koy[7:10]"  0 -0.53362275574393447 0 0;
createNode animCurveTA -n "Bony_rFootIKC_rotateY";
	...
	setAttr -s 11 ".ktv[0:10]"  1 -1.2610312414198932 2 4.3055038025887571
		 ...
		 7 0.60248564115012759 8 12.455 9 -6.3865032930897829 10 -7.613016091255731 11 -6.9894598155121042;
	setAttr -s 11 ".kit[7:10]"  1 1 1 18;
	setAttr -s 11 ".kot[7:10]"  1 1 1 18;
	setAttr -s 11 ".kix[7:10]"  1 1 1 1;
	setAttr -s 11 ".kiy[7:10]"  0 0 0 0;
...
createNode animCurveTA -n "Bony_rFootIKC_rotateX";
	...
	setAttr -s 11 ".ktv[0:10]"  1 -38.213824271668919 2 -4.249730814002703
		 ...
		 7 130.60053168358391 8 127.205 9 118.81178622888335 10 92.383496468265918 11 -30.077085534836037;
	setAttr -s 11 ".kit[7:10]"  1 1 1 18;
	setAttr -s 11 ".kot[7:10]"  1 1 1 18;
	setAttr -s 11 ".kix[7:10]"  1 0.061663829455598125 1 1;
	setAttr -s 11 ".kiy[7:10]"  0 0.9980969753169634 0 0;
	setAttr -s 11 ".kox[7:10]"  1 0.061663829455598125 1 1;
	setAttr -s 11 ".koy[7:10]"  0 0.9980969753169634 0 0;
...
createNode animCurveTA -n "Bony_lFootIKC_rotateX";
	...
	setAttr -s 11 ".ktv[0:10]"  1 127.205011589929 2 127.205011589929 3 97.272661393419156
		 ...
		 8 -46.927041657155065 9 -3.4700473396631564 10 39.498818223032416 11 138.2731845534158;
	setAttr -s 11 ".kit[7:10]"  1 1 1 18;
	setAttr -s 11 ".kot[7:10]"  1 1 1 18;
...
createNode animCurveTL -n "Bony_rFootIKC_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  5 0.022680888885808548 6 0.022680888885808548
		 8 0.022680888885808548 11 0.022680888885808548;
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "EBA8D569-504C-62CB-619F-609BD8F00EE6";
