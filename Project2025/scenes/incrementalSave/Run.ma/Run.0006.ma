...
//Name: Run.ma
//Last modified: Mon, Oct 20, 2025 04:49:04 PM
//Codeset: UTF-8
...
fileInfo "UUID" "BB1543B6-E14D-3145-DAB0-ADBD6479C7AC";
createNode transform -s -n "persp";
	rename -uid "C0B330F1-4345-EFEA-BE9C-EF83DCC6FE1F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -18.046805189429339 5.1521559311169529 0.31790548143701125 ;
	setAttr ".r" -type "double3" -2.3999999999747117 -1530.7999999999979 0 ;
...
createNode reference -n "Ultimate_Bony_v1_0_5RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" 0 -0.52896814006740289 0"
		2 "|Ultimate_Bony_v1_0_5:Bony|Ultimate_Bony_v1_0_5:Bony_Main_CNT|Ultimate_Bony_v1_0_5:Bony_ROOTCG|Ultimate_Bony_v1_0_5:Bony_ROOTC" 
		...
		"translate" " -type \"double3\" 0 1.21046024400543439 2.89794696356125536"
		2 "|Ultimate_Bony_v1_0_5:Bony|Ultimate_Bony_v1_0_5:Bony_Main_CNT|Ultimate_Bony_v1_0_5:Bony_rFootIKCG|Ultimate_Bony_v1_0_5:Bony_rFootIKC" 
		"translate" " -type \"double3\" 0 -3.06017847249066532 2.89407528609734221"
...
createNode animCurveTA -n "Bony_rFootIKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 -38.213824271668919 2 -4.249730814002703
...
createNode animCurveTL -n "Bony_rFootIKC_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 0.012282282814967807 2 0 3 -0.58476625725339648
		 4 -0.58476625725339626 5 -3.909261021009784 6 -3.0601784724906653;
createNode animCurveTL -n "Bony_rFootIKC_translateZ";
	rename -uid "ADFABADA-8642-24A1-7BCC-42A89EDA4E0E";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 -1.2537231280940722 2 -1.2537231280940722
...
createNode animCurveTA -n "Bony_rFootIKC_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 -1.2610312414198932 2 4.3055038025887571
...
createNode animCurveTA -n "Bony_rFootIKC_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 1.2206625605590489 2 0.12128366139886751
...
createNode animCurveTL -n "Bony_lFootIKC_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 3.4763080086242977 2 1.7651639573053246
...
createNode animCurveTL -n "Bony_lFootIKC_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 -2.7744636900620847 2 -2.3219534951234859
...
createNode animCurveTA -n "Bony_lFootIKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 127.205011589929 2 127.205011589929 3 97.272661393419156
		 4 11.420634746545719 5 -22.812193057576689 6 -32.446388499926407;
createNode animCurveTA -n "Bony_lFootIKC_rotateY";
	rename -uid "6D06B30E-6B40-6789-ABBD-D8B1299C57B9";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 12.455146124616089 2 12.455146124616089
...
createNode animCurveTA -n "Bony_lFootIKC_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 -4.3092794044368699 2 -4.3092794044368699
...
createNode animCurveTA -n "Bony_rShoulderFKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 64.720942191606881 2 98.626127662265219
...
createNode animCurveTA -n "Bony_rShoulderFKC_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 20.056540771735826 2 19.77280352027055
...
createNode animCurveTA -n "Bony_rShoulderFKC_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 0.86245497634740376 2 2.9378163292050807
...
createNode animCurveTA -n "Bony_lShoulderFKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 -51.548630037676858 2 -14.272975313694682
...
createNode animCurveTA -n "Bony_lShoulderFKC_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 -53.132278711742224 2 -36.949216017404005
...
createNode animCurveTA -n "Bony_lShoulderFKC_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  1 18.656855208829686 2 11.807065293619004
...
createNode animCurveTL -n "Bony_ROOTC_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 -0.14771085795120076 2 -0.32774766071907901
		 3 -0.67238038515361165 4 -0.52896814006740289;
...
createNode animCurveTA -n "Bony_ROOTC_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  3 -15.873865233557533 4 -15.873865233557533;
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "91AC3B3E-FB41-124A-7586-0489DBD62EBC";
