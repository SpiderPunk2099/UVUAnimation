...
//Name: riggedArm.ma
//Last modified: Tue, Feb 03, 2026 06:07:13 PM
//Codeset: UTF-8
...
fileInfo "UUID" "D33BBFE0-C340-D9DB-E40F-4EA52A60AE3C";
createNode transform -s -n "persp";
	rename -uid "DD996B3F-5F4B-1BA8-83F3-399FA427B843";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.12131578615905758 14.95917995835387 -16.961223950035976 ;
	setAttr ".r" -type "double3" -41.214407852264969 176.31709440386885 0 ;
	setAttr ".rp" -type "double3" -8.8817841970012523e-16 8.8817841970012523e-16 7.1054273576010019e-15 ;
	setAttr ".rpt" -type "double3" 5.9192589578715216e-15 2.6921072972024113e-15 -3.4973212905551944e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E8FD064D-C742-1539-1FD8-A886DE56750E";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 11.381813814907249;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -1.8583198982978502 4.0703013711115812 -1.6235641583463583 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	rename -uid "53B4BD06-7B4A-3DEA-3BA4-F187D0F7C7F9";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 988.13862143933966 5.9429094492961152 -3.9778011729839298 ;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.25528482687823129 10.066808542327063 -1001.9094576211264 ;
	setAttr ".r" -type "double3" 0 180.00000000000003 0 ;
	setAttr ".rpt" -type "double3" -6.554224284976545e-15 0 8.7669029008063034e-15 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "D2E5E1D5-D149-F287-F5B7-6882600814C1";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1000000000005;
	setAttr ".ow" 35.195774256749495;
	setAttr ".imn" -type "string" "front";
	setAttr ".den" -type "string" "front_depth";
	setAttr ".man" -type "string" "front_mask";
	setAttr ".tp" -type "double3" -11.961378645332548 12.232271130181626 -1.8094576211259437 ;
...
createNode joint -n "joint3" -p "joint2";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 1.1620293084645225e-15 -13.242469815097575 -1.0010629466929032e-14 ;
...
createNode joint -n "joint5" -p "joint4";
	...
	setAttr ".t" -type "double3" 1.0046170060057469 -1.230301000773936e-16 -9.1593399531575415e-16 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "joint6";
	...
	setAttr ".t" -type "double3" 0.46420382059511711 10.246350783111875 -11.745248072949792 ;
	setAttr ".r" -type "double3" 0 2.3283965607008352 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 89.999999999999446 89.348939619770562 89.999999999999446 ;
...
createNode joint -n "joint8" -p "joint6";
	rename -uid "445D0236-5640-7048-7167-8FB2AFC8E284";
	setAttr ".t" -type "double3" 1.0046818681297129 -3.1225022567582528e-17 -1.1154209424210223e-16 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jot" -type "string" "none";
...
createNode fosterParent -n "RobotArm_ModelRNfosterParent1";
	rename -uid "65222A1A-6C41-89A8-30A7-AC98A1BEC4AC";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "9D2BF1B9-F244-4BBF-7C89-8AAEFA663363";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "14C15DEC-6E46-F2A1-0455-AE82F86138C6";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "1259B89B-2440-CF90-DC63-D58999E6708E";
createNode displayLayerManager -n "layerManager";
	rename -uid "563447D1-5043-5B7F-A946-378A3424E868";
	setAttr -s 2 ".dli[1]"  1;
	setAttr -s 2 ".dli";
...
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "8F0800D7-AE41-E6FE-6F9C-85B8F5A22FB3";
...
select -ne :hardwareRenderGlobals;
	setAttr ".ctrs" 256;
	setAttr ".btrs" 512;
connectAttr "layer1.di" "RobotArm_ModelRN.phl[1]";
connectAttr "RobotArm_ModelRN.phl[2]" "baseShapeDeformed.i";
connectAttr "layer1.di" "RobotArm_ModelRN.phl[3]";
connectAttr "layer1.di" "RobotArm_ModelRN.phl[4]";
connectAttr "RobotArm_ModelRN.phl[5]" "hingeShapeDeformed.i";
connectAttr "layer1.di" "RobotArm_ModelRN.phl[6]";
connectAttr "layer1.di" "RobotArm_ModelRN.phl[7]";
connectAttr "layer1.di" "RobotArm_ModelRN.phl[8]";
connectAttr "layer1.di" "RobotArm_ModelRN.phl[9]";
connectAttr "layer1.di" "RobotArm_ModelRN.phl[10]";
connectAttr "layer1.di" "RobotArm_ModelRN.phl[11]";
connectAttr "layer1.di" "RobotArm_ModelRN.phl[12]";
connectAttr "layer1.di" "RobotArm_ModelRN.phl[13]";
