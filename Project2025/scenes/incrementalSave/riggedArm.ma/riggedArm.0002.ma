...
//Name: riggedArm.ma
//Last modified: Tue, Feb 03, 2026 06:08:09 PM
//Codeset: UTF-8
...
fileInfo "UUID" "D7721D60-C84B-44F8-FDBE-0F903A0A8D67";
createNode transform -s -n "persp";
	rename -uid "DD996B3F-5F4B-1BA8-83F3-399FA427B843";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.64209346368331222 17.854622362917951 -10.360649396376132 ;
	setAttr ".r" -type "double3" -91.614407852263767 173.9170944038687 0 ;
...
createNode joint -n "joint9";
	...
	setAttr ".t" -type "double3" -0.42898581980269918 0 -11.704237980598151 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 88.740954792824752 0 ;
	setAttr ".radi" 0.50318623588849998;
createNode joint -n "joint10" -p "joint9";
	rename -uid "ABDD2591-BB44-2C67-3776-1FAC432DC604";
	setAttr ".t" -type "double3" 1.0616005605109999 0 1.8388068845354155e-16 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 0.50318623588849998;
createNode fosterParent -n "RobotArm_ModelRNfosterParent1";
	rename -uid "97538953-FB43-D8F3-85FD-1F8157DE64F0";
