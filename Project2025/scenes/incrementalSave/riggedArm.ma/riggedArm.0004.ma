...
//Name: riggedArm.ma
//Last modified: Tue, Feb 03, 2026 06:49:16 PM
//Codeset: UTF-8
...
fileInfo "UUID" "754B90FF-D843-15D6-C5C6-588CE0EDACF0";
createNode transform -s -n "persp";
	rename -uid "DD996B3F-5F4B-1BA8-83F3-399FA427B843";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -5.7778057153905884 11.602210866915133 -20.461816140279655 ;
	setAttr ".r" -type "double3" 177.59999999989236 -29.599999999999756 -179.99999999995643 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 10.374916381277851;
...
createNode joint -n "joint8" -p "joint6";
	...
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 0.50024216559291612;
createNode joint -n "joint9" -p "joint3";
...
createNode fosterParent -n "RobotArm_ModelRNfosterParent1";
	rename -uid "55E93B0D-3C48-0712-CCAD-DD94A6142636";
...
connectAttr "joint3.s" "joint9.is";
