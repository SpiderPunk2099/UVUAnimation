...
//Name: riggedArm.ma
//Last modified: Tue, Feb 03, 2026 06:10:42 PM
//Codeset: UTF-8
...
fileInfo "UUID" "08A52B39-DB42-A756-C145-B1ACE6461055";
createNode transform -s -n "persp";
	rename -uid "DD996B3F-5F4B-1BA8-83F3-399FA427B843";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.87428282643202537 14.670924966250308 -18.265397679511246 ;
	setAttr ".r" -type "double3" 149.99999999999582 -3.1999999999999953 -179.99999999999986 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 7.4133066735759918;
...
createNode joint -n "joint6";
	...
	setAttr ".t" -type "double3" 0.44308000201644393 10.246350783111875 -11.710806455252868 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "joint9";
	...
	setAttr ".t" -type "double3" -0.42898581980269918 10.230147555101743 -11.732485872435067 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode fosterParent -n "RobotArm_ModelRNfosterParent1";
	rename -uid "99B07206-1241-E7B0-04EE-88B1AAE80418";
