...
//Name: HIPHOP.ma
//Last modified: Sun, Apr 26, 2026 09:01:41 PM
//Codeset: UTF-8
...
fileInfo "UUID" "7DF14C6F-3C46-849C-E45A-7CA47B8CB40E";
createNode transform -s -n "persp";
	rename -uid "CC3E15C7-6B41-43AC-B0BE-BCB88FEE6A75";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.12298995423214043 7.7963014413752205 19.9534182446098 ;
	setAttr ".r" -type "double3" -7.5383527296076407 -1.4000000000016282 -9.9422012282376601e-17 ;
...
createNode reference -n "Ultimate_Bony_v1_0_5RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		" -type \"double3\" 0 0 -4.0945527751070987"
		2 "|Ultimate_Bony_v1_0_5:Bony|Ultimate_Bony_v1_0_5:Bony_Main_CNT" "translateY" 
		" -av"
		2 "|Ultimate_Bony_v1_0_5:Bony|Ultimate_Bony_v1_0_5:Bony_Main_CNT|Ultimate_Bony_v1_0_5:Bony_ROOTCG|Ultimate_Bony_v1_0_5:Bony_ROOTC" 
		"translate" " -type \"double3\" -0.2486953447074205 -0.11711812396141319 1.06437518834531231"
		...
		"rotate" " -type \"double3\" 0 0 -15.20038933142848592"
		2 "|Ultimate_Bony_v1_0_5:Bony|Ultimate_Bony_v1_0_5:Bony_Main_CNT|Ultimate_Bony_v1_0_5:Bony_MainHipCG|Ultimate_Bony_v1_0_5:Bony_MainHipC" 
		"rotateZ" " -av"
		2 "|Ultimate_Bony_v1_0_5:Bony|Ultimate_Bony_v1_0_5:Bony_Main_CNT|Ultimate_Bony_v1_0_5:Bony_MainHipCG|Ultimate_Bony_v1_0_5:Bony_MainHipC" 
		"rotatePivotTranslate" " -type \"double3\" 0 0 0"
		...
		"translate" " -type \"double3\" -0.16049531726386784 0 1.31110070125160538"
		2 "|Ultimate_Bony_v1_0_5:Bony|Ultimate_Bony_v1_0_5:Bony_Main_CNT|Ultimate_Bony_v1_0_5:Bony_lFootIKCG|Ultimate_Bony_v1_0_5:Bony_lFootIKC" 
		"translateY" " -av"
		2 "|Ultimate_Bony_v1_0_5:Bony|Ultimate_Bony_v1_0_5:Bony_Main_CNT|Ultimate_Bony_v1_0_5:Bony_lFootIKCG|Ultimate_Bony_v1_0_5:Bony_lFootIKC" 
		"rotate" " -type \"double3\" 0 0 0"
		...
		"translate" " -type \"double3\" -0.10820258828440547 0.39099994327510312 0.063652492860059945"
		...
		"rotate" " -type \"double3\" 70.55863117141757357 -2.97013854607908279 1.64575061019461777"
		...
		"translate" " -type \"double3\" 0.71298032020059265 1.84677627449387383 1.43930858090065561"
...
createNode animCurveTA -n "Bony_lElbowFKC_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  2 -33.637374798642064 10 -132.43383876807579
...
createNode animCurveTL -n "Bony_lFootIKC_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  2 0.75987781109038965 10 0.48931848289370666
		 20 -1.0022207499253453 30 0.39197858825327575 40 -0.38529221004378728 45 -0.98958459424477041
		 54 -1.5767726214200488 64 -0.16049531726386784;
	setAttr -s 8 ".kit[7]"  1;
	setAttr -s 8 ".kot[0:7]"  9 9 9 9 9 9 9 1;
	setAttr -s 8 ".kix[7]"  1;
	setAttr -s 8 ".kiy[7]"  0;
	setAttr -s 8 ".kox[7]"  0.97068487356155997;
	setAttr -s 8 ".koy[7]"  0.24035572853331075;
...
createNode animCurveTL -n "Bony_rFootIKC_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  2 -0.43303750818366343 10 -0.56879265666462431
		 20 2.0011573069349029 30 -0.61863282884994386 40 -0.25811005264232334 45 -0.75974095676977993
		 54 0.58447106320974673 64 -0.11272780816456821;
	setAttr -s 8 ".kot[0:7]"  9 9 9 9 9 9 9 9;
createNode animCurveTL -n "Bony_rFootIKC_translateY";
	rename -uid "E2DAA435-AC4F-7995-7BCD-30AA1E10BC40";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  2 0 10 -0.32352787726545518 20 0 30 -2.248004596346878
		 40 -0.19830016331946676 64 0.15989819715705544 74 -2.3386924736952515;
	setAttr -s 7 ".kot[0:6]"  9 9 9 9 9 9 9;
createNode animCurveTL -n "Bony_rFootIKC_translateZ";
	rename -uid "CFCCB276-684C-A5F0-D609-3D98A86ED470";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  2 1.3314289827871271 10 0.77657531598741703
		 20 -0.46891004358085259 30 -1.0353965067417823 40 -0.55790572685087858 45 -1.7211011230339917
		 54 -0.81778274509285631 64 -0.63436521644602295;
	setAttr -s 8 ".kot[0:7]"  9 9 9 9 9 9 9 9;
...
createNode animCurveTA -n "Bony_lFootIKC_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  2 -12.225899285777245 10 0 20 22.448281620027839
		 45 0 64 -1.2213622376794842 74 0;
	setAttr -s 6 ".kit[4:5]"  1 18;
	setAttr -s 6 ".kot[0:5]"  9 9 9 9 1 9;
	setAttr -s 6 ".kix[4:5]"  1 1;
	setAttr -s 6 ".kiy[4:5]"  0 0;
	setAttr -s 6 ".kox[4:5]"  0.99984442534497175 0.99869387516785113;
	setAttr -s 6 ".koy[4:5]"  -0.017638738803647594 0.051093480036307058;
...
createNode animCurveTA -n "Bony_MainHipC_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 0 45 9.1226049315198701 54 -4.1555379157622179
		 64 0;
	setAttr -s 4 ".kot[0:3]"  9 9 9 9;
createNode animCurveTA -n "Bony_MainHipC_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  2 7.5911169546842876 10 0 30 -11.001220556157351
		 40 0 45 10.133423783425535 64 15.250715977260306 74 -15.200389331428486;
	setAttr -s 7 ".kot[0:6]"  9 9 9 9 9 9 9;
createNode animCurveTA -n "Bony_lWristFKC_rotateX";
	...
	setAttr -s 4 ".ktv[0:3]"  2 11.872586760066829 20 -31.845485465823842
		 30 -21.442096138460077 45 -14.210238284483021;
	setAttr -s 4 ".kot[0:3]"  9 9 9 9;
...
createNode animCurveTA -n "Bony_lWristFKC_rotateZ";
	...
	setAttr -s 3 ".ktv[0:2]"  2 -22.105988303044139 20 -11.308566795561804
		 45 -11.636874459717218;
	setAttr -s 3 ".kot[0:2]"  9 9 9;
createNode animCurveTA -n "Bony_rWristFKC_rotateX";
	rename -uid "211F2E43-9E4C-B549-D1CA-88B254194FF8";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  2 24.07834254823462 20 -61.6238496109072
...
createNode animCurveTA -n "Bony_rWristFKC_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  2 -11.363094447307711 20 -6.0494607841421733
...
createNode animCurveTA -n "Bony_rWristFKC_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  2 -24.00038773840302 20 -23.63001672114644
...
createNode animCurveTA -n "Bony_Spine02FKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 22.723356328933416 10 0 54 4.6596164866726122
		 64 0;
	setAttr -s 4 ".kot[0:3]"  9 9 9 9;
createNode animCurveTA -n "Bony_Spine02FKC_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 0 54 -9.280168219769358 64 0;
	setAttr -s 3 ".kot[0:2]"  9 9 9;
createNode animCurveTA -n "Bony_Spine02FKC_rotateZ";
	rename -uid "B33DF520-6F45-6AC7-6EA7-A4A2E0F444FE";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  2 0 54 -0.75303777929341464;
	setAttr -s 2 ".kot[0:1]"  9 9;
...
createNode animCurveTL -n "Bony_Main_CNT_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  2 0 10 0 20 0.88907504606960353 54 -0.38921082859284928
		 64 0;
...
createNode animCurveTA -n "Bony_lToeIKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  30 0 45 36.312457406114575 54 0;
	setAttr -s 3 ".kot[0:2]"  9 9 9;
