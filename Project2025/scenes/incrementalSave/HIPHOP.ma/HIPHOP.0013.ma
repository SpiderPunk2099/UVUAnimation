...
//Name: HIPHOP.ma
//Last modified: Sun, Apr 26, 2026 08:38:15 PM
//Codeset: UTF-8
...
fileInfo "UUID" "D19D448C-B84F-F63D-D66A-6F845E71AD1F";
...
createNode animCurveTA -n "Bony_rShoulderFKC_rotateY";
	...
	setAttr -s 6 ".ktv[0:5]"  2 -18.914151917801888 10 1.563650379880865
		 20 0 40 -65.310486338940649 45 0.9520909438792583 54 -1.5509054806549338;
...
createNode animCurveTA -n "Bony_rElbowFKC_rotateY";
	...
	setAttr -s 6 ".ktv[0:5]"  2 -38.825687968705559 10 -138.81478001462281
		 20 0 30 -101.67246925078618 40 -49.862076679031809 54 -28.311069487497196;
	setAttr -s 6 ".kot[0:5]"  9 9 9 9 9 9;
createNode animCurveTA -n "Bony_lElbowFKC_rotateY";
	...
	setAttr -s 6 ".ktv[0:5]"  2 -33.637374798642064 10 -132.43383876807579
		 20 0 30 -94.343629244944395 40 -41.966026611663359 54 -31.038265740338247;
	setAttr -s 6 ".kot[0:5]"  9 9 9 9 9 9;
createNode animCurveTL -n "Bony_lFootIKC_translateX";
	...
	setAttr -s 7 ".ktv[0:6]"  2 0.75987781109038965 10 0.48931848289370666
		 ...
		 54 -1.5767726214200488;
	setAttr -s 7 ".kot[0:6]"  9 9 9 9 9 9 9;
createNode animCurveTL -n "Bony_lFootIKC_translateY";
	rename -uid "7FABD330-6443-2522-71FF-2B86878885EA";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  2 0 10 0.30993649115901922 20 0 45 1.7429689214727864
		 54 0;
...
createNode animCurveTA -n "Bony_MainHipC_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 0 45 9.1226049315198701 54 -4.1555379157622179;
	setAttr -s 3 ".kot[0:2]"  9 9 9;
...
createNode animCurveTA -n "Bony_rWristFKC_rotateX";
	...
	setAttr -s 5 ".ktv[0:4]"  2 24.07834254823462 20 -61.6238496109072
		 30 -41.193795460185342 45 -15.803846342763242 54 -22.061546883418696;
	setAttr -s 5 ".kot[0:4]"  9 9 9 9 9;
createNode animCurveTA -n "Bony_rWristFKC_rotateY";
	...
	setAttr -s 5 ".ktv[0:4]"  2 -11.363094447307711 20 -6.0494607841421733
		 30 -7.6671313147430427 45 0.61526208276813066 54 29.977360467036306;
	setAttr -s 5 ".kot[0:4]"  9 9 9 9 9;
createNode animCurveTA -n "Bony_rWristFKC_rotateZ";
	...
	setAttr -s 5 ".ktv[0:4]"  2 -24.00038773840302 20 -23.63001672114644
		 30 -21.373717859051983 45 -31.87211265031252 54 -22.309788762525979;
	setAttr -s 5 ".kot[0:4]"  9 9 9 9 9;
...
createNode animCurveTA -n "Bony_Spine02FKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 22.723356328933416 10 0 54 4.6596164866726122;
	setAttr -s 3 ".kot[0:2]"  9 9 9;
createNode animCurveTA -n "Bony_Spine02FKC_rotateY";
	rename -uid "55EEE83D-4640-D3BE-7E5A-1C8CD90CF3C4";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  2 0 54 -9.280168219769358;
	setAttr -s 2 ".kot[0:1]"  9 9;
...
createNode animCurveTL -n "Bony_Main_CNT_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 0 10 0 20 0.88907504606960353 54 -0.38921082859284928;
	setAttr -s 4 ".kot[0:3]"  9 9 9 9;
...
createNode animCurveTA -n "Bony_ROOTC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  2 0 10 0 20 -7.6149702882410528 30 0 54 -6.7223628577461092;
	setAttr -s 5 ".kot[0:4]"  9 9 9 9 9;
createNode animCurveTA -n "Bony_ROOTC_rotateY";
	rename -uid "88F3198A-ED44-9A61-9C7E-6585B4C7C203";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  2 0 10 0 20 35.787123250034334 30 0 54 -9.7147763327282561;
	setAttr -s 5 ".kot[0:4]"  9 9 9 9 9;
createNode animCurveTA -n "Bony_ROOTC_rotateZ";
	rename -uid "4AE90CF9-0249-8C03-9DA6-51BEEB10D49F";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  2 0 10 0 20 12.727201300796555 30 0 45 -10.012959154443967
		 54 -21.742261414754591;
	setAttr -s 6 ".kot[0:5]"  9 9 9 9 9 9;
