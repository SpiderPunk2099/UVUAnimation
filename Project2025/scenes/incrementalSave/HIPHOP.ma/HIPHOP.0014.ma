...
//Name: HIPHOP.ma
//Last modified: Sun, Apr 26, 2026 08:44:25 PM
//Codeset: UTF-8
...
fileInfo "UUID" "8D407081-0F4A-CF85-BAD6-25929434B88E";
createNode transform -s -n "persp";
	rename -uid "CC3E15C7-6B41-43AC-B0BE-BCB88FEE6A75";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.57896657910214933 7.7963014413752534 19.926451794692355 ;
	setAttr ".r" -type "double3" -7.5383527296075989 -3.0000000000018945 0 ;
...
createNode animCurveTL -n "Bony_lFootIKC_translateX";
	...
	setAttr -s 8 ".ktv[0:7]"  2 0.75987781109038965 10 0.48931848289370666
		 ...
		 54 -1.5767726214200488 64 0.056150601759476386;
	setAttr -s 8 ".kot[0:7]"  9 9 9 9 9 9 9 9;
createNode animCurveTL -n "Bony_lFootIKC_translateY";
	rename -uid "7FABD330-6443-2522-71FF-2B86878885EA";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  2 0 10 0.30993649115901922 20 0 45 1.7429689214727864
		 54 0 64 0.33204106347045981;
...
createNode animCurveTL -n "Bony_rFootIKC_translateY";
	...
	setAttr -s 6 ".ktv[0:5]"  2 0 10 -0.32352787726545518 20 0 30 -2.248004596346878
		 40 -0.19830016331946676 64 0.15989819715705544;
	setAttr -s 6 ".kot[0:5]"  9 9 9 9 9 9;
...
createNode animCurveTL -n "Bony_ROOTC_translateY";
	...
	setAttr -s 5 ".ktv[0:4]"  2 -0.9077523928224096 10 0 20 -0.3925506723597838
		 30 0.17040395702333644 45 0.010086753932704973;
...
createNode animCurveTL -n "Bony_lKneeIKC_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 0.43864570168010103 10 0.36211857699866234
		 45 -0.92244070532381206 64 0.37703617077153095;
	setAttr -s 4 ".kot[0:3]"  9 9 9 9;
createNode animCurveTL -n "Bony_lKneeIKC_translateY";
	rename -uid "F4F819E8-874B-637A-CAEB-E1A2D9D4227C";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 0.29753642883984821 10 0.29769005712094365
		 45 2.1782696743031149 64 0.71491295337589422;
	setAttr -s 4 ".kot[0:3]"  9 9 9 9;
createNode animCurveTL -n "Bony_lKneeIKC_translateZ";
	rename -uid "765721A5-314B-D45F-B068-ED894DF3257A";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 -0.030844471616105422 10 -0.025770529242002412
		 45 1.1674544565672831 64 2.0078143770234971;
	setAttr -s 4 ".kot[0:3]"  9 9 9 9;
...
createNode animCurveTA -n "Bony_lFootIKC_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  2 0 64 -4.9510926934933401;
...
createNode animCurveTA -n "Bony_MainHipC_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  2 7.5911169546842876 10 0 30 -11.001220556157351
		 40 0 45 10.133423783425535 64 15.250715977260306;
	setAttr -s 6 ".kot[0:5]"  9 9 9 9 9 9;
...
createNode animCurveTL -n "Bony_Main_CNT_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  2 0 6 0.831 10 0 20 0 40 0.38771706434487285
		 54 0 64 0.51586213473656217;
	setAttr -s 7 ".kot[0:6]"  9 9 9 9 9 9 9;
