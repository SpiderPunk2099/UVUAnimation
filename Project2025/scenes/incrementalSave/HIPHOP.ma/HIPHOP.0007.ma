...
//Name: HIPHOP.ma
//Last modified: Sun, Apr 26, 2026 08:06:56 PM
//Codeset: UTF-8
...
fileInfo "UUID" "468D39A4-5948-643E-8F05-D3A3DA0D49A3";
createNode transform -s -n "persp";
	rename -uid "CC3E15C7-6B41-43AC-B0BE-BCB88FEE6A75";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.85012346274926442 7.5102809176577736 14.538319840393582 ;
	setAttr ".r" -type "double3" -8.7383527296066603 -4.6000000000012449 4.9856761586716263e-17 ;
...
createNode reference -n "Ultimate_Bony_v1_0_5RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" 7.84945662188862059 0 0"
		2 "|Ultimate_Bony_v1_0_5:Bony|Ultimate_Bony_v1_0_5:Bony_Main_CNT|Ultimate_Bony_v1_0_5:Bony_rToeIKCG|Ultimate_Bony_v1_0_5:Bony_rToeIKC" 
		"rotatePivotTranslate" " -type \"double3\" 0 0 0"
...
createNode animCurveTA -n "Bony_lShoulderFKC_rotateX";
	...
	setAttr -s 5 ".ktv[0:4]"  2 41.237017350019798 10 25.947663775714037
		 20 0 30 21.546371685667452 40 13.810359729326906;
...
createNode animCurveTA -n "Bony_lShoulderFKC_rotateY";
	...
	setAttr -s 5 ".ktv[0:4]"  2 -39.314214228947456 10 -23.948629276052625
		 20 -12.589503741776074 30 -4.4233773996159265 40 -69.686789541069373;
	setAttr -s 5 ".kot[0:4]"  9 9 9 9 9;
createNode animCurveTA -n "Bony_lShoulderFKC_rotateZ";
	...
	setAttr -s 5 ".ktv[0:4]"  2 -78.349775430879276 10 -60.198190913310683
		 20 -9.2076776735109007 30 -79.04370578292982 40 -78.763862244961956;
	setAttr -s 5 ".kot[0:4]"  9 9 9 9 9;
createNode animCurveTA -n "Bony_rShoulderFKC_rotateX";
	...
	setAttr -s 5 ".ktv[0:4]"  2 39.024393182875592 10 4.3454120444444939
		 20 0 30 10.924828708035081 40 4.2931974715033023;
	setAttr -s 5 ".kot[0:4]"  9 9 9 9 9;
...
createNode animCurveTA -n "Bony_rShoulderFKC_rotateZ";
	...
	setAttr -s 5 ".ktv[0:4]"  2 -72.441530651896358 10 -65.105748295204961
		 20 0 30 -70.446755725630936 40 -66.745571903633859;
	setAttr -s 5 ".kot[0:4]"  9 9 9 9 9;
...
createNode animCurveTL -n "Bony_lFootIKC_translateX";
	...
	setAttr -s 6 ".ktv[0:5]"  2 0.75987781109038965 10 0.48931848289370666
		 20 -1.0022207499253453 30 0.39197858825327575 40 -0.38529221004378728 50 -0.082432304178553795;
...
createNode animCurveTL -n "Bony_lFootIKC_translateZ";
	...
	setAttr -s 6 ".ktv[0:5]"  2 1.1489702114594955 10 -0.80551033312619436
		 20 -1.0192749937681633 30 0.65321741896960317 40 -1.2280816285273857 50 -0.18496451901851912;
	setAttr -s 6 ".kot[0:5]"  9 9 9 9 9 9;
createNode animCurveTL -n "Bony_rFootIKC_translateX";
	...
	setAttr -s 6 ".ktv[0:5]"  2 -0.43303750818366343 10 -0.56879265666462431
		 20 2.0011573069349029 30 -0.61863282884994386 40 -0.25811005264232334 50 -0.43087438907623765;
	setAttr -s 6 ".kot[0:5]"  9 9 9 9 9 9;
createNode animCurveTL -n "Bony_rFootIKC_translateY";
	rename -uid "E2DAA435-AC4F-7995-7BCD-30AA1E10BC40";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  2 0 10 -0.32352787726545518 20 0 30 -2.248004596346878
		 40 -0.19830016331946676 50 -0.23141740848358383;
	setAttr -s 6 ".kot[0:5]"  9 9 9 9 9 9;
createNode animCurveTL -n "Bony_rFootIKC_translateZ";
	...
	setAttr -s 6 ".ktv[0:5]"  2 1.3314289827871271 10 0.77657531598741703
		 20 -0.46891004358085259 30 -1.0353965067417823 40 -0.55790572685087858 50 -1.7024648290196838;
	setAttr -s 6 ".kot[0:5]"  9 9 9 9 9 9;
...
createNode animCurveTA -n "Bony_rToeIKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 25.31438158644437 10 0 50 7.8494566218886206;
	setAttr -s 3 ".kot[0:2]"  9 9 9;
...
createNode animCurveTL -n "Bony_Main_CNT_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  2 0 6 0.831 10 0 20 0 40 0.38771706434487285
		 50 0;
	setAttr -s 6 ".kot[0:5]"  9 9 9 9 9 9;
