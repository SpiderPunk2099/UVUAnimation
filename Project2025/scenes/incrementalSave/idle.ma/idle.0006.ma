...
//Name: idle.ma
//Last modified: Mon, Nov 17, 2025 09:36:26 PM
//Codeset: UTF-8
...
fileInfo "UUID" "4010EA44-2D46-E0F6-5BDC-378CA9FA5102";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "14418298-494C-B6FD-4BCA-7790221B53EF";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "B47E631C-5B40-6D5E-FE33-49A903BA4A67";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "3FD3FA55-3944-0B05-4097-59B902442312";
createNode displayLayerManager -n "layerManager";
	rename -uid "92728DD1-2642-C37B-D558-5C970E5EB4E2";
createNode displayLayer -n "defaultLayer";
	rename -uid "8DFD831F-5946-0E65-ECA0-63A7B3E9B0F9";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "04EFF9C8-1045-148C-C7F5-E1B2D4454137";
...
createNode reference -n "Ultimate_Bony_v1_0_5RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" 36.463 0 0"
		2 "|Ultimate_Bony_v1_0_5:Bony|Ultimate_Bony_v1_0_5:Bony_Main_CNT|Ultimate_Bony_v1_0_5:Bony_Spine02FKCG|Ultimate_Bony_v1_0_5:Bony_Spine02FKC" 
		"rotatePivotTranslate" " -type \"double3\" 0 0 0"
...
createNode animCurveTA -n "Bony_Neck01C_rotateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 0.6432971672566743 20 0.64329716725667263
