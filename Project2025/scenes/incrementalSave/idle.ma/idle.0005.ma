...
//Name: idle.ma
//Last modified: Mon, Nov 17, 2025 12:02:41 PM
//Codeset: UTF-8
...
fileInfo "UUID" "3829F820-9048-4D7B-A669-139D02C93040";
createNode transform -s -n "persp";
	rename -uid "3EBBE575-6E48-0E24-E94A-E4B30819795E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 10.229743869490525 4.6637508450489067 14.124030700408065 ;
	setAttr ".r" -type "double3" -5.1383527295901006 1119.3999999994958 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "A2BCF7BA-5B40-3FF6-F6F5-BF96076B2576";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 15.940021485290918;
...
createNode transform -n "pCube1";
	...
	setAttr ".t" -type "double3" -1.453006280576937 3.9030535392418813 2.6405058693841852 ;
	setAttr ".r" -type "double3" 5.4671591431634541 -17.560901148740047 -193.37782288692105 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "D6A56A83-4B4F-98F4-84D1-1C924B30AACD";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "68F61773-0E44-50F3-8AF7-E5993BA4587F";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "03C9CCCF-7C47-0F10-6FBD-8AA70E52B9B0";
createNode displayLayerManager -n "layerManager";
	rename -uid "E24340AE-F049-EC85-5720-3F804298B732";
createNode displayLayer -n "defaultLayer";
	rename -uid "8DFD831F-5946-0E65-ECA0-63A7B3E9B0F9";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "BDA02618-D342-27D0-D84E-378342A6A20E";
...
createNode reference -n "Ultimate_Bony_v1_0_5RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" 33.30344085131052623 0 0"
		2 "|Ultimate_Bony_v1_0_5:Bony|Ultimate_Bony_v1_0_5:Bony_Main_CNT|Ultimate_Bony_v1_0_5:Bony_Spine02FKCG|Ultimate_Bony_v1_0_5:Bony_Spine02FKC" 
		"rotatePivotTranslate" " -type \"double3\" 0 0 0"
...
createNode animCurveTL -n "Bony_ROOTC_translateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 -2.1908435819613352 17 -2.0146757239311395
		 31 -2.3218306138911684 40 -2.1908435819613352;
createNode animCurveTL -n "Bony_lFootIKC_translateX";
	rename -uid "CFC0503A-4848-3B69-7A4F-C49580DB2324";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  2 1.0904489178390151;
	setAttr ".kot[0]"  5;
...
createNode animCurveTL -n "Bony_lFootIKC_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  2 0.90062544413862389;
	setAttr ".kot[0]"  5;
createNode animCurveTL -n "Bony_ROOTC_translateX";
	rename -uid "95FD5294-324C-94B8-8418-668CD65F7D3B";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 0 17 0 31 0 40 0;
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 2 -max 40 -ast 2 -aet 40 ";
	setAttr ".st" 6;
createNode animCurveTA -n "Bony_Neck01C_rotateX";
	rename -uid "41EE5E54-4142-F8CC-8B1B-06A9678BFEEA";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 15.467683791674343 17 11.204654104819387
		 31 15.467683791674343 40 15.467683791674343;
	setAttr -s 4 ".kit[3]"  1;
	setAttr -s 4 ".kot[3]"  1;
	setAttr -s 4 ".kix[3]"  0.99298843416396265;
	setAttr -s 4 ".kiy[3]"  -0.11821154603760763;
	setAttr -s 4 ".kox[3]"  0.99298843416396265;
	setAttr -s 4 ".koy[3]"  -0.11821154603760763;
createNode animCurveTA -n "Bony_rElbowFKC_rotateY";
	rename -uid "ED56D73D-ED4A-629D-92E7-4997F807C817";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  2 -118.63975902711201;
createNode animCurveTA -n "Bony_rShoulderFKC_rotateX";
	rename -uid "1EEB9A56-0446-64C6-5FB3-65A4DC8C82EA";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 -40.353897321443448 17 -38.408689933939101
		 31 -40.353897321443448;
createNode animCurveTA -n "Bony_lElbowFKC_rotateY";
	rename -uid "7CFC3A4A-CF49-951A-DB7E-43AC0176A441";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 -31.865524047428128 17 -37.917088989151971
		 31 -31.866;
createNode animCurveTA -n "Bony_lShoulderFKC_rotateX";
	rename -uid "C183D4BA-6D40-3665-7D12-A1B6438724CD";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 52.617797787598384 17 56.082589264420001
		 31 52.617797787598384;
createNode animCurveTA -n "Bony_lShoulderFKC_rotateZ";
	rename -uid "50192A01-BA45-1DBC-6908-258C674B458D";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 -54.921493427959625 17 -58.676467038509543
		 31 -54.921493427959625;
createNode animCurveTA -n "Bony_lFinger1J1C_rotateZ";
	rename -uid "37B381D9-8949-45E5-767D-58947131A36D";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  2 -42.260674244675847;
...
createNode animCurveTA -n "Bony_lFinger1J3C_rotateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  2 -30.256091366668429;
...
createNode animCurveTA -n "Bony_lThumbJ2C_rotateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  2 -56.207568189389569;
createNode animCurveTA -n "Bony_HeadC_rotateX";
	rename -uid "3C03FD59-8E48-FC7E-4124-E3A7B17034D1";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 -52.136849679935345 17 -55.788133709957563
		 31 -52.136849679935345;
createNode animCurveTA -n "Bony_HeadC_rotateY";
	rename -uid "A787B449-8E4B-B890-016E-8183AAA72F1A";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 18.137998602678675 17 19.363944267795961
		 31 18.137998602678675;
createNode animCurveTA -n "Bony_HeadC_rotateZ";
	rename -uid "D7E54CE8-B14E-7604-A2FF-48A12D31398A";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 -6.5935049112928121 17 -8.4760223059143556
		 31 -6.5935049112928121;
...
createNode animCurveTA -n "Bony_rFinger1J1C_rotateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  2 -45.535858100219187;
...
createNode animCurveTA -n "Bony_rFinger1J3C_rotateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  2 -84.275710745711336;
...
createNode animCurveTA -n "Bony_Neck01C_rotateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 0.6432971672566743 17 0.64329716725667285
		 31 0.6432971672566743 40 0.6432971672566743;
	setAttr -s 4 ".kit[3]"  1;
	setAttr -s 4 ".kot[3]"  1;
	setAttr -s 4 ".kix[3]"  1;
	setAttr -s 4 ".kiy[3]"  0;
...
createNode animCurveTA -n "Bony_Neck01C_rotateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 -0.81021183547331532 17 -0.81021183547331677
		 31 -0.81021183547331532 40 -0.81021183547331532;
	setAttr -s 4 ".kit[3]"  1;
	setAttr -s 4 ".kot[3]"  1;
	setAttr -s 4 ".kix[3]"  1;
	setAttr -s 4 ".kiy[3]"  0;
...
createNode animCurveTA -n "Bony_rShoulderFKC_rotateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 12.283122106727404 17 18.149051331455905
		 31 12.283122106727404;
createNode animCurveTA -n "Bony_rShoulderFKC_rotateZ";
	rename -uid "26EFF5A3-284D-9A48-A94B-99B0A7C002E0";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 7.7559737151811188 17 15.14814541820572
		 31 7.7559737151811188;
createNode animCurveTA -n "Bony_Spine03FKC_rotateX";
	rename -uid "3BD6F56F-C745-58FE-2278-F7AE990767C2";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 0 17 -3.9432559241249665 31 0;
createNode animCurveTA -n "Bony_Spine03FKC_rotateY";
	rename -uid "125AEEA9-B640-7295-02A8-42AF6D42FC5A";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 0 17 0 31 0;
...
createNode animCurveTA -n "Bony_lWristFKC_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 0 17 -10.079874762247629 31 0;
createNode animCurveTA -n "Bony_lWristFKC_rotateY";
	rename -uid "C985A110-D94B-4FFA-0187-1084F59C5B2B";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 0 17 -0.72349095940908059 31 0;
createNode animCurveTA -n "Bony_lWristFKC_rotateZ";
	rename -uid "81AE488C-F246-EE63-8586-84856A8BE591";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 0 17 -5.3700858096279847 31 0;
...
connectAttr "Bony_rFinger1J1C_rotateX.o" "Ultimate_Bony_v1_0_5RN.phl[46]";
connectAttr "Bony_rFinger1J1C_rotateY.o" "Ultimate_Bony_v1_0_5RN.phl[47]";
...
connectAttr "Bony_rFinger2J1C_rotateX.o" "Ultimate_Bony_v1_0_5RN.phl[50]";
connectAttr "Bony_rFinger2J1C_rotateY.o" "Ultimate_Bony_v1_0_5RN.phl[51]";
connectAttr "Bony_rFinger2J3C_rotateZ.o" "Ultimate_Bony_v1_0_5RN.phl[52]";
