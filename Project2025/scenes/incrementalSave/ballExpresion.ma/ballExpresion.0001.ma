...
//Last modified: Sun, Jan 25, 2026 04:43:10 PM
//Codeset: UTF-8
...
fileInfo "UUID" "0C663A5C-EF46-CBA8-9357-039D65943AE4";
...
createNode animCurveTA -n "CTRL_Main_rotateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  2 0 4 12.801915455539135 16 0 22 -12.802
		 28 -12.802 34 -12.802 40 0;
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 2 -max 44 -ast 2 -aet 48 ";
	setAttr ".st" 6;
select -ne :time1;
	setAttr ".o" 43;
	setAttr ".unw" 43;
