...
//Name: rk rig.ma
//Last modified: Tue, Feb 17, 2026 02:52:51 PM
//Codeset: UTF-8
...
fileInfo "UUID" "E6B2D44D-4B4F-2026-1460-6DA27B3C5487";
createNode transform -s -n "persp";
	rename -uid "A6ECE5BE-6B42-7C10-7A6A-F7AB4DB0E03C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.0358741504167703 1.5882038225175781 15.56500438673903 ;
	setAttr ".r" -type "double3" 185.44885349999069 -532.00202120829488 179.99999999999429 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 15.588650189826652;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode joint -n "base_fk_jnt_1";
...
createNode joint -n "head_fk_jnt_3" -p "elbow_fk_jnt_2";
	...
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 1.3801203752913918;
createNode joint -n "base_base_fk_jnt_1";
...
createNode transform -n "transform1";
	rename -uid "47852C2F-6C4B-844D-85ED-50B1C6407040";
	setAttr ".t" -type "double3" 0 2.9030793683489313 0.010008524069302437 ;
	setAttr ".s" -type "double3" 0.98677730460254232 0.98677730460254232 0.98677730460254232 ;
createNode joint -n "base_base_fk_jnt_3" -p "transform1";
	rename -uid "95690048-FB4B-284E-1422-01A3C95C3DA2";
	setAttr ".t" -type "double3" 0 -2.8818025658763164 -0.017097034394737552 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jot" -type "string" "none";
	setAttr ".is" -type "double3" 0.98677730460254232 0.98677730460254232 0.98677730460254232 ;
	setAttr ".radi" 0.55965643367692952;
createNode fosterParent -n "lamp_modelRNfosterParent1";
	rename -uid "63550DB9-2A43-E8F7-75F1-BF93DC487029";
...
connectAttr "base_base_fk_jnt_3.iog" ":defaultLightSet.dsm" -na;
// End of rk rig.ma
