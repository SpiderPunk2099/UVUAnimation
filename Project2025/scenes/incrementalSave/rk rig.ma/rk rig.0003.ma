...
//Name: rk rig.ma
//Last modified: Tue, Feb 17, 2026 02:39:47 PM
//Codeset: UTF-8
...
fileInfo "UUID" "E17D88F8-6D4C-3E77-E99C-139046842EBC";
createNode transform -s -n "persp";
	rename -uid "A6ECE5BE-6B42-7C10-7A6A-F7AB4DB0E03C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.96825573587197766 20.091034775040015 -38.710280963465273 ;
	setAttr ".r" -type "double3" 165.04885350004344 2.3979730201010394 180 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 39.369471142652429;
...
createNode joint -n "elbow_jnt_2" -p "base_jnt_1";
...
createNode joint -n "head_jnt_3" -p "elbow_jnt_2";
	...
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 1.3801203752913918;
createNode joint -n "base_base_1";
	...
	setAttr ".dla" yes;
	setAttr ".radi" 0.5;
createNode joint -n "joint5" -p "base_base_1";
...
createNode fosterParent -n "lamp_modelRNfosterParent1";
	rename -uid "C6D73DFB-B14D-0CC7-25BB-65BD0E881241";
...
connectAttr "base_jnt_1.s" "elbow_jnt_2.is";
connectAttr "elbow_jnt_2.s" "head_jnt_3.is";
connectAttr "base_base_1.s" "joint5.is";
...
connectAttr "base_jnt_1.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[0].dn";
