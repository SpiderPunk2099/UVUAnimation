...
//Name: rk rig.ma
//Last modified: Tue, Feb 17, 2026 03:08:59 PM
//Codeset: UTF-8
...
fileInfo "UUID" "3A675F6E-7D43-B3E3-5117-7C9B4382929A";
createNode transform -s -n "persp";
	rename -uid "A6ECE5BE-6B42-7C10-7A6A-F7AB4DB0E03C";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 6.2503647729050051 6.0032804626241143 -1.2952549945359175 ;
	setAttr ".r" -type "double3" 153.04885349983502 -615.20202120825354 179.9999999999734 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 5.0222455321430184;
...
createNode joint -n "COG_jnt";
	...
	setAttr ".radi" 0.65;
createNode joint -n "base_base_fk_jnt_1" -p "COG_jnt";
	...
	setAttr ".s" -type "double3" 0.98677730460254232 0.98677730460254232 0.98677730460254232 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".radi" 0.5;
createNode joint -n "base_base_fk_jnt_2" -p "base_base_fk_jnt_1";
...
createNode joint -n "base_fk_jnt_1" -p "COG_jnt";
...
createNode joint -n "elbow_fk_jnt_2" -p "base_fk_jnt_1";
...
createNode joint -n "head_fk_jnt_3" -p "elbow_fk_jnt_2";
	rename -uid "1253C0FC-2A4F-1ABD-71E6-80857051EB7C";
	setAttr ".t" -type "double3" 3.5904643466395523e-15 18.239120899149551 1.6098233857064719e-15 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 1.3801203752913918;
createNode transform -n "group6";
	rename -uid "E6B026DA-0E46-636B-E515-A28D243F4398";
createNode transform -n "group5";
	rename -uid "1C70C766-524E-4699-F2AD-FE94307FFB56";
createNode transform -n "group4";
	rename -uid "82EE0C13-8640-6066-7516-589212776B72";
createNode transform -n "group3";
	rename -uid "EDB69D95-9D4E-CE15-CCBB-6FBE4B25B38A";
createNode transform -n "group2";
	rename -uid "22F7272E-244D-BD41-B648-64AB35AD29B1";
createNode transform -n "group1";
	rename -uid "35780F44-A249-7EFC-FA3C-46A678A5F67B";
createNode transform -n "null1" -p "group1";
	rename -uid "37ADF727-1649-17FC-A2FC-2B83031F766A";
createNode fosterParent -n "lamp_modelRNfosterParent1";
	rename -uid "47A8BD13-3E4F-735B-3B37-1AB0F204D393";
...
connectAttr "COG_jnt.s" "base_base_fk_jnt_1.is";
connectAttr "base_base_fk_jnt_1.s" "base_base_fk_jnt_2.is";
connectAttr "COG_jnt.s" "base_fk_jnt_1.is";
connectAttr "base_fk_jnt_1.s" "elbow_fk_jnt_2.is";
connectAttr "elbow_fk_jnt_2.s" "head_fk_jnt_3.is";
...
connectAttr "base_fk_jnt_1.msg" "MayaNodeEditorSavedTabsInfo.tgi[0].ni[0].dn";
