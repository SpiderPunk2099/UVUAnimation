...
//Name: robot_rig.ma
//Last modified: Mon, Mar 23, 2026 07:59:12 PM
//Codeset: UTF-8
...
fileInfo "UUID" "7E0725CE-1948-A617-19BC-D597782B7585";
createNode transform -s -n "persp";
	rename -uid "D1524135-F646-05E6-05B9-2596DA07A3E7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.68985088043821119 0.35800148393692932 -0.15749943380628914 ;
	setAttr ".r" -type "double3" -27.938352729578625 600.99999999990825 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 0.19627046442914814;
	setAttr ".ow" 0.1;
...
createNode joint -n "L_Finger_1_FK_Jnt";
	...
	setAttr ".radi" 4;
createNode joint -n "L_Finger_1_FK_Jnt1" -p "L_Finger_1_FK_Jnt";
	rename -uid "D12CF277-C64B-3A16-8C02-878BB0217D43";
	setAttr ".t" -type "double3" 0 -0.13080344849002454 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
...
createNode joint -n "L_Finger_2_FK_Jnt1" -p "L_Finger_2_FK_Jnt";
	...
	setAttr ".t" -type "double3" 0.13080344849002451 1.4522100021399591e-17 -8.7811354690052507e-33 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
...
createNode joint -n "L_Finger_3_FK_Jnt1" -p "L_Finger_3_FK_Jnt";
	...
	setAttr ".t" -type "double3" 1.4210854715202004e-16 -0.13080344849002451 -3.552713678800501e-17 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
...
createNode fosterParent -n "robot_modelRNfosterParent1";
	rename -uid "9FBE4CFB-1444-0358-9A87-7C90D14F8762";
...
connectAttr "L_Finger_1_FK_Jnt.s" "L_Finger_1_FK_Jnt1.is";
