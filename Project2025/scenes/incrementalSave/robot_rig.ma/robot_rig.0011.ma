...
//Name: robot_rig.ma
//Last modified: Mon, Mar 23, 2026 06:48:43 PM
//Codeset: UTF-8
...
fileInfo "UUID" "FF7EBC51-4E41-B059-CA69-81BBFD68F31C";
createNode transform -s -n "persp";
	rename -uid "D1524135-F646-05E6-05B9-2596DA07A3E7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.6038071669579819 0.33300768948016429 2.7761780048454505 ;
	setAttr ".r" -type "double3" 5.6616472704020948 374.59999999997797 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 3.2077990638902225;
	setAttr ".ow" 0.1;
...
createNode joint -n "left_Arm_3_Jnt" -p "left_Arm_2_Jnt";
	...
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" 90.000000000028905 2.121493103046062e-05 -89.999921933511004 ;
	setAttr ".radi" 4;
...
createNode fosterParent -n "robot_modelRNfosterParent1";
	rename -uid "A7E1C384-9440-F0CB-AFB7-EF8D4A5E0EB8";
