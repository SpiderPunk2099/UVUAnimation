...
//Name: robot_rig.ma
//Last modified: Mon, Mar 23, 2026 07:20:43 PM
//Codeset: UTF-8
...
fileInfo "UUID" "A7AB255C-214C-B1B5-F353-6FBACBB963B3";
createNode transform -s -n "persp";
	rename -uid "D1524135-F646-05E6-05B9-2596DA07A3E7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.27225949368456154 0.44556266939720451 0.90317190126493585 ;
	setAttr ".r" -type "double3" -2.7383527295982426 356.99999999995907 2.4882183616811808e-17 ;
...
createNode joint -n "left_Leg_1_Jnt" -p "left_Leg_Clav_Jnt";
	...
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "xzy";
	setAttr ".jo" -type "double3" 0 -90 90.000000000000412 ;
	setAttr ".radi" 4;
createNode joint -n "left_Leg_2_Jnt" -p "left_Leg_1_Jnt";
	rename -uid "FD9AF1AD-1D4F-1CD3-C13E-1DAAF4CAAD13";
	setAttr ".t" -type "double3" 0.32942268665588992 0 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" 7.35344242354365e-12 90 90.000000000008413 ;
	setAttr ".radi" 4;
createNode joint -n "left_Leg_3_Jnt" -p "left_Leg_2_Jnt";
	rename -uid "BEA4C20F-7A4A-02D2-3AA2-93AC9A97512D";
	setAttr ".t" -type "double3" -0.0056263486390678618 -0.40368227095194331 0.0051954489021996154 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" -90 8.4411247395214668e-12 -90.000000000000028 ;
	setAttr ".radi" 4;
...
createNode fosterParent -n "robot_modelRNfosterParent1";
	rename -uid "90183AB4-5A4E-A10D-058E-1093893E5313";
...
connectAttr "left_Leg_1_Jnt.s" "left_Leg_2_Jnt.is";
