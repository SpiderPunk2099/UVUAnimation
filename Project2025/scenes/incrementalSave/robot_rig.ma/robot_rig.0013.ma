...
//Name: robot_rig.ma
//Last modified: Mon, Mar 23, 2026 07:16:55 PM
//Codeset: UTF-8
...
fileInfo "UUID" "08624DEC-634D-A4E2-D930-F99D5664225B";
createNode transform -s -n "persp";
	rename -uid "D1524135-F646-05E6-05B9-2596DA07A3E7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.23798948716229454 0.60564775306089935 0.88307621671876069 ;
	setAttr ".r" -type "double3" -9.9383527295981846 355.39999999996292 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 1.2825953567725237;
	setAttr ".ow" 0.1;
...
createNode joint -n "left_Arm_1_Jnt";
	...
	setAttr ".radi" 4;
createNode joint -n "left_Arm_2_Jnt" -p "left_Arm_1_Jnt";
	...
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" -90.000021214931024 89.999921933510976 0 ;
	setAttr ".pa" -type "double3" 0 0 5 ;
	setAttr ".radi" 4;
createNode joint -n "left_Arm_3_Jnt" -p "left_Arm_2_Jnt";
	rename -uid "5263E15A-0C47-A4DE-1146-E0BCF199619D";
	setAttr ".t" -type "double3" 9.9740457045527368e-07 -0.72047439575184402 4.4408920985006263e-18 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" 90.000000000028905 2.1214931020938648e-05 -89.999921933511004 ;
	setAttr ".radi" 4;
...
createNode joint -n "left_Leg_Clav_Jnt";
	...
	setAttr ".radi" 4;
createNode joint -n "left_Leg_1_Jnt" -p "left_Leg_Clav_Jnt";
	...
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "xzy";
	setAttr ".jo" -type "double3" 0.1731904357244741 -90 90.000000000000412 ;
	setAttr ".radi" 4;
...
createNode joint -n "left_Leg_2_Jnt";
	...
	setAttr ".t" -type "double3" 0.28953433990478522 0.56983802501403225 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" 1.8313193880700842 0 0 ;
	setAttr ".radi" 4;
createNode joint -n "left_Leg_3_Jnt" -p "left_Leg_2_Jnt";
	rename -uid "BEA4C20F-7A4A-02D2-3AA2-93AC9A97512D";
	setAttr ".t" -type "double3" -0.0068995062146001733 -0.40336987885852649 0.016222269042094461 ;
	setAttr ".r" -type "double3" -0.050381178476490082 -0.91837192186596472 0.63031219634805413 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" 0.32056043920901051 182.30121479671342 89.020074273840663 ;
	setAttr ".radi" 4;
...
createNode fosterParent -n "robot_modelRNfosterParent1";
	rename -uid "645A0A61-DE46-B072-FBE4-38ADD3CC2A31";
...
connectAttr "left_Arm_1_Jnt.s" "left_Arm_2_Jnt.is";
connectAttr "left_Arm_2_Jnt.s" "left_Arm_3_Jnt.is";
connectAttr "left_Leg_Clav_Jnt.s" "left_Leg_1_Jnt.is";
connectAttr "left_Leg_2_Jnt.s" "left_Leg_3_Jnt.is";
