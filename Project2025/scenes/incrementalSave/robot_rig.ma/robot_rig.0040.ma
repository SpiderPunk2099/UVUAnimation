...
//Name: robot_rig.ma
//Last modified: Tue, Mar 24, 2026 05:26:58 PM
//Codeset: UTF-8
...
fileInfo "UUID" "D061D703-1F46-6941-E89A-CDB3EE531ED6";
createNode transform -s -n "persp";
	rename -uid "D1524135-F646-05E6-05B9-2596DA07A3E7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.8070600590003014 0.36833529059277809 0.23103102114276852 ;
	setAttr ".r" -type "double3" -9.9383527296030501 2582.599999999406 1.7278119126531992e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 0.68687772814017423;
	setAttr ".ow" 0.1;
...
createNode joint -n "L_Finger_3_FK_Jnt" -p "L_Arm_3_FK_Jnt";
	...
	setAttr ".t" -type "double3" 0.092983177891431373 -0.032761211988750566 -0.12590782681619986 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
...
createNode joint -n "L_Finger_3_Tip_FK_Jnt" -p "L_Finger_3_FK_Jnt";
	...
	setAttr ".t" -type "double3" 0.24271887220902658 2.8421709430404008e-16 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
...
createNode fosterParent -n "robot_modelRNfosterParent1";
	rename -uid "D73CA533-794E-8570-521C-5499F9F5A3E7";
