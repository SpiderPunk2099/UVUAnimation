...
//Name: robot_rig.ma
//Last modified: Tue, Mar 24, 2026 03:16:32 PM
//Codeset: UTF-8
...
fileInfo "UUID" "C1EDECEF-754B-41D4-1EBD-A9961DB46FA8";
createNode transform -s -n "persp";
	rename -uid "D1524135-F646-05E6-05B9-2596DA07A3E7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.31648341320131429 0.15651816339024741 0.56561843350374863 ;
	setAttr ".r" -type "double3" -15.938352729605898 2161.799999999746 9.9441402124816682e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 0.58095930672664364;
	setAttr ".ow" 0.1;
...
createNode joint -n "L_Toe_2_FK_Jnt";
	...
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" -89.999999999999957 6.3611093629270335e-15 -89.999999999999986 ;
	setAttr ".radi" 4;
createNode joint -n "L_Toe_3_FK_Jnt";
	...
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" -179.99999999999972 0 -89.999999999999957 ;
	setAttr ".radi" 4;
createNode joint -n "L_Finger_1_FK_Jnt";
	...
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" 21.000000000000018 0 -90 ;
	setAttr ".radi" 4;
...
createNode joint -n "L_Leg_3_FK_Jnt" -p "L_Leg_2_FK_Jnt";
	...
	setAttr ".pa" -type "double3" 0 0 -5 ;
	setAttr ".radi" 4;
createNode joint -n "L_Toe_1_FK_Jnt1";
	rename -uid "D7B36B0A-8843-6B40-9DCE-CFAF7DF58548";
	setAttr ".t" -type "double3" 0.068327531814575196 0.024077982902526857 -0.0041713076829910283 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" 0 0 -89.999999999999957 ;
	setAttr ".radi" 4;
createNode joint -n "L_Toe_2_FK_Jnt1";
	rename -uid "FC6B17E7-474D-5F19-7822-7B8BF7A4929D";
	setAttr ".t" -type "double3" 0.28953441619873049 0.030911107063293457 0.25793508529663084 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" -89.999999999999957 6.3611093629270335e-15 -89.999999999999986 ;
	setAttr ".radi" 4;
createNode joint -n "L_Toe_3_FK_Jnt1";
	rename -uid "4A75C4BB-6A4B-EFAD-02A9-C58F506D90E4";
	setAttr ".t" -type "double3" 0.51074111938476563 0.024077982902526857 -0.0041713076829910283 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
...
createNode fosterParent -n "robot_modelRNfosterParent1";
	rename -uid "65D7ACD2-2C47-9441-9EC0-D1BC0CB2DA17";
