...
//Name: robot_rig.ma
//Last modified: Mon, Mar 23, 2026 07:18:12 PM
//Codeset: UTF-8
...
fileInfo "UUID" "5788C6B0-934B-B43E-9F2A-0C81E8992EFE";
...
createNode joint -n "left_Leg_2_Jnt" -p "left_Leg_1_Jnt";
	...
	setAttr ".t" -type "double3" 0.32942268665588997 0 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" -178.16868061192989 73 -90.000000000000014 ;
	setAttr ".radi" 4;
createNode joint -n "left_Leg_3_Jnt" -p "left_Leg_2_Jnt";
	rename -uid "BEA4C20F-7A4A-02D2-3AA2-93AC9A97512D";
	setAttr ".t" -type "double3" -0.0068995062146001733 -0.40336987885852649 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" 0 180 90 ;
	setAttr ".radi" 4;
...
createNode fosterParent -n "robot_modelRNfosterParent1";
	rename -uid "BE5C4C17-A843-CA03-A7F3-11BBFEE44E01";
