...
//Name: robot_rig.ma
//Last modified: Mon, Mar 23, 2026 06:08:05 PM
//Codeset: UTF-8
...
fileInfo "UUID" "84141926-3B49-120E-C646-46892ED9BF35";
createNode transform -s -n "persp";
	rename -uid "D1524135-F646-05E6-05B9-2596DA07A3E7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.51177358312149734 2.265666792497357 3.1922934463949661 ;
	setAttr ".r" -type "double3" -20.738352729597857 348.99999999998272 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 3.7198384741940176;
	setAttr ".ow" 0.1;
...
createNode fosterParent -n "robot_modelRNfosterParent1";
	rename -uid "AE3B2CD0-5842-D239-D1CD-42B987D5FD39";
