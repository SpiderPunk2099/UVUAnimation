...
//Name: robot_rig.ma
//Last modified: Tue, Mar 24, 2026 03:27:30 PM
//Codeset: UTF-8
...
fileInfo "UUID" "FC93EE6D-5B40-E572-6B1A-4D8840F099D1";
createNode transform -s -n "persp";
	rename -uid "D1524135-F646-05E6-05B9-2596DA07A3E7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.22786483063075072 1.8089504588634333 5.1235315474287777 ;
	setAttr ".r" -type "double3" -12.338352729596689 2514.5999999995088 1.9967081373069968e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 5.3701206067883485;
	setAttr ".ow" 0.1;
...
createNode joint -n "R_Arm_2_FK_Jnt" -p "R_Arm_1_FK_Jnt";
	...
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "xzy";
	setAttr ".jo" -type "double3" 6.8559409014348613 -1.8044773432163232e-08 3.0124407821419609e-07 ;
	setAttr ".pa" -type "double3" 0 0 5 ;
	setAttr ".radi" 4;
...
createNode joint -n "R_Finger_1_FK_Jnt" -p "R_Arm_3_FK_Jnt";
	...
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" 89.567822851377528 7.0057196074395025e-05 -8.2898984422795469e-05 ;
	setAttr ".radi" 4;
...
createNode joint -n "R_Finger_2_FK_Jnt" -p "R_Arm_3_FK_Jnt";
	...
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "xzy";
	setAttr ".jo" -type "double3" 159.43217714845113 0.00014652631499514039 -3.8897193290442134e-05 ;
	setAttr ".radi" 4;
...
createNode fosterParent -n "robot_modelRNfosterParent1";
	rename -uid "A38EE8E0-A745-0FAB-E973-1EB4A243443D";
