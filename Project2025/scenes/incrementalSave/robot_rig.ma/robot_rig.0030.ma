...
//Name: robot_rig.ma
//Last modified: Tue, Mar 24, 2026 03:06:34 PM
//Codeset: UTF-8
...
fileInfo "UUID" "CE12ACDD-C046-F0B2-8DE2-4FAB4E40A2CC";
createNode transform -s -n "persp";
	rename -uid "D1524135-F646-05E6-05B9-2596DA07A3E7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.4819111130112352 0.19920715347874587 0.14184021312932074 ;
	setAttr ".r" -type "double3" -7.5383527296917263 789.00000000009493 -1.1093886484243213e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 0.44942617360813297;
	setAttr ".ow" 0.1;
...
createNode joint -n "L_Finger_1_Tip_FK_Jnt" -p "L_Finger_1_FK_Jnt";
	...
	setAttr ".t" -type "double3" 0.2427188722090266 -1.4210854715202004e-16 0 ;
...
createNode fosterParent -n "robot_modelRNfosterParent1";
	rename -uid "F655C37C-D748-C9E3-5DEF-A4A778D086F6";
