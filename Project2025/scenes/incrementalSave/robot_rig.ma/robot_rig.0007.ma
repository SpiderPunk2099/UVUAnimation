...
//Name: robot_rig.ma
//Last modified: Mon, Mar 23, 2026 06:32:16 PM
//Codeset: UTF-8
...
fileInfo "UUID" "68425BEF-D742-A973-4C5C-4EA26EE67437";
createNode transform -s -n "persp";
	rename -uid "D1524135-F646-05E6-05B9-2596DA07A3E7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.21245737628888997 1.4418347214838714 3.5773159041638167 ;
	setAttr ".r" -type "double3" -7.538352729598059 360.19999999998066 9.939293933153438e-17 ;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode joint -n "right_Arm_1_Jnt";
	...
	setAttr ".jo" -type "double3" 79.417126900051557 -1.2040689529083142 -6.4170977026997793 ;
	setAttr ".radi" 4;
createNode joint -n "right_Arm_2_Jnt";
	...
	setAttr ".jo" -type "double3" -111.44077956979939 -2.123548570224807e-05 90.000072807379624 ;
	setAttr ".radi" 4;
createNode joint -n "right_Arm_3_Jnt";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -111.44077956979937 -2.1235485702248067e-05 90.000072807379624 ;
	setAttr ".radi" 4;
createNode joint -n "right_Finger_1_Jnt";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 27.896420473241449 -17.301081192216259 37.518653561509375 ;
	setAttr ".radi" 4;
createNode joint -n "right_Finger_2_Jnt";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 179.99996709687372 55.44435327233289 179.99997290178484 ;
	setAttr ".radi" 4;
createNode joint -n "right_Finger_3_Jnt";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 149.84504061702927 -55.395250079028159 -179.9999729514376 ;
	setAttr ".radi" 4;
createNode joint -n "right_Toe_1_Jnt";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -146.46882312504172 8.406585917792734 151.92247913210002 ;
	setAttr ".radi" 4;
createNode joint -n "right_Toe_2_Jnt";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 12.997956753149206 133.68661879632666 9.4764555163616766 ;
	setAttr ".radi" 4;
createNode joint -n "right_Toe_3_Jnt";
	rename -uid "A301EB09-C94A-A513-7311-F99E4C435916";
	setAttr ".t" -type "double3" -0.18400512695312493 0.06031445503234862 -0.0041713279485702517 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 135.19182657594354 -46.313310752754276 170.52356802770885 ;
	setAttr ".radi" 4;
createNode joint -n "right_Leg_3_Jnt";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 87.401389967577856 8.898491198099429e-06 -45.166178411918978 ;
	setAttr ".radi" 4;
createNode joint -n "right_Leg_2_Jnt";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 179.99999999997814 -1.8327832577040666 -89.999999999956614 ;
	setAttr ".radi" 4;
createNode joint -n "right_Leg_1_Jnt";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 89.826552175302567 -1.8295252051842794 -89.999999999999972 ;
	setAttr ".radi" 4;
createNode joint -n "right_Leg_Clav_Jnt";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -91.269367778144399 -0.43136270167699409 -171.84565161152946 ;
	setAttr ".radi" 4;
createNode joint -n "spine_1_Jnt";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -90.360181054960094 0.87400316963775326 -112.39785141224338 ;
	setAttr ".radi" 4;
createNode joint -n "left_Leg_Clav_Jnt";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -91.01662981154881 -0.87400321820315363 112.39784368590634 ;
	setAttr ".radi" 4;
createNode joint -n "left_Leg_1_Jnt";
	rename -uid "4BCFC30F-F940-4135-5412-3790EEEBE148";
	setAttr ".t" -type "double3" 0.28953433990478517 0.89926071166992216 -0.027601542472839365 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 91.786399428160124 0.43136270167699187 171.84565161152952 ;
	setAttr ".radi" 4;
createNode joint -n "left_Leg_2_Jnt";
	rename -uid "FD9AF1AD-1D4F-1CD3-C13E-1DAAF4CAAD13";
	setAttr ".t" -type "double3" 0.28953433990478511 0.57000595092773443 -0.017084455490112366 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 3.5817627674886108e-10 1.829525205185663 89.9999999999566 ;
	setAttr ".radi" 4;
createNode joint -n "left_Leg_3_Jnt";
	rename -uid "BEA4C20F-7A4A-02D2-3AA2-93AC9A97512D";
	setAttr ".t" -type "double3" 0.28953433990478511 0.16645759582519531 -0.0041713047027587807 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 88.157491465544624 1.8327832577039445 90.000000000000028 ;
	setAttr ".radi" 4;
createNode joint -n "left_Toe_1_Jnt";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 29.128564298723035 -8.898491220760879e-06 45.166178411918985 ;
	setAttr ".radi" 4;
createNode joint -n "left_Toe_2_Jnt";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 12.997939727771188 133.68668924724571 9.476431972291067 ;
	setAttr ".radi" 4;
createNode joint -n "left_Toe_3_Jnt";
	rename -uid "1A3E6F65-5E42-87FD-F5AE-EFBE5C64B395";
	setAttr ".t" -type "double3" 0.39506351470947276 0.060314455032348634 -0.0041713279485702335 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -127.70722949858785 -46.313381203673352 170.52354448363837 ;
	setAttr ".radi" 4;
createNode joint -n "left_Finger_1_Jnt";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 163.23878786422853 -8.4065859177927553 -151.92247913209999 ;
	setAttr ".radi" 4;
createNode joint -n "left_Finger_2_Jnt";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 179.99996713775437 55.395250079028223 179.99997295143754 ;
	setAttr ".radi" 4;
createNode joint -n "left_Finger_3_Jnt";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 128.04247860842329 -55.444353272332968 -179.99997290178479 ;
	setAttr ".radi" 4;
createNode joint -n "left_Arm_3_Jnt";
	rename -uid "5263E15A-0C47-A4DE-1146-E0BCF199619D";
	setAttr ".t" -type "double3" 0.99590316772460952 0.40921493530273439 -0.036970138549804701 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -102.8629663569089 17.301081192216262 -37.518653561509431 ;
	setAttr ".radi" 4;
createNode joint -n "left_Arm_2_Jnt";
	rename -uid "B68FE5A5-9B4A-EEBE-F156-5FA585C32A74";
	setAttr ".t" -type "double3" 0.99590408325195312 1.1296893310546876 -0.036969871520996088 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -91.211660782462673 2.119375433604323e-05 -90.000075355570985 ;
	setAttr ".radi" 4;
createNode joint -n "left_Arm_1_Jnt";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -91.211660782462602 2.1193754340814055e-05 -90.000075355570985 ;
	setAttr ".radi" 4;
createNode joint -n "spine_2_Jnt";
	rename -uid "B4B91ECB-E547-101A-788E-0592E5203D49";
	setAttr ".t" -type "double3" 0 1.7137908935546875 -0.01590564727783203 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 79.417126900051571 1.2040689529083171 6.4170977026997669 ;
	setAttr ".radi" 4;
createNode fosterParent -n "robot_modelRNfosterParent1";
	rename -uid "5CC82AD2-FD43-22C4-B2F3-A8BFAA29DF0D";
