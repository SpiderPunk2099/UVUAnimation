...
//Name: robot_rig.ma
//Last modified: Tue, Mar 24, 2026 03:23:25 PM
//Codeset: UTF-8
...
fileInfo "UUID" "C1B2AF8B-4C40-E11C-497C-61A14B821ED8";
createNode transform -s -n "persp";
	rename -uid "D1524135-F646-05E6-05B9-2596DA07A3E7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.19431243025800699 0.51203270230035136 1.7791076678681053 ;
	setAttr ".r" -type "double3" -11.138352729596697 2508.9999999995121 2.0250525957688842e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 1.8789836818193888;
	setAttr ".ow" 0.1;
...
createNode fosterParent -n "robot_modelRNfosterParent1";
	rename -uid "2635D894-FA44-AB65-90F9-81AD2D2D6B69";
