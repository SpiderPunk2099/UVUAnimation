...
//Name: robot_rig.ma
//Last modified: Mon, Mar 23, 2026 06:45:37 PM
//Codeset: UTF-8
...
fileInfo "UUID" "63495AF9-254B-457A-AA72-5C8880C08956";
...
createNode joint -n "left_Arm_3_Jnt" -p "left_Arm_2_Jnt";
	...
	setAttr ".t" -type "double3" 9.9740457045527368e-07 -0.72047439575184402 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" 90.000000000028919 2.1214931027280069e-05 -89.99992193351099 ;
	setAttr ".radi" 4;
...
createNode fosterParent -n "robot_modelRNfosterParent1";
	rename -uid "673F9B52-474A-226A-1B19-04911996D83E";
