...
//Name: robot_rig.ma
//Last modified: Mon, Mar 23, 2026 07:44:04 PM
//Codeset: UTF-8
...
fileInfo "UUID" "8D8BDFB3-2241-BBF8-1959-ACBB67C1550E";
createNode transform -s -n "persp";
	rename -uid "D1524135-F646-05E6-05B9-2596DA07A3E7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.60528442214901534 1.529421794532783 0.84154235979996861 ;
	setAttr ".r" -type "double3" -21.938352729598925 386.59999999994608 -1.778526875130937e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 1.5837737284069267;
	setAttr ".ow" 0.1;
...
createNode joint -n "spine_2_FK_Jnt" -p "spine_1_FK_Jnt";
	...
	setAttr ".radi" 4;
createNode joint -n "L_Arm_1_FK_Jnt";
...
createNode joint -n "hip_FK_Jnt";
	...
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "xzy";
	setAttr ".jo" -type "double3" 90.000000033597857 -3.1805546814635168e-15 -89.999997996681358 ;
	setAttr ".radi" 6;
createNode joint -n "L_Leg_Clav_FK_Jnt" -p "hip_FK_Jnt";
	rename -uid "C0112524-2B42-4B8D-F029-FFBBF4AAAE6D";
	setAttr ".t" -type "double3" 0.24106807723029292 0.01938085444532265 -0.099657460338565373 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jo" -type "double3" -5.5417576487676206 89.999997996399657 0 ;
	setAttr ".radi" 4;
...
createNode fosterParent -n "robot_modelRNfosterParent1";
	rename -uid "4ECD5669-EE42-A660-4635-16A4C092B9F6";
