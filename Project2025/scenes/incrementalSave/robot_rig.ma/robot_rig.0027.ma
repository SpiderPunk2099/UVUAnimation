...
//Name: robot_rig.ma
//Last modified: Mon, Mar 23, 2026 08:18:31 PM
//Codeset: UTF-8
...
fileInfo "UUID" "73FD3F0D-EF44-CD46-36F6-5BB92117E44A";
createNode transform -s -n "persp";
	rename -uid "D1524135-F646-05E6-05B9-2596DA07A3E7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.70699566552718784 0.34365245348415374 0.015377441450052954 ;
	setAttr ".r" -type "double3" -31.538352729685077 649.80000000010693 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 0.27654546602593821;
	setAttr ".ow" 0.1;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode joint -n "R_Arm_1_FK_Jnt";
	...
	setAttr ".radi" 4;
createNode joint -n "R_Arm_2_FK_Jnt";
	...
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 4;
createNode joint -n "R_Arm_3_FK_Jnt";
	...
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 4;
createNode joint -n "R_Finger_1_FK_Jnt";
	...
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 4;
createNode joint -n "R_Finger_2_FK_Jnt";
	...
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 4;
createNode joint -n "R_Finger_3_FK_Jnt";
	...
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 4;
createNode joint -n "R_Toe_1_FK_Jnt";
	...
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 4;
createNode joint -n "R_Toe_2_FK_Jnt";
	...
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 4;
createNode joint -n "R_Toe_3_FK_Jnt";
	...
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 4;
createNode joint -n "R_Leg_3_FK_Jnt";
	...
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 4;
createNode joint -n "R_Leg_2_FK_Jnt";
	...
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 4;
createNode joint -n "R_Leg_1_FK_Jnt";
	...
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 4;
createNode joint -n "R_Leg_Clav_FK_Jnt";
	...
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 4;
createNode joint -n "L_Toe_1_FK_Jnt";
	...
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 4;
createNode joint -n "L_Toe_2_FK_Jnt";
	...
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 4;
createNode joint -n "L_Toe_3_FK_Jnt";
	...
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 4;
createNode joint -n "L_Finger_1_FK_Jnt";
	...
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" 0 -21.000000000000011 0 ;
	setAttr ".radi" 4;
createNode joint -n "L_Finger_2_FK_Jnt";
	...
	setAttr ".radi" 4;
createNode joint -n "L_Finger_2_FK_Jnt1" -p "L_Finger_2_FK_Jnt";
	rename -uid "625DADD7-3844-1E03-6BCD-1B974A749C80";
	setAttr ".t" -type "double3" 0.24271887220902666 2.6947208043751249e-17 -1.291952777196612e-32 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 4;
createNode joint -n "L_Finger_3_FK_Jnt";
	...
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" 0 200 0 ;
	setAttr ".radi" 4;
createNode joint -n "L_Finger_3_FK_Jnt1" -p "L_Finger_3_FK_Jnt";
	rename -uid "6CC6F687-E347-D3B8-28C8-A5A10E6CF4B1";
	setAttr ".t" -type "double3" 1.4210854715202004e-16 -0.24271887220902666 -3.552713678800501e-17 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
...
createNode joint -n "L_Leg_3_FK_Jnt" -p "L_Leg_2_FK_Jnt";
	...
	setAttr ".pa" -type "double3" 0 0 -5 ;
	setAttr ".radi" 4;
createNode transform -n "TARGET_LOC";
	rename -uid "C0EDC0BF-EE45-567D-9C92-7DAFD9CDE057";
	setAttr ".t" -type "double3" 0.87433834772919583 0.073512740135192878 -0.08463347432163891 ;
	setAttr ".r" -type "double3" 0 0 -90 ;
	setAttr ".s" -type "double3" 0.05 0.05 0.05 ;
createNode locator -n "TARGET_LOCShape" -p "TARGET_LOC";
	rename -uid "694BCA80-6F4F-260F-C814-C3B476146A08";
	setAttr -k off ".v";
createNode joint -n "L_Finger_1_FK_Jnt1";
	rename -uid "D12CF277-C64B-3A16-8C02-878BB0217D43";
	setAttr ".t" -type "double3" 0.87480667114257815 0.073512740950153116 -0.08452690124511722 ;
	...
	setAttr ".jo" -type "double3" 0 -21.000000000000011 0 ;
	setAttr ".radi" 4;
createNode transform -n "UP_LOC";
	rename -uid "9F3D03A0-9341-A2BB-29B9-09BC886FF9EE";
	setAttr ".t" -type "double3" 0.86730758666992191 0.31595989227294924 -0.064308371543884274 ;
	setAttr ".s" -type "double3" 0.05 0.05 0.05 ;
createNode locator -n "UP_LOCShape" -p "UP_LOC";
	rename -uid "054A0BED-CF43-B4A3-51CA-42BFFA74887C";
	setAttr -k off ".v";
createNode fosterParent -n "robot_modelRNfosterParent1";
	rename -uid "425FCA4D-A842-52C6-4862-A7AD0EC2F751";
...
createNode mesh -n "Robot_GeoShapeDeformed" -p "robot_modelRNfosterParent1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.74402070045471191 0.61119472980499268 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
connectAttr "L_Finger_2_FK_Jnt.s" "L_Finger_2_FK_Jnt1.is";
connectAttr "L_Finger_3_FK_Jnt.s" "L_Finger_3_FK_Jnt1.is";
