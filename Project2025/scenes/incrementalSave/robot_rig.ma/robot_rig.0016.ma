...
//Name: robot_rig.ma
//Last modified: Mon, Mar 23, 2026 07:21:58 PM
//Codeset: UTF-8
...
fileInfo "UUID" "2587152F-6B4C-F3A0-0062-0DAB44773004";
...
createNode joint -n "left_Arm_3_Jnt" -p "left_Arm_2_Jnt";
	...
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" 90.000000000028905 2.1214931020938652e-05 -89.999921933511004 ;
	setAttr ".radi" 4;
...
createNode joint -n "left_Leg_1_Jnt" -p "left_Leg_Clav_Jnt";
	...
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "xzy";
	setAttr ".jo" -type "double3" 0 -90 90.000000000000426 ;
	setAttr ".radi" 4;
createNode joint -n "left_Leg_2_Jnt" -p "left_Leg_1_Jnt";
	...
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" -90.000000000008427 89.999999999999986 0 ;
	setAttr ".radi" 4;
createNode joint -n "left_Leg_3_Jnt" -p "left_Leg_2_Jnt";
	...
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" -90 3.1805546814635176e-15 -90.000000000000043 ;
	setAttr ".radi" 4;
...
createNode fosterParent -n "robot_modelRNfosterParent1";
	rename -uid "0D1C6E13-6E48-EFD8-FBDD-C4B20F74A3D6";
