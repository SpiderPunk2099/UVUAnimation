...
//Name: robot_rig.ma
//Last modified: Mon, Mar 23, 2026 07:26:41 PM
//Codeset: UTF-8
...
fileInfo "UUID" "3EAE2B47-534B-E10C-5487-4ABE68FBA597";
createNode transform -s -n "persp";
	rename -uid "D1524135-F646-05E6-05B9-2596DA07A3E7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.29523448680591302 0.88984001709118443 1.8363112962060502 ;
	setAttr ".r" -type "double3" -11.138352729598399 353.79999999995215 9.9977103475918096e-17 ;
...
createNode joint -n "left_Leg_2_Jnt" -p "left_Leg_1_Jnt";
	...
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".jo" -type "double3" -90.000000000008441 90 0 ;
	setAttr ".radi" 4;
...
createNode fosterParent -n "robot_modelRNfosterParent1";
	rename -uid "71EF30B4-8B4A-7728-A370-C4A97D193E43";
