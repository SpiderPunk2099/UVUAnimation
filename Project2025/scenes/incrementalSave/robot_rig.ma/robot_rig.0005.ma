...
//Name: robot_rig.ma
//Last modified: Mon, Mar 23, 2026 06:08:26 PM
//Codeset: UTF-8
...
fileInfo "UUID" "88D19D07-7142-82CB-9F32-62A384FACB95";
createNode transform -s -n "persp";
	rename -uid "D1524135-F646-05E6-05B9-2596DA07A3E7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.41514522834648815 1.0994561677422305 0.51711140887776841 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 0.88913583567275356;
	setAttr ".ow" 0.1;
...
createNode fosterParent -n "robot_modelRNfosterParent1";
	rename -uid "CCDCC562-CE4F-7F61-3140-5E8735DF6155";
