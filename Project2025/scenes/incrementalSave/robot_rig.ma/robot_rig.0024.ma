...
//Name: robot_rig.ma
//Last modified: Mon, Mar 23, 2026 07:55:48 PM
//Codeset: UTF-8
...
fileInfo "UUID" "FAF28BF5-4248-FC37-C8FD-EC8B31544B63";
createNode transform -s -n "persp";
	rename -uid "D1524135-F646-05E6-05B9-2596DA07A3E7";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.3796889511605168 0.47506012009987986 -0.19325663860130846 ;
	setAttr ".r" -type "double3" -41.13835272958147 461.79999999991367 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 0.41202509087582245;
	setAttr ".ow" 0.1;
...
createNode joint -n "L_Finger_1_FK_Jnt1" -p "L_Finger_1_FK_Jnt";
	...
	setAttr ".t" -type "double3" 0 -0.13080344849002451 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
...
createNode fosterParent -n "robot_modelRNfosterParent1";
	rename -uid "D53C0B54-4444-C164-F3D4-06BFFB6DB423";
