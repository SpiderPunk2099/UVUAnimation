...
//Name: botRig.ma
//Last modified: Mon, Mar 09, 2026 08:14:07 PM
//Codeset: UTF-8
...
fileInfo "UUID" "798290D2-604F-86FF-6A4E-63A19829CB40";
createNode transform -s -n "persp";
	rename -uid "A914F8FA-F447-5BF6-3324-82B59C183066";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -4.1476752247507349 0.72774948047639276 0.59995102756086627 ;
	setAttr ".r" -type "double3" -9.1356103152639516 2082.9999999990778 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 3.8981142437418823;
	setAttr ".ow" 0.1;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 10.278451990793052 0.24264875429872093 0.30046951806429012 ;
...
createNode joint -n "joint4";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 35.790794978557244 -41.395423323241118 -29.310240104586718 ;
	setAttr ".radi" 2;
createNode joint -n "joint5" -p "joint4";
	rename -uid "943A84DE-8C4C-6C25-099F-2BA0DF80D377";
	setAttr ".t" -type "double3" 0.42040620777805521 3.511457453882147e-17 2.5489454411264329e-17 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "joint8" -p "joint4";
	...
	setAttr ".t" -type "double3" 0.12645885127305673 -0.21935031331990321 -0.29151732233495137 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "joint12" -p "joint4";
	...
	setAttr ".t" -type "double3" 0.048938859912611557 -0.016505888715812895 0.40499602220782549 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "joint15" -p "joint4";
	...
	setAttr ".t" -type "double3" -0.24946444890599023 -0.24981334509321371 0.1585559171266647 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 152.81624976307288 -11.487315471284907 -142.11469176089599 ;
	setAttr ".radi" 2;
createNode joint -n "joint16" -p "joint15";
	rename -uid "3CB47643-3444-42B7-8551-868A2FB31C6A";
	setAttr ".t" -type "double3" 0.32267528774832938 -0.13761093219449336 0.052717026367249134 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 70.169099636389248 26.702152486504485 41.628466415206695 ;
...
createNode fosterParent -n "rover_modelRNfosterParent1";
	rename -uid "BEA5CEA1-2340-5AD0-6136-768C4CF61F85";
