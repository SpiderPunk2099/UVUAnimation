...
//Name: botRig.ma
//Last modified: Mon, Mar 09, 2026 05:48:55 PM
//Codeset: UTF-8
...
fileInfo "UUID" "61A88AEB-8846-A884-0B14-4DABE1FB661C";
createNode transform -s -n "persp";
	rename -uid "A914F8FA-F447-5BF6-3324-82B59C183066";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.7397130659694011 0.63401241891490079 0.20828066355115568 ;
	setAttr ".r" -type "double3" -1.9356103173135104 447.79999999998734 5.1783280243245215e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 2.2999263364672915;
	setAttr ".ow" 0.1;
...
createNode fosterParent -n "rover_modelRNfosterParent1";
	rename -uid "449216B5-1646-3899-ED64-6CAF26041814";
...
createNode reference -n "rover_modelRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		5 4 "rover_modelRN" "rover_model:Body_GeoSG.dagSetMembers" "rover_modelRN.placeHolderList[12]" 
		""
		5 4 "rover_modelRN" "rover_model:Body_GeoSG.dagSetMembers" "rover_modelRN.placeHolderList[13]" 
		""
		5 4 "rover_modelRN" "rover_model:Body_GeoSG.dagSetMembers" "rover_modelRN.placeHolderList[14]" 
		""
		5 4 "rover_modelRN" "rover_model:Body_GeoSG.dagSetMembers" "rover_modelRN.placeHolderList[15]" 
		""
		5 4 "rover_modelRN" "rover_model:Body_GeoSG.dagSetMembers" "rover_modelRN.placeHolderList[16]" 
		"";
...
connectAttr "rover_modelRN.phl[7]" "cluster2.orggeom[0]";
connectAttr "rover_modelRN.phl[8]" "Camera_Lower_Arm_GeoShapeTag.i";
connectAttr "rover_modelRN.phl[9]" "cluster4.orggeom[0]";
connectAttr "rover_modelRN.phl[10]" "cluster3.orggeom[0]";
connectAttr "rover_modelRN.phl[11]" "Camera_Upper_Arm_GeoShapeTag.i";
connectAttr "Body_GeoShapeDeformed.iog" "rover_modelRN.phl[12]";
connectAttr "Camera_Lower_Arm_GeoShapeDeformed.iog" "rover_modelRN.phl[13]";
connectAttr "Camera_Upper_Arm_GeoShapeDeformed.iog" "rover_modelRN.phl[14]";
connectAttr "Head_Gauges_GeoShapeDeformed.iog" "rover_modelRN.phl[15]";
connectAttr "Neck_GeoShapeDeformed.iog" "rover_modelRN.phl[16]";
