...
//Name: botRig.ma
//Last modified: Mon, Mar 09, 2026 08:11:14 PM
//Codeset: UTF-8
...
fileInfo "UUID" "A64346A3-A947-02A6-1C44-B1BFA0D4B050";
createNode transform -s -n "persp";
	rename -uid "A914F8FA-F447-5BF6-3324-82B59C183066";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.4711932477283494 0.84283471422828471 0.47655270773920649 ;
	setAttr ".r" -type "double3" -30.735610315249776 2062.1999999998311 2.5444437451708134e-14 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 1.4254129281223353;
	setAttr ".ow" 0.1;
...
createNode joint -n "joint4";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 35.790794978557336 -41.395423323241118 -29.310240104586736 ;
	setAttr ".radi" 2;
createNode joint -n "joint5" -p "joint4";
	rename -uid "943A84DE-8C4C-6C25-099F-2BA0DF80D377";
	setAttr ".t" -type "double3" 0.42040620777805521 3.5114574538821482e-17 -2.1185010745790173e-17 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "joint8" -p "joint4";
	...
	setAttr ".t" -type "double3" 0.12645885127305673 -0.21935031331990368 -0.29151732233495103 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
createNode joint -n "joint12" -p "joint4";
	...
	setAttr ".t" -type "double3" 0.048938859912611585 -0.016505888715812288 0.40499602220782549 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 2.7182843459603081 -45.887454039996406 -5.5795864208965353 ;
	setAttr ".radi" 2;
...
createNode fosterParent -n "rover_modelRNfosterParent1";
	rename -uid "B88C866F-0049-8A24-BF78-84BD9E9DC4CD";
