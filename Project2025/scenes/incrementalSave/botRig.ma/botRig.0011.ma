...
//Name: botRig.ma
//Last modified: Mon, Mar 09, 2026 09:47:55 PM
//Codeset: UTF-8
...
fileInfo "UUID" "C57427EC-9547-C46F-7B24-5A8F8264F142";
createNode transform -s -n "persp";
	rename -uid "A914F8FA-F447-5BF6-3324-82B59C183066";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.041889482291048261 0.53544368299943634 1.0216004834068979 ;
	setAttr ".r" -type "double3" -17.535610315406775 2522.1999999971126 4.9732824146302937e-17 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 0.38979652865575987;
	setAttr ".ow" 0.1;
...
createNode fosterParent -n "rover_modelRNfosterParent1";
	rename -uid "9A69E59A-8744-6B95-8643-A1B480B80A22";
