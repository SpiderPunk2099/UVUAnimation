...
//Name: botRig.ma
//Last modified: Mon, Mar 09, 2026 07:35:12 PM
//Codeset: UTF-8
...
fileInfo "UUID" "E1D533A7-544C-93C4-B0EA-45989255FB3A";
createNode transform -s -n "persp";
	rename -uid "A914F8FA-F447-5BF6-3324-82B59C183066";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.6023754603687352 0.77568690230199822 1.7739006122281553 ;
	setAttr ".r" -type "double3" -25.935610315152019 2203.799999999128 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 2.3303900500244512;
	setAttr ".ow" 0.1;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0 0.50467918395996092 10.013757147500808 ;
createNode camera -s -n "frontShape" -p "front";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 9.9890599963167261;
	setAttr ".ow" 0.013825053408428815;
...
createNode joint -n "joint4";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 35.790794978557379 -41.395423323241126 -29.310240104586697 ;
	setAttr ".radi" 2;
createNode joint -n "joint5" -p "joint4";
	rename -uid "943A84DE-8C4C-6C25-099F-2BA0DF80D377";
	setAttr ".t" -type "double3" 0.42040620777805532 3.5114574538821272e-17 -4.452224332431739e-17 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -1.9446596202047346e-15 -35.84474452991379 6.012753811284659e-15 ;
	setAttr ".radi" 2;
...
createNode fosterParent -n "rover_modelRNfosterParent1";
	rename -uid "7C0383F2-2744-5288-5E4C-CBA10B5E112A";
