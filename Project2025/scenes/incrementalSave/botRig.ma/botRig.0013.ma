...
//Name: botRig.ma
//Last modified: Tue, Mar 10, 2026 01:20:31 PM
//Codeset: UTF-8
...
fileInfo "UUID" "37DBB40F-7A42-69D2-D1DC-DD8DB7FECA27";
createNode transform -s -n "persp";
	rename -uid "A914F8FA-F447-5BF6-3324-82B59C183066";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.5916016090014318 0.40403379874280776 0.44153571579242967 ;
	setAttr ".r" -type "double3" 1.4421333623828057 82.199999999998226 -7.3235762125842204e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 3.3289063828966015;
	setAttr ".ow" 0.1;
...
createNode joint -n "FR_Wheel" -p "FR_Wheel_Rotator";
	...
	setAttr ".t" -type "double3" 0.12496309046816335 -9.3311672162431271e-17 -1.2145956666799352e-16 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
...
createNode joint -n "RB_Wheel" -p "RB_Rotator";
	...
	setAttr ".t" -type "double3" 0.12604066534453021 -2.6456889723333578e-18 -1.0992525762099322e-17 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
...
createNode fosterParent -n "rover_modelRNfosterParent1";
	rename -uid "97CF28EA-8B40-173B-AA75-F88DF2E7B905";
