...
//Name: lilGuy.ma
//Last modified: Mon, Oct 13, 2025 11:37:12 AM
//Codeset: UTF-8
requires maya "2024";
...
fileInfo "UUID" "AA9D8ACE-8A43-8349-BFD7-AEB28C6F91D3";
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.26674428582191467 0.51414787769317627 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode polyTweakUV -n "polyTweakUV6";
	...
	setAttr ".uopa" yes;
	setAttr -s 41 ".uvtk";
	setAttr ".uvtk[15]" -type "float2" 0.0036375336 0 ;
	setAttr ".uvtk[33]" -type "float2" -0.016975157 0 ;
	...
	setAttr ".uvtk[132]" -type "float2" -0.016975164 0 ;
	setAttr ".uvtk[136]" -type "float2" 0.0036375448 0 ;
	setAttr ".uvtk[191]" -type "float2" -0.0052496605 0.00070926873 ;
	setAttr ".uvtk[198]" -type "float2" -0.0042808205 0 ;
	setAttr ".uvtk[263]" -type "float2" -0.027887752 0 ;
	setAttr ".uvtk[283]" -type "float2" -0.027887752 0 ;
	...
	setAttr ".uvtk[426]" -type "float2" -0.023037704 0.023037683 ;
	setAttr ".uvtk[427]" -type "float2" -0.027887737 0 ;
	setAttr ".uvtk[429]" -type "float2" -0.027887752 0 ;
	setAttr ".uvtk[430]" -type "float2" -0.023037704 0.023037683 ;
	...
	setAttr ".uvtk[538]" -type "float2" -0.016975164 0 ;
	setAttr ".uvtk[540]" -type "float2" 0.0036375448 0 ;
	setAttr ".uvtk[541]" -type "float2" -0.023037719 0.023037683 ;
	setAttr ".uvtk[543]" -type "float2" -0.016975136 0.018187612 ;
	setAttr ".uvtk[544]" -type "float2" -0.027887737 0 ;
	setAttr ".uvtk[549]" -type "float2" -0.016975164 0 ;
	setAttr ".uvtk[550]" -type "float2" 0.0036375448 0 ;
	setAttr ".uvtk[551]" -type "float2" -0.023037719 0.023037683 ;
	setAttr ".uvtk[553]" -type "float2" -0.027887737 0 ;
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "D07D24BF-B145-1415-D3DF-4EAD2C1E1710";
