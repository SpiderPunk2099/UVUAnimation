...
//Name: lilGuy.ma
//Last modified: Mon, Oct 13, 2025 11:23:18 AM
//Codeset: UTF-8
requires maya "2024";
...
fileInfo "UUID" "E2F380DD-224C-A9BA-3BDE-C4AF13E40796";
createNode transform -s -n "persp";
	rename -uid "10847B0F-0442-808A-4C79-F781CB405C8E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.045347500530531888 2.6006433878049071 4.328705606907211 ;
	setAttr ".r" -type "double3" -10.799999999973817 1.0000000000017977 1.2425934254440187e-17 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 4.2217167772605393;
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.88580858707427979 0.30538161098957062 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "DBA9F932-FA4F-FCE5-E132-89A83F5017FE";
...
connectAttr "polyCylProj4.out" "pCubeShape2.i";
