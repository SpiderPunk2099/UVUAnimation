...
//Name: lilGuy.ma
//Last modified: Mon, Oct 13, 2025 11:38:20 AM
//Codeset: UTF-8
requires maya "2024";
...
fileInfo "UUID" "AEDF1505-5348-62BC-E46D-2DBD5F9DC166";
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.27920929342508316 0.51414789259433746 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode polyTweakUV -n "polyTweakUV7";
	...
	setAttr ".uvtk[33]" -type "float2" 2.3283064e-09 0 ;
	setAttr ".uvtk[126]" -type "float2" -0.010912593 0 ;
	setAttr ".uvtk[132]" -type "float2" -1.2572855e-08 0 ;
	setAttr ".uvtk[525]" -type "float2" -0.010912593 0 ;
	setAttr ".uvtk[526]" -type "float2" -1.2572855e-08 0 ;
	setAttr ".uvtk[529]" -type "float2" 0 -0.038800333 ;
	setAttr ".uvtk[532]" -type "float2" -0.010912593 0 ;
	setAttr ".uvtk[535]" -type "float2" -1.2572855e-08 0 ;
	setAttr ".uvtk[537]" -type "float2" 0 -0.038800333 ;
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "C98254A8-E144-BBAF-2768-BEAE8ACE4508";
