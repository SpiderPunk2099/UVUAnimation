...
//Name: lilGuy.ma
//Last modified: Mon, Oct 13, 2025 12:09:29 PM
//Codeset: UTF-8
requires maya "2024";
...
fileInfo "UUID" "B79E18CB-144D-95CB-9C2A-EE8ADFDEAA17";
createNode transform -s -n "persp";
	rename -uid "10847B0F-0442-808A-4C79-F781CB405C8E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.033000206184655878 1.5514353112417547 5.0511659375136944 ;
	setAttr ".r" -type "double3" 2.3999999999987214 -2158.1999999994455 0 ;
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "87F64150-8A45-3BB8-C243-17A48766B04E";
...
connectAttr "polyCylProj16.out" "pCubeShape2.i";
