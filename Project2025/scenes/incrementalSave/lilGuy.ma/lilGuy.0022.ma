...
//Name: lilGuy.ma
//Last modified: Mon, Oct 13, 2025 11:33:29 AM
//Codeset: UTF-8
requires maya "2024";
...
fileInfo "UUID" "9AB46BC8-2E44-13A3-837A-FC943C8E3BBC";
createNode transform -s -n "persp";
	rename -uid "10847B0F-0442-808A-4C79-F781CB405C8E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.436072842899901 1.5481676884792765 6.0253751544080156 ;
	setAttr ".r" -type "double3" -2.399999999999995 -1082.1999999994823 0 ;
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.52698565694613575 0.40672634658403695 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode polyTweakUV -n "polyTweakUV6";
	...
	setAttr ".uvtk[62]" -type "float2" 0.01539294 0 ;
	setAttr ".uvtk[63]" -type "float2" 0.008031101 0 ;
	setAttr ".uvtk[109]" -type "float2" -0.01065892 0 ;
	setAttr ".uvtk[191]" -type "float2" 0.0080310861 0 ;
	setAttr ".uvtk[198]" -type "float2" 0.015392917 0 ;
	setAttr ".uvtk[358]" -type "float2" 0.015392947 0 ;
	setAttr ".uvtk[361]" -type "float2" 0.0080311159 0 ;
	setAttr ".uvtk[385]" -type "float2" 0.015392947 0 ;
	setAttr ".uvtk[386]" -type "float2" 0.0080310861 0 ;
	setAttr ".uvtk[478]" -type "float2" -0.01065895 0 ;
	setAttr ".uvtk[479]" -type "float2" -0.01065895 0 ;
	setAttr ".uvtk[523]" -type "float2" 0.015392917 0 ;
	setAttr ".uvtk[530]" -type "float2" 0.015392917 0 ;
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "947F0F12-9549-6D6B-A9B1-27858B062470";
