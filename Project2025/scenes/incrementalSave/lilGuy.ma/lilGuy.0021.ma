...
//Name: lilGuy.ma
//Last modified: Mon, Oct 13, 2025 11:33:07 AM
//Codeset: UTF-8
requires maya "2024";
...
fileInfo "UUID" "ECAE4F53-1748-FE71-47A4-559B5581C8BE";
createNode transform -s -n "persp";
	rename -uid "10847B0F-0442-808A-4C79-F781CB405C8E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.18976427224070846 1.1783985059903621 6.0335465823418151 ;
	setAttr ".r" -type "double3" 1.1999999999998494 -1079.7999999995156 -5.5520274704725998e-17 ;
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.5077322750997999 0.23297529667615891 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "F361302B-EF4E-9695-E645-E6B9BB3A21E4";
