...
//Name: lilGuy.ma
//Last modified: Mon, Oct 13, 2025 11:34:47 AM
//Codeset: UTF-8
requires maya "2024";
...
fileInfo "UUID" "466132D1-B34A-3AA7-12D5-03A6406C4AA7";
createNode transform -s -n "persp";
	rename -uid "10847B0F-0442-808A-4C79-F781CB405C8E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.67459142233868996 -4.5382616828521884 0.72186673214650909 ;
	setAttr ".r" -type "double3" 82.800000000000196 -1118.9999999994673 0 ;
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.53758773930108961 0.41439277911558747 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "96688CFC-7F45-DE6E-2B3A-42A428F7ACAC";
