...
//Name: lilGuy.ma
//Last modified: Mon, Oct 13, 2025 11:17:53 AM
//Codeset: UTF-8
requires maya "2024";
...
fileInfo "UUID" "74251446-9247-A9C4-FB7F-638A2DD8047C";
createNode transform -s -n "persp";
	rename -uid "10847B0F-0442-808A-4C79-F781CB405C8E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.92788411306647633 0.24440866805220418 5.7270786404425831 ;
	setAttr ".r" -type "double3" 12.000000000000171 -7.8000000000008143 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 5.9174416527421432;
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "7C7B6FAF-9B46-A645-543C-F0964977079C";
