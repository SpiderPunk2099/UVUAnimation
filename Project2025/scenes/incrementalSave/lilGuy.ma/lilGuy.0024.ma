...
//Name: lilGuy.ma
//Last modified: Mon, Oct 13, 2025 11:36:57 AM
//Codeset: UTF-8
requires maya "2024";
...
fileInfo "UUID" "802C93D4-664B-D0F4-8A7C-19B5D763F00A";
createNode transform -s -n "persp";
	rename -uid "10847B0F-0442-808A-4C79-F781CB405C8E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.0581476078258536 1.3941410065961066 -1.888283157435195 ;
	setAttr ".r" -type "double3" -2.4000000000000541 -1237.3999999993703 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 2.2081585391518157;
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.27401662617921829 0.51414789259433746 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode polyTweakUV -n "polyTweakUV6";
	...
	setAttr ".uopa" yes;
	setAttr -s 41 ".uvtk";
	setAttr ".uvtk[15]" -type "float2" -0.0036375266 0 ;
	setAttr ".uvtk[33]" -type "float2" 0.001212508 0 ;
	...
	setAttr ".uvtk[132]" -type "float2" 0.0012124856 0 ;
	setAttr ".uvtk[136]" -type "float2" -0.0036375229 0 ;
	setAttr ".uvtk[191]" -type "float2" -0.0052496605 0.00070926873 ;
	setAttr ".uvtk[198]" -type "float2" -0.0042808205 0 ;
	setAttr ".uvtk[263]" -type "float2" -0.0084875934 0.0097000711 ;
	setAttr ".uvtk[283]" -type "float2" -0.0084875822 0.0097000711 ;
	...
	setAttr ".uvtk[426]" -type "float2" -0.0097000813 0.041225344 ;
	setAttr ".uvtk[427]" -type "float2" -0.0084875487 0.0097000711 ;
	setAttr ".uvtk[429]" -type "float2" -0.0084875636 0.0097000711 ;
	setAttr ".uvtk[430]" -type "float2" -0.0097000813 0.041225344 ;
	...
	setAttr ".uvtk[538]" -type "float2" 0.0012124856 0 ;
	setAttr ".uvtk[540]" -type "float2" -0.0036375229 0 ;
	setAttr ".uvtk[541]" -type "float2" -0.009700126 0.041225344 ;
	setAttr ".uvtk[543]" -type "float2" -0.016975136 0.018187612 ;
	setAttr ".uvtk[544]" -type "float2" -0.0084875487 0.0097000711 ;
	setAttr ".uvtk[549]" -type "float2" 0.0012124856 0 ;
	setAttr ".uvtk[550]" -type "float2" -0.0036375229 0 ;
	setAttr ".uvtk[551]" -type "float2" -0.0097000962 0.041225344 ;
	setAttr ".uvtk[553]" -type "float2" -0.0084875487 0.0097000711 ;
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "E000FCA9-A343-A29B-6009-4DB0E6906A23";
