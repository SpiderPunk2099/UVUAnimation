...
//Last modified: Wed, Oct 29, 2025 06:23:02 PM
//Codeset: UTF-8
...
fileInfo "UUID" "1AFDBDC3-3644-67FF-48FA-7C91FA1F57A2";
createNode transform -s -n "persp";
	rename -uid "4B30E5ED-1248-6A29-2142-CAB17B4E7EEB";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 10.937716531354257 6.7110958225961426 3.2420399713016952 ;
	setAttr ".r" -type "double3" -19.538352729604551 -295.79999999999603 7.3077376273222159e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 12.803053278325256;
	setAttr ".ow" 0.1;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "1251FB38-5940-ACFC-8E21-7C83F0892256";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "3A3F500C-9944-1867-D044-4EA8F36A3FCB";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "5DD71034-3643-7EF2-A67C-67A7B030DDBC";
createNode displayLayerManager -n "layerManager";
	rename -uid "B924DFD9-3441-4B91-3ECF-11ADE2D957E0";
createNode displayLayer -n "defaultLayer";
	rename -uid "8D75FFA3-7F4F-B13B-278F-B1B3A2634C14";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "A40C2189-AE42-45E4-720A-7BA5506F54F1";
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "736F5AD2-014C-3EEB-0889-319F4E465451";
