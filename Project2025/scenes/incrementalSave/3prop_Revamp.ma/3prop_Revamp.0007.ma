...
//Last modified: Wed, Oct 29, 2025 06:38:18 PM
//Codeset: UTF-8
...
requires -nodeType "aiOptions" -nodeType "aiAOVDriver" -nodeType "aiAOVFilter" -nodeType "aiSkyDomeLight"
		 -nodeType "aiPhotometricLight" -nodeType "aiStandardSurface" "mtoa" "5.3.4.1";
...
fileInfo "UUID" "42D512AD-A34A-7B7B-4480-49A34D5E62F4";
createNode transform -s -n "persp";
	rename -uid "4B30E5ED-1248-6A29-2142-CAB17B4E7EEB";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 10.897179270785799 3.7911976026912377 6.5644319122339212 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 14.542028712113472;
	setAttr ".ow" 0.1;
...
createNode transform -n "aiPhotometricLight1";
	rename -uid "85A89FDD-3A42-D42C-78E6-86B21A2B7F56";
	setAttr ".t" -type "double3" 1.3404232599033992 5.5674343794403285 5.0493451384309314 ;
	setAttr ".s" -type "double3" 226.35433049804161 226.35433049804161 226.35433049804161 ;
createNode aiPhotometricLight -n "aiPhotometricLightShape1" -p "aiPhotometricLight1";
	rename -uid "865668D7-5041-D512-2EC1-638CB11B8DB7";
	addAttr -ci true -h true -sn "aal" -ln "attributeAliasList" -dt "attributeAlias";
	setAttr -k off ".v";
	setAttr ".csh" no;
	setAttr ".rcsh" no;
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "299D8AD4-734C-9702-EF41-7C8B114515D5";
