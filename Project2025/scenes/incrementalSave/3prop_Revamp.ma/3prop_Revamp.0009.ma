...
//Last modified: Wed, Oct 29, 2025 07:08:30 PM
//Codeset: UTF-8
...
fileInfo "UUID" "1D3383C5-F84F-4D9D-47CE-6BA49E2A4F0D";
createNode transform -s -n "persp";
	rename -uid "4B30E5ED-1248-6A29-2142-CAB17B4E7EEB";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 8.6327406784760718 4.4695953799396504 4.8958228804165591 ;
	setAttr ".r" -type "double3" -8.7383527301769153 -666.99999999990075 0 ;
...
createNode transform -n "pPlane1";
	rename -uid "9B5F6495-9F43-D9D7-FB01-C5AF5C06ACEB";
	setAttr ".s" -type "double3" 30.971700911906115 30.971700911906115 30.971700911906115 ;
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	rename -uid "A304282F-2947-83D5-ACE6-0CAA514BACA6";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode transform -n "aiSkyDomeLight1";
	rename -uid "48B933DE-F944-D4FC-11A1-FD94DFA07ED8";
	setAttr ".s" -type "double3" 1.7468022467375781 1.7468022467375781 1.7468022467375781 ;
createNode aiSkyDomeLight -n "aiSkyDomeLightShape1" -p "aiSkyDomeLight1";
	rename -uid "F4EBC67E-384F-8A84-650F-16926A0C0386";
	addAttr -ci true -h true -sn "aal" -ln "attributeAliasList" -dt "attributeAlias";
	setAttr -k off ".v";
	setAttr ".csh" no;
	setAttr ".rcsh" no;
	setAttr ".intensity" 5.5797100067138672;
	setAttr ".ai_exposure" -3.2352941036224365;
	setAttr ".aal" -type "attributeAlias" {"exposure","aiExposure"} ;
createNode transform -n "aiAreaLight1";
	rename -uid "27C8054C-4E45-E984-FEA8-6EB80ACF7AE0";
	setAttr ".t" -type "double3" 5.3339693715276599 2.5068457209942916 2.4713510160018171 ;
	setAttr ".r" -type "double3" 0 59.572418319782351 0 ;
	setAttr ".s" -type "double3" 431.39608270576025 431.39608270576025 431.39608270576025 ;
createNode aiAreaLight -n "aiAreaLightShape1" -p "aiAreaLight1";
	rename -uid "ECB7B2B7-F34A-5B61-B2F5-44B1F223AD9A";
	addAttr -ci true -h true -sn "aal" -ln "attributeAliasList" -dt "attributeAlias";
	setAttr -k off ".v";
	setAttr ".csh" no;
	setAttr ".rcsh" no;
...
createNode reference -n "shieldOnWheelsRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"shieldOnWheelsRN" 0
		"shieldOnWheelsRN" 18
		2 "|shieldOnWheels:pCylinder9" "translate" " -type \"double3\" 0.7041271070434324 2.77165240894036513 -7.14014561193625052"
		
		2 "|shieldOnWheels:pCylinder9" "scale" " -type \"double3\" 0.25117798083782084 2.66181177942353075 0.25117798083782084"
		
		2 "|shieldOnWheels:pCube30" "translate" " -type \"double3\" -4.88090262608821579 1.95816729651126575 -5.3820389692360866"
		
		2 "|shieldOnWheels:pCube30" "scale" " -type \"double3\" 2.19047135155520767 2.19047135155520767 2.19047135155520767"
		
		2 "|shieldOnWheels:pCylinder10" "translate" " -type \"double3\" -1.71183744382913017 2.77165240894036513 -7.08612782859330181"
		
		2 "|shieldOnWheels:pCylinder10" "scale" " -type \"double3\" 0.25117798083782084 2.66181177942353075 0.25117798083782084"
		
		2 "shieldOnWheels:groupParts1" "inputRemoveComponent" " -type \"componentList\" 1 \"f[0:467]\""
		
		2 "shieldOnWheels:groupParts1" "groupId" " 102"
...
createNode reference -n "lilguy_SoloRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"lilguy_SoloRN" 0
		"lilguy_SoloRN" 7
		2 "|lilguy_Solo:pCube2" "translate" " -type \"double3\" 0.45772458116941578 3.48417020481031914 -0.8849816578560723"
...
createNode polyPlane -n "polyPlane1";
	rename -uid "0C399290-0346-C656-2356-6EB9DBF65511";
	setAttr ".ax" -type "double3" 0 1 0 ;
	setAttr ".w" 1;
	setAttr ".h" 1;
	setAttr ".cuv" 2;
createNode file -n "file16";
	rename -uid "3D7E7CBC-DF4B-D215-D571-ECACA66FE253";
	setAttr ".ftn" -type "string" "/Users/kierasheppard/Desktop/metro_vijzelgracht_4k.exr";
	setAttr ".cs" -type "string" "Raw";
createNode place2dTexture -n "place2dTexture4";
	rename -uid "6E39DC5E-2E48-09FB-6723-58803FED627B";
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "4D46A8CC-B246-0766-54D0-D5BAEF99D120";
...
connectAttr "file16.oc" "aiSkyDomeLightShape1.sc";
