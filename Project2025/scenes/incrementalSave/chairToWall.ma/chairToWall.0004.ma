...
//Name: chairToWall.ma
//Last modified: Sat, Mar 21, 2026 08:09:00 PM
//Codeset: UTF-8
...
fileInfo "UUID" "D384F600-1748-B806-CDC1-F89F0EE5F8C1";
createNode transform -s -n "persp";
	rename -uid "09DE7D37-8D43-6DE5-81FB-A9B2500AC5EA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.0541841675599102 1.6281028069259407 2.6517586250995482 ;
	setAttr ".r" -type "double3" -23.138352729435745 340.19999999972714 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 4.6368947881581892;
	setAttr ".ow" 0.1;
...
createNode transform -n "pCylinder1";
	...
	setAttr ".t" -type "double3" -0.24560433996389705 0.71787051506335142 -0.44969327193549535 ;
