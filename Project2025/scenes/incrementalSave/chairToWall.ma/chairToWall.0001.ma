...
//Name: chairToWall.ma
//Last modified: Sat, Mar 21, 2026 07:39:42 PM
//Codeset: UTF-8
...
fileInfo "UUID" "D7390161-F749-224F-EDCA-B7BDB671F9EA";
createNode transform -s -n "persp";
	rename -uid "09DE7D37-8D43-6DE5-81FB-A9B2500AC5EA";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 10.260869078173839 3.0794526712770618 8.7866395000286701 ;
	setAttr ".r" -type "double3" -8.7383527295888506 40.199999999999051 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 13.035851460044318;
	setAttr ".ow" 0.1;
...
createNode transform -n "pCylinder1";
	rename -uid "8E9D1D22-584D-F8EA-1696-3D8589BEDC68";
	setAttr ".t" -type "double3" 3.0202440266628514 0.74596221569777454 -1.2851857859222136 ;
	setAttr ".r" -type "double3" 0 0 90.000000000000043 ;
	setAttr ".s" -type "double3" 0.82142219222378032 1.7105114040622602 0.82142219222378032 ;
createNode mesh -n "pCylinderShape1" -p "pCylinder1";
	rename -uid "7B357011-374A-6DD1-A8FF-93B91BA40B22";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode transform -n "pCube1";
	...
	setAttr ".t" -type "double3" 3.0263185693739003 0.74220810997308606 -1.7905896820988563 ;
	setAttr ".s" -type "double3" 3.4295598688916926 1.6323941929079049 1 ;
...
createNode transform -n "pCylinder2";
	rename -uid "A224D8E2-5E46-7D90-38FD-8EABC40B1C37";
	setAttr ".t" -type "double3" 3.0202440266628514 2.8760431472445154 -1.7901413038511953 ;
	setAttr ".r" -type "double3" -90.000000000000057 89.999999999999986 0 ;
	setAttr ".s" -type "double3" 0.50194438848644773 1.707397306559526 0.55680473241760275 ;
createNode mesh -n "pCylinderShape2" -p "pCylinder2";
	rename -uid "8E7FE862-624C-E24D-DD4D-23810EFCC343";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr -s 10 ".gtag";
...
createNode polyCylinder -n "polyCylinder1";
	rename -uid "E2F7420C-1A4F-BB55-1CC7-ABA39147A9D8";
...
createNode deleteComponent -n "deleteComponent1";
	rename -uid "AAFDFF32-8348-83E6-5D3A-23BD479884B4";
	setAttr ".dc" -type "componentList" 5 "f[0:1]" "f[6:8]" "f[19:28]" "f[39:48]" "f[59]";
createNode deleteComponent -n "deleteComponent2";
	rename -uid "8DDE9982-1348-2594-88AC-72B7E10EFE96";
	setAttr ".dc" -type "componentList" 1 "f[0:3]";
createNode polyCloseBorder -n "polyCloseBorder1";
	rename -uid "5C60845A-A44E-D5A8-5EB3-86B058702CB9";
