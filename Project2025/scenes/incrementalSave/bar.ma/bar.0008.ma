...
//Name: bar.ma
//Last modified: Fri, Mar 20, 2026 08:22:10 PM
//Codeset: UTF-8
...
fileInfo "UUID" "1807B9F9-2E43-5D8C-8435-FDBCC2A6ACB4";
createNode transform -s -n "persp";
	rename -uid "F57985F6-C245-220A-C279-DA892A0F5C7B";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -6.0731460874080856 12.472769120525387 -13.371905250242769 ;
	setAttr ".r" -type "double3" -36.338352728587807 933.79999999969357 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 22.653147323548133;
	setAttr ".ow" 0.1;
...
createNode reference -n "stool2RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" -7.45900969948055081 0.71042782994858722 -2.348411386383364"
		...
		"rotatePivotTranslate" " -type \"double3\" 0 0 0"
		"stool2RN" 15
		2 "|stool2:group2" "translate" " -type \"double3\" -11.40268016817076457 0 -8.64761097513140875"
