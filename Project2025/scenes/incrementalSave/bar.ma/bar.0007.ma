...
//Name: bar.ma
//Last modified: Fri, Mar 20, 2026 08:18:38 PM
//Codeset: UTF-8
...
fileInfo "UUID" "FC16B207-774C-89C0-7D90-4598934FA128";
createNode transform -s -n "persp";
	rename -uid "F57985F6-C245-220A-C279-DA892A0F5C7B";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.41419985846470581 2.6572919744225141 -5.125607905707108 ;
	setAttr ".r" -type "double3" -12.338352728815652 623.39999999987185 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 5.7457717496007925;
	setAttr ".ow" 0.1;
...
createNode reference -n "stool2RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|stool2:Skeleton:Skeleton_Asset|stool2:Skeleton:Controls|stool2:Skeleton:Transform_Ctrl_Grp|stool2:Skeleton:Transform_Ctrl|stool2:Skeleton:COG_Ctrl_Grp|stool2:Skeleton:COG_Ctrl|stool2:Skeleton:Hip_Ctrl_Grp|stool2:Skeleton:Hip_Ctrl" 
		"rotate" " -type \"double3\" -19.61905811416793455 5.89009229771820308 15.854475518376141"
