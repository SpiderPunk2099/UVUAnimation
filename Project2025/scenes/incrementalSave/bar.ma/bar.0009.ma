...
//Name: bar.ma
//Last modified: Fri, Mar 20, 2026 08:27:51 PM
//Codeset: UTF-8
...
fileInfo "UUID" "DC35936E-CC47-3000-CB30-79A5B1080561";
createNode transform -s -n "persp";
	rename -uid "F57985F6-C245-220A-C279-DA892A0F5C7B";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.61950233992934411 2.7415388717617395 1.6780900680116611 ;
	setAttr ".r" -type "double3" -33.938352728277124 833.8000000003525 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 2.3909998298925328;
	setAttr ".ow" 0.1;
...
createNode reference -n "SkeletonRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" -2.2976497195858161 0 3.51883239179794716"
		2 "|Skeleton:Skeleton_Asset|Skeleton:Controls|Skeleton:Transform_Ctrl_Grp|Skeleton:Transform_Ctrl" 
