...
//Name: bar.ma
//Last modified: Fri, Mar 20, 2026 08:14:13 PM
//Codeset: UTF-8
...
fileInfo "UUID" "9166EFC3-EE4D-80C9-292D-4B85F9CCED36";
createNode transform -s -n "persp";
	rename -uid "F57985F6-C245-220A-C279-DA892A0F5C7B";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.2133476399557943 0.5769648694527173 6.0295879294646175 ;
	setAttr ".r" -type "double3" 30.861647271182076 276.19999999993706 2.9449756072186449e-14 ;
...
createNode transform -n "pCylinder6";
	...
	setAttr ".t" -type "double3" -5.3397426296347952 0.013153724783246133 0.9586918582383972 ;
...
createNode transform -n "pCylinder7";
	...
	setAttr ".t" -type "double3" -5.2295260991932633 0.013153724783246133 -5.007336662042797 ;
	setAttr ".r" -type "double3" 0 270.00000000000006 0 ;
	setAttr ".s" -type "double3" 1.3920763094005462 1.0184324697225047 1.4134354295536786 ;
	setAttr ".rp" -type "double3" -9.2866870673447016e-08 0.46738849551961942 0.0047361175369838191 ;
	setAttr ".rpt" -type "double3" 2.5535129566378602e-17 0 -7.4384942649885493e-17 ;
...
createNode reference -n "tablepropRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" -5.5183276458260675 0.97758286120958648 -2.55592733953447393"
		
		2 "|tableprop:Skeleton2:Skeleton_Asset|tableprop:Skeleton2:Controls|tableprop:Skeleton2:Transform_Ctrl_Grp|tableprop:Skeleton2:Transform_Ctrl" 
		"rotate" " -type \"double3\" 0 429.39086682013390828 0"
		...
		"translate" " -type \"double3\" 0 0 0"
		"tablepropRN" 3
		2 "|tableprop:pCylinder6" "translate" " -type \"double3\" -5.22952609919326328 0.013153724783246133 -2.17557976294107247"
		...
		"translate" " -type \"double3\" -5.02187747744709334 0.98673771844612956 -1.78709459336033061"
...
createNode reference -n "stoolRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" 4.33131214244582097 0.034314930079672477 -4.47168831695052749"
		
		2 "|stool:Skeleton:Skeleton_Asset|stool:Skeleton:Controls|stool:Skeleton:Transform_Ctrl_Grp|stool:Skeleton:Transform_Ctrl" 
		"rotate" " -type \"double3\" 0 89.99999999999995737 0"
		"stoolRN" 1
		2 "|stool:pCylinder3" "translate" " -type \"double3\" 4.41833457608456293 -1.69913593028916554 -4.46845793454444085";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
createNode reference -n "stool2RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" 3.94367046869021198 0.71042782994858722 6.29919958874804475"
