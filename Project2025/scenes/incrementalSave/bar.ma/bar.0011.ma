...
//Name: bar.ma
//Last modified: Fri, Mar 20, 2026 08:34:57 PM
//Codeset: UTF-8
...
fileInfo "UUID" "5904C89F-C644-57F3-EE43-B7B0DC7389DC";
createNode transform -s -n "persp";
	rename -uid "F57985F6-C245-220A-C279-DA892A0F5C7B";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -5.4703011268889279 1.5176315475867703 -7.1976873578843437 ;
	setAttr ".r" -type "double3" -14.738352728247683 1268.2000000002581 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 10.155468545194401;
	setAttr ".ow" 0.1;
...
createNode reference -n "ashTrayRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"ashTrayRN" 0
		"ashTrayRN" 6
		2 "|ashTray:polySurface2" "translate" " -type \"double3\" -5.72975892857056746 0.99323828766172584 -5.03650111095991626"
		
		2 "|ashTray:polySurface2" "scale" " -type \"double3\" 4.03658470805483827 4.03658470805483827 4.03658470805483827"
		
		2 "|ashTray:pCylinder4" "translate" " -type \"double3\" -5.74927245691758237 0.99961317727392374 -5.03665398987953239"
		
		2 "|ashTray:pCylinder4" "scale" " -type \"double3\" -0.45890002591564055 4.17099610846863733 -0.45890002591564055"
		
		2 "|ashTray:pCylinder5" "translate" " -type \"double3\" -5.72944136709314389 0.99949634024923495 -5.05839575903501881"
