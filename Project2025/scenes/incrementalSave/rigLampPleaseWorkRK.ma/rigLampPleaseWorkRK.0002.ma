...
//Last modified: Sun, Mar 01, 2026 04:07:19 PM
//Codeset: UTF-8
...
fileInfo "UUID" "D904DD65-574E-FAC5-33A4-C6B707D2E0FE";
createNode transform -s -n "persp";
	rename -uid "E008AE0B-0941-D186-0CAE-2E927DEC9671";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -50.973561227497797 0.3802750685993761 -2.8324361782742886 ;
	setAttr ".r" -type "double3" 6.8616472717137729 -454.1999999998842 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "2D5DA375-7F44-BEF1-9023-648DE9BD2E67";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 54.366483451814332;
...
createNode joint -n "joint1";
	...
	setAttr ".jo" -type "double3" 166.66846503817123 -1.8039602736277964 106.23019829353773 ;
	setAttr ".radi" 0.60372924561064856;
createNode joint -n "joint2" -p "joint1";
	rename -uid "3F2EC256-7D44-D079-ED9B-BBAFE2387498";
	setAttr ".t" -type "double3" 2.7739899510814032 0.7757038096273341 0.17632821689086381 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 3.1073167225348857e-14 -52.697408334013851 -6.2737457756593948e-14 ;
	setAttr ".radi" 1.238098625503067;
createNode joint -n "joint3" -p "joint2";
	rename -uid "316A0DAD-5142-38BB-8EA6-349E50639E81";
	setAttr ".t" -type "double3" 15.269906759725963 -1.0658141036401503e-14 8.8817841970012523e-16 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 112.84028308037418 70.769266019167532 114.04070394134104 ;
	setAttr ".radi" 1.3902751069692199;
createNode joint -n "joint4" -p "joint3";
	rename -uid "8B2D05EE-9B4F-4AD6-28FE-ADBC838A4A25";
	setAttr ".t" -type "double3" 17.552167521573544 0.89454423666350369 -0.7059130566601266 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 1.3902751069692199;
createNode fosterParent -n "lamp_modelRNfosterParent1";
	rename -uid "D3F4664B-304E-2E37-9BE5-DBA99F4204BD";
