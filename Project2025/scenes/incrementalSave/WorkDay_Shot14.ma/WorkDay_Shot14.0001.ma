...
//Last modified: Tue, Dec 02, 2025 01:50:51 PM
//Codeset: UTF-8
...
fileInfo "UUID" "3E4C7F23-6447-E62F-4827-3DBE4C463FDC";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "DF1CE744-CF4B-185D-43AD-8F8655745DDB";
	setAttr -s 8 ".lnk";
	setAttr -s 8 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "0E112F5F-8C49-7481-4508-01B97A75A4D6";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B499C454-B142-99CF-EE87-D69CF3D7A34E";
createNode displayLayerManager -n "layerManager";
	rename -uid "EF7B990A-0F49-B550-E714-549D74217ACB";
createNode displayLayer -n "defaultLayer";
	rename -uid "644EB563-274D-90E0-7ADB-58AA664ED8F1";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "20AFDC76-D042-16C9-50A6-8D91C77E3204";
...
createNode reference -n "SkeletonRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" -19.43181852748238825 0 0"
...
createNode animCurveTA -n "R_Arm_02_FK_Ctrl_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  1 -25.583460796016919;
	setAttr ".kot[0]"  5;
...
createNode animCurveTA -n "Head_Ctrl_rotateX";
	...
	setAttr -s 17 ".ktv[0:16]"  1 -19.431818527482388 7 -58.455227084315396
		 11 60.201671758908269 37 -0.84932864786526463 39 -20.515541981413094 47 -71.519050636554027
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "2FF7CAC0-374C-31C8-8815-A49F315A12A7";
