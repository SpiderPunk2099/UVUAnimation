...
//Name: off chest.ma
//Last modified: Tue, Mar 31, 2026 06:57:47 PM
//Codeset: UTF-8
...
fileInfo "UUID" "167D903F-FA47-22EF-4C40-FCB1B2C8EFAE";
createNode transform -s -n "persp";
	rename -uid "59D701D5-2347-C01C-0996-DB9DAFD035AC";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 37.667061473741057 27.945580158252397 22.926183829689297 ;
	setAttr ".r" -type "double3" -33.938352729597291 47.400000000000063 2.3494368421401165e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "02BF70E3-0D46-FFB6-0E02-12B202FC50CF";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 46.781059330582522;
...
createNode transform -n "persp1";
	...
	setAttr ".t" -type "double3" 13.01707842811987 3.1814381792523232 11.864655892916517 ;
	setAttr -av ".tx";
	setAttr -av ".ty";
	setAttr -av ".tz";
...
createNode reference -n "Ultimate_Bony_v1_0_5RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" 19.59002281552574232 -55.3953916911973252 -13.37250983059041154"
...
createNode reference -n "Ultimate_Bony_v1_0_5RN1";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		" -type \"double3\" 9.34277202825656694 0.57118033817070801 1.88360443836394964"
...
createNode reference -n "spatulasAndHolderRN1";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|spatulasAndHolder1:Spatula_holder:spatula" "translate" " -type \"double3\" 11.15484521154665387 -0.25943274441347119 -0.074574108908295855"
