...
//Name: off chest.ma
//Last modified: Tue, Mar 31, 2026 06:24:12 PM
//Codeset: UTF-8
...
fileInfo "UUID" "0581BF1F-D741-1F43-B697-11B888BEBC93";
createNode transform -s -n "persp";
	rename -uid "59D701D5-2347-C01C-0996-DB9DAFD035AC";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 27.673642991415662 15.518742688421639 16.104647336038219 ;
	setAttr -av ".tx";
	setAttr -av ".ty";
	setAttr -av ".tz";
	setAttr ".r" -type "double3" -25.227917868586921 49.687246280992973 0 ;
	setAttr -av ".rx";
	setAttr -av ".ry";
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 32.614181998674837;
...
createNode animCurveTL -n "persp_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 20.362437371568653 75 27.673642991415662
...
createNode animCurveTL -n "persp_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 16.116935760806676 75 15.518742688421639
...
createNode animCurveTL -n "persp_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 42.842708158601177 75 16.104647336038219
...
createNode animCurveTA -n "persp_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 -18.338352729603972 75 -25.227917868586921
...
createNode animCurveTA -n "persp_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 15.400000000000544 75 49.687246280992973
...
createNode reference -n "Ultimate_Bony_v1_0_5RN1";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" -1.20853618323322465 -3.01068902968765073 0"
		2 "|Ultimate_Bony_v1_0_6:Bony|Ultimate_Bony_v1_0_6:Bony_Main_CNT|Ultimate_Bony_v1_0_6:Bony_rFootIKCG|Ultimate_Bony_v1_0_6:Bony_rFootIKC" 
		"rotate" " -type \"double3\" 78.90410977816769389 0 0"
		2 "|Ultimate_Bony_v1_0_6:Bony|Ultimate_Bony_v1_0_6:Bony_Main_CNT|Ultimate_Bony_v1_0_6:Bony_rFootIKCG|Ultimate_Bony_v1_0_6:Bony_rFootIKC" 
		"rotatePivotTranslate" " -type \"double3\" 0 0 0"
