...
//Name: off chest.ma
//Last modified: Tue, Mar 31, 2026 06:10:10 PM
//Codeset: UTF-8
...
fileInfo "UUID" "CC4655A4-864D-2A91-BDFD-DD80CB9C28B7";
createNode transform -s -n "persp";
	rename -uid "59D701D5-2347-C01C-0996-DB9DAFD035AC";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 12.816929725970464 2.9344489471867963 7.6126406802202906 ;
	setAttr ".r" -type "double3" -3.9383527296037704 53.800000000000423 -3.3657764984300225e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "02BF70E3-0D46-FFB6-0E02-12B202FC50CF";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 14.73940242211113;
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 80 -max 120 -ast 2 -aet 120 ";
	setAttr ".st" 6;
select -ne :time1;
	setAttr ".o" 75;
	setAttr ".unw" 75;
