...
//Name: set.ma
//Last modified: Sun, Feb 22, 2026 10:24:34 PM
//Codeset: UTF-8
...
fileInfo "UUID" "EEB84BE5-734D-F148-BEE7-9F8ADD649D35";
createNode transform -s -n "persp";
	rename -uid "39B1CF7E-3740-B711-BCAE-A2AB8D110785";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 22.519849950667812 3.6934339910956568 -1.006767906748685 ;
	setAttr ".r" -type "double3" 2.3999999999999782 91.599999999999085 0 ;
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 12 -max 30 -ast 2 -aet 150 ";
	setAttr ".st" 6;
...
createNode animCurveTL -n "Bony_ROOTC_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 -0.72759572846298948 17 -1.0867460602399879
		 25 0.15234475145349169;
	setAttr -s 3 ".kot[0:2]"  9 9 9;
...
createNode animCurveTA -n "Bony_rShoulderFKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 -0.97009270289338589 12 -1.1211359770242102
		 17 -2.3210194252589336 21 -5.9553704519722537;
	setAttr -s 4 ".kot[0:3]"  9 9 9 9;
...
createNode animCurveTA -n "Bony_rShoulderFKC_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 -13.195834382624806 12 -32.601010422750306
		 17 -65.982502975495677 21 -80.858630696433664;
	setAttr -s 4 ".kot[0:3]"  9 9 9 9;
...
createNode animCurveTA -n "Bony_lShoulderFKC_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 0 12 -19.283225871405477 17 -43.832049848930467
		 21 -70.169304521108856;
	setAttr -s 4 ".kot[0:3]"  9 9 9 9;
...
createNode animCurveTA -n "Bony_rShoulderFKC_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 -82.224923536132152 12 -81.842289756597935
		 17 -80.326135997527032 21 -76.56612966853595;
	setAttr -s 4 ".kot[0:3]"  9 9 9 9;
...
createNode animCurveTA -n "Bony_lShoulderFKC_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  2 -79.312403607714216 21 -79.312403607714373;
	setAttr -s 2 ".kot[0:1]"  9 9;
