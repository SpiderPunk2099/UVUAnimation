...
//Name: stool.ma
//Last modified: Mon, Mar 16, 2026 07:58:32 PM
//Codeset: UTF-8
...
fileInfo "UUID" "426B655C-9441-37C9-707F-DF8D8FDD44FF";
createNode transform -s -n "persp";
	rename -uid "FE13CB77-CC4B-EAF6-0437-54A7F6023602";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.065676025723818116 1.5489450948147236 4.3786890845731117 ;
	setAttr ".r" -type "double3" -9.7695003684698971 0.26471953534382242 -6.2120871652811065e-18 ;
	setAttr ".rp" -type "double3" 4.4408920985006263e-18 -2.8421709430404008e-16 5.6843418860808016e-16 ;
	setAttr ".rpt" -type "double3" 1.1736535512441137e-16 6.5403495472381792e-17 -7.7756634053718913e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 4.1529010423906803;
	setAttr ".ow" 0.1;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 6.515677749188427 88.579521660203937 28.017029135643611 ;
...
createNode reference -n "SkeletonRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" 0.02299066679604252 0.034314930079672477 -0.059624702589085157"
