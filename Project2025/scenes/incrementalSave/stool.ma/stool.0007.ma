...
//Name: stool.ma
//Last modified: Mon, Mar 16, 2026 07:59:31 PM
//Codeset: UTF-8
...
fileInfo "UUID" "9FC8DC4B-614A-DC21-211E-60B2BC6B834C";
createNode transform -s -n "persp";
	rename -uid "FE13CB77-CC4B-EAF6-0437-54A7F6023602";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.11319124282586077 1.1795237691214078 4.4248236232735589 ;
	setAttr ".r" -type "double3" -4.6170022108169873 0.92118879179873148 -5.2721836693185127e-12 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 4.1464771095430821;
	setAttr ".ow" 0.1;
