...
//Name: stool.ma
//Last modified: Mon, Mar 16, 2026 07:42:06 PM
//Codeset: UTF-8
requires maya "2026";
...
fileInfo "UUID" "BCB077CF-6241-BBB0-834B-8F89B4076B13";
createNode transform -s -n "persp";
	rename -uid "FE13CB77-CC4B-EAF6-0437-54A7F6023602";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -4.9001655320019095 4.0838842715696124 7.2173997571701118 ;
	setAttr ".r" -type "double3" -1.5383527289283607 1766.5999999994799 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 8.9887023564672823;
	setAttr ".ow" 0.1;
...
createNode mesh -n "pCylinderShape2" -p "pCylinder2";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.094763010740280151 0.38424664735794067 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	...
	setAttr ".pt[44]" -type "float3" 0 -0.10956996 0 ;
	setAttr ".pt[45]" -type "float3" -1.1920929e-09 -0.10956996 4.7683715e-09 ;
	setAttr ".pt[46]" -type "float3" -1.1920929e-09 -0.10956996 0 ;
	setAttr ".pt[49]" -type "float3" -1.1920929e-09 0 0 ;
	setAttr ".pt[50]" -type "float3" -1.1920929e-09 0 0 ;
	...
	setAttr ".pt[171]" -type "float3" -1.1920929e-09 -0.14983857 0 ;
	setAttr ".pt[172]" -type "float3" -1.1920929e-09 0 0 ;
	setAttr ".pt[173]" -type "float3" -1.1920929e-09 -0.14983857 4.7683715e-09 ;
	setAttr ".pt[174]" -type "float3" -1.1920929e-09 0 4.7683715e-09 ;
	setAttr ".pt[175]" -type "float3" -1.1920929e-09 -0.14983857 0 ;
	setAttr ".pt[176]" -type "float3" -1.1920929e-09 0 0 ;
	setAttr ".pt[181]" -type "float3" -1.1920929e-09 0 0 ;
	setAttr ".pt[182]" -type "float3" -1.1920929e-09 0 0 ;
	setAttr ".pt[183]" -type "float3" -1.1920929e-09 0 0 ;
	setAttr ".pt[184]" -type "float3" -1.1920929e-09 0 0 ;
	setAttr ".pt[185]" -type "float3" -1.1920929e-09 0 0 ;
