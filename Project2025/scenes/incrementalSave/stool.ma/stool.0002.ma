...
//Name: stool.ma
//Last modified: Mon, Mar 16, 2026 07:16:57 PM
//Codeset: UTF-8
requires maya "2026";
...
fileInfo "UUID" "CCDF2383-4643-7DC0-CB39-D98DAF2CA37A";
createNode transform -s -n "persp";
	rename -uid "FE13CB77-CC4B-EAF6-0437-54A7F6023602";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.96838877739586882 7.8979820852330285 3.5308547073616161 ;
	setAttr ".r" -type "double3" -42.338352728750948 1094.6000000000793 0 ;
...
createNode mesh -n "pCylinderShape2" -p "pCylinder2";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.53674200177192688 0.73137727379798889 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	...
	setAttr ".pt[292]" -type "float3" 5.2534432e-07 0.050833561 -0.07998801 ;
	setAttr ".pt[294]" -type "float3" -0.024713773 0.075250901 -0.076062888 ;
	setAttr ".pt[296]" -type "float3" -0.047015227 0.050833561 -0.064711615 ;
