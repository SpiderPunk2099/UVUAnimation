...
//Name: lampRig.ma
//Last modified: Tue, Jan 27, 2026 02:25:12 PM
//Codeset: UTF-8
...
fileInfo "UUID" "E538AC3C-6142-DF99-EDC8-47AE1B685B0A";
createNode transform -s -n "persp";
	rename -uid "166C878B-1948-4598-E4FF-0A9DEAA1DAE9";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -47.152261823874781 12.271929062855046 3.6896253068782254 ;
	setAttr ".r" -type "double3" -6.3383527296037894 -88.600000000001387 -1.6272365595048591e-14 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "8684B0C2-6F4D-8D8E-5A8A-B8A4D816FC89";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 50.391489750773339;
...
createNode transform -n "nurbsCircle1" -p "Group";
