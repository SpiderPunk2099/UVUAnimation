...
//Name: lampRig.ma
//Last modified: Tue, Jan 27, 2026 02:43:52 PM
//Codeset: UTF-8
...
fileInfo "UUID" "E169940C-7F45-215F-49B7-4C840F0E782C";
createNode transform -s -n "persp";
	rename -uid "166C878B-1948-4598-E4FF-0A9DEAA1DAE9";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -8.2726926579130939 3.7786186996763695 0.75090932008524391 ;
	setAttr ".r" -type "double3" 170.06164727039715 -88.199999999999207 179.99999999999866 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 61.679259262958567;
...
createNode joint -n "bar_1" -p "base_bar";
...
createNode joint -n "bar_2" -p "bar_1";
	rename -uid "127C957C-5648-4C22-CCEB-2D9D40F66CA9";
	setAttr ".t" -type "double3" 15.123684611292154 1.0658141036401503e-14 5.0961661666892005e-16 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 1.2305354109289042;
createNode joint -n "bottom_bar_base";
...
createNode joint -n "bottom_base" -p "bottom_bar_base";
	rename -uid "DD3402F9-DD46-1399-43BF-E4B5A7AF125D";
	setAttr ".t" -type "double3" 1.9373227901925483 -7.7368764963181958e-18 4.9303806576313238e-32 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "none";
	setAttr ".radi" 0.54059621365001276;
createNode transform -n "group_Bar_1";
	rename -uid "895AB947-A440-C63F-DBD8-7A81FECEE7A8";
	setAttr ".t" -type "double3" -1.7244440622572706e-15 12.912891001144649 -11.518061173995291 ;
	setAttr ".r" -type "double3" 89.999999999999986 90 90.000000000000043 ;
createNode transform -n "nurbsCircle1" -p "group_Bar_1";
...
createNode transform -n "nurbsCircle2" -p "group_base_bar";
	rename -uid "635BE6C2-B248-3DB9-65C2-D9B007A4C013";
createNode nurbsCurve -n "nurbsCircleShape2" -p "nurbsCircle2";
	rename -uid "2DF6A4AF-B14B-E9A0-4920-3591E745C70F";
	setAttr -k off ".v";
	setAttr ".tw" yes;
createNode transform -n "group_bar_2";
	rename -uid "0D72292E-2F4F-94C1-1B31-D28A0CAC64E5";
	setAttr ".t" -type "double3" -2.0449932805983186e-15 22.59957739181683 0.096324000890273709 ;
	setAttr ".r" -type "double3" 89.999999999999972 -50.171052418002496 90 ;
	setAttr ".s" -type "double3" 1 1.0000000000000002 1 ;
createNode transform -n "nurbsCircle3" -p "group_bar_2";
...
createNode transform -n "nurbsCircle4" -p "group_bottom_bar_base";
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "joints.di" "base_bar.do";
connectAttr "base_bar.s" "bar_1.is";
connectAttr "joints.di" "bar_1.do";
connectAttr "bar_1.s" "bar_2.is";
connectAttr "joints.di" "bar_2.do";
connectAttr "joints.di" "bottom_bar_base.do";
connectAttr "bottom_bar_base.s" "bottom_base.is";
connectAttr "joints.di" "bottom_base.do";
connectAttr "makeNurbCircle1.oc" "nurbsCircleShape1.cr";
connectAttr "transformGeometry1.og" "nurbsCircleShape2.cr";
connectAttr "transformGeometry2.og" "nurbsCircleShape3.cr";
connectAttr "transformGeometry3.og" "nurbsCircleShape4.cr";
