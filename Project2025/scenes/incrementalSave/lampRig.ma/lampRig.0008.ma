...
//Name: lampRig.ma
//Last modified: Tue, Jan 27, 2026 03:04:31 PM
//Codeset: UTF-8
...
fileInfo "UUID" "003C8F9E-B14D-D6E5-D2C1-B7B6CE460DFD";
...
createNode nurbsCurve -n "bottom_Bar_Base_CtrlShape" -p "bottom_Bar_Base_Ctrl";
	...
	setAttr -k off ".v";
	setAttr ".tw" yes;
createNode transform -n "group_Bottom_Base";
	rename -uid "3106957A-134E-2D52-7A5D-DBB350D9678A";
	setAttr ".t" -type "double3" 4.8444840733823882e-32 0.65969687222138429 0.054653578871492477 ;
	setAttr ".r" -type "double3" -90 0.76496759907601264 -90 ;
...
select -ne :ikSystem;
	setAttr -s 4 ".sol";
connectAttr "joints.di" "base_Bar_Jnt.do";
connectAttr "base_Bar_Jnt.s" "bar_1__Jnt.is";
connectAttr "joints.di" "bar_1__Jnt.do";
connectAttr "bar_1__Jnt.s" "bar_2__Jnt.is";
connectAttr "joints.di" "bar_2__Jnt.do";
connectAttr "joints.di" "bottom_bar_base__Jnt.do";
connectAttr "bottom_bar_base__Jnt.s" "bottom_base__Jnt.is";
connectAttr "joints.di" "bottom_base__Jnt.do";
