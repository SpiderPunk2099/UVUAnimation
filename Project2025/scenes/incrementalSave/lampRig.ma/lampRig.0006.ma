...
//Name: lampRig.ma
//Last modified: Tue, Jan 27, 2026 02:31:17 PM
//Codeset: UTF-8
...
fileInfo "UUID" "81832F3D-3344-71DB-BAEC-D1A432FF1C42";
createNode transform -s -n "persp";
	rename -uid "166C878B-1948-4598-E4FF-0A9DEAA1DAE9";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -34.38745479297409 2.4396202859091756 -0.99085415628322382 ;
	setAttr ".r" -type "double3" 6.8616472703982954 -95.80000000000112 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "8684B0C2-6F4D-8D8E-5A8A-B8A4D816FC89";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 39.139827028817301;
...
createNode joint -n "bar_1" -p "base_bar";
	...
	setAttr ".t" -type "double3" 15.532411272406204 4.2851537670716828e-15 -1.7244440622572704e-15 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jot" -type "string" "xzy";
...
createNode joint -n "bar_2" -p "bar_1";
	...
	setAttr ".t" -type "double3" 15.12368461129215 2.171800773181473e-15 5.0961661666891936e-16 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
