...
//Name: unit_11.ma
//Last modified: Thu, Nov 06, 2025 02:13:03 PM
//Codeset: UTF-8
requires maya "2026";
requires "mtoa" "5.5.3";
...
fileInfo "UUID" "F91F17F1-0648-1537-18AB-80AE5989CD30";
createNode transform -s -n "persp";
	rename -uid "4403E3DC-5845-683D-460A-FABB1FDD3E55";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.6014444443555944 22.154321449603053 16.587138599683175 ;
	setAttr ".r" -type "double3" -39.599999999999113 5765.1999999997342 -1.9960616700858751e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 26.971732777361886;
	setAttr ".ow" 0.1;
