...
//Name: unit_11.ma
//Last modified: Thu, Nov 06, 2025 01:59:09 PM
//Codeset: UTF-8
requires maya "2026";
requires "mtoa" "5.5.3";
...
fileInfo "UUID" "07FC8ADA-9549-0C97-8912-CE96E6BFF012";
createNode transform -s -n "persp";
	rename -uid "4403E3DC-5845-683D-460A-FABB1FDD3E55";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -4.2838156364840509 8.7947167268040225 -30.598691915731703 ;
	setAttr ".r" -type "double3" -13.199999999999688 5587.5999999999622 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 31.728870310238882;
	setAttr ".ow" 0.1;
...
createNode transform -n "polySurface1" -p "pCylinder3";
	...
	setAttr ".s" -type "double3" 1.1470880710036029 1.0386597061205152 1.1260974676065212 ;
