...
//Name: unit_11.ma
//Last modified: Thu, Nov 06, 2025 02:20:54 PM
//Codeset: UTF-8
requires maya "2026";
requires "mtoa" "5.5.3";
...
fileInfo "UUID" "CEF6C91E-3D4E-EBCD-137C-6B97A604CB4F";
...
createNode mesh -n "pCylinderShape4" -p "pCylinder4";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "Tentacle";
	rename -uid "F811F9AC-3A48-9F56-0038-27A29077EE2C";
createNode transform -n "pCylinder5" -p "Tentacle";
...
createNode transform -n "curve1" -p "Tentacle";
