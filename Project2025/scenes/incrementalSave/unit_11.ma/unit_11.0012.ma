...
//Name: unit_11.ma
//Last modified: Thu, Nov 06, 2025 02:00:28 PM
//Codeset: UTF-8
requires maya "2026";
requires "mtoa" "5.5.3";
...
fileInfo "UUID" "F890106A-B64C-FD5B-911B-19858C376293";
createNode transform -s -n "persp";
	rename -uid "4403E3DC-5845-683D-460A-FABB1FDD3E55";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 7.5765100597270116 7.7956603681272103 8.6214741567971611 ;
	setAttr ".r" -type "double3" -28.799999999930247 5440.3999999983216 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 16.547082252916535;
	setAttr ".ow" 0.1;
