...
//Name: unit_11.ma
//Last modified: Thu, Nov 06, 2025 01:46:04 PM
//Codeset: UTF-8
requires maya "2026";
requires "mtoa" "5.5.3";
...
fileInfo "UUID" "F0EC1AD2-7A45-443F-B000-9E9C2EC251D4";
createNode transform -s -n "persp";
	rename -uid "4403E3DC-5845-683D-460A-FABB1FDD3E55";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.9618465082129437 4.3561037035140151 1.0842698134657269 ;
	setAttr ".r" -type "double3" -45.599999999999184 4385.2000000014268 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 3.7025164720189214;
	setAttr ".ow" 0.1;
