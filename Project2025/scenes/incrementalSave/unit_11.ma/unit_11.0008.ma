...
//Name: unit_11.ma
//Last modified: Thu, Nov 06, 2025 01:53:46 PM
//Codeset: UTF-8
requires maya "2026";
requires "mtoa" "5.5.3";
...
fileInfo "UUID" "1B60156B-3648-1EA7-E54C-D3A4BF578C0A";
createNode transform -s -n "persp";
	rename -uid "4403E3DC-5845-683D-460A-FABB1FDD3E55";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.8663591315154111 3.9839637198759825 -6.2630582227042844 ;
	setAttr ".r" -type "double3" -19.199999999746499 4834.0000000009968 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 7.4028855167192908;
	setAttr ".ow" 0.1;
...
createNode transform -n "pCylinder4";
	...
	setAttr ".s" -type "double3" 1 1.1980570499757104 1 ;
