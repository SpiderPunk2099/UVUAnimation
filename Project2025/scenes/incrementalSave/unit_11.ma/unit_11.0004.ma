...
//Name: unit_11.ma
//Last modified: Thu, Nov 06, 2025 01:37:50 PM
//Codeset: UTF-8
requires maya "2026";
requires "mtoa" "5.5.3";
...
fileInfo "UUID" "491AD104-914C-318B-8B99-0DB6562069DC";
createNode transform -s -n "persp";
	rename -uid "4403E3DC-5845-683D-460A-FABB1FDD3E55";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -6.3232671591446659 2.9850943734704014 0.50897328659882335 ;
	setAttr ".r" -type "double3" -9.6000000001206267 3873.1999999998566 1.4244307288002024e-14 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 6.5097329269066817;
	setAttr ".ow" 0.1;
