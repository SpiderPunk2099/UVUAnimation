...
//Name: newset.ma
//Last modified: Tue, Feb 24, 2026 05:04:10 PM
//Codeset: UTF-8
...
fileInfo "UUID" "579F495A-5749-A5D6-3C67-A389CE2AA978";
createNode transform -s -n "persp";
	rename -uid "39B1CF7E-3740-B711-BCAE-A2AB8D110785";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 59.758563535445731 12.687283523896809 5.2608651340017767 ;
	setAttr ".r" -type "double3" -4.8000000000000851 87.60000000000008 -4.7470224316250761e-14 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 61.700882616466565;
...
createNode transform -n "areaLight1";
	rename -uid "73873520-EE40-F4D9-DE59-3ABB94036EB5";
	setAttr ".t" -type "double3" 0 26.93815424044142 24.246402073507561 ;
	setAttr ".r" -type "double3" -53.270210604963545 0 0 ;
	setAttr ".s" -type "double3" 2.6994281601994352 2.6994281601994352 2.6994281601994352 ;
createNode areaLight -n "areaLightShape1" -p "areaLight1";
	rename -uid "5D028D43-B941-3E1C-2B3D-DD9A902C4D25";
	setAttr -k off ".v";
	setAttr ".in" 3.4782607555389404;
	setAttr ".ai_exposure" 8;
	setAttr ".ai_roundness" 1;
createNode lightLinker -s -n "lightLinker1";
	rename -uid "6CABDFD2-8642-B232-5079-6B9BF782D996";
	setAttr -s 4 ".lnk";
	setAttr -s 4 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "AE08AFF2-9848-2B9A-BAD2-64918FD6DAC0";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 1 0 ;
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "8EB88E1F-5248-3B75-4E30-1D9F3DC7A3C5";
createNode displayLayerManager -n "layerManager";
	rename -uid "11434332-C642-37A6-A0C9-CCBE93649F62";
createNode displayLayer -n "defaultLayer";
	rename -uid "6D594005-684C-5C7D-FDF1-50AE90246325";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "582FD77E-EA47-3893-973A-1899851B25BD";
...
createNode timeEditor -s -n "timeEditor";
	rename -uid "2EBAE4C5-604F-3779-F94B-F38F7811FF26";
select -ne :time1;
	setAttr ".o" 5;
	setAttr ".unw" 5;
