...
//Name: robot.ma
//Last modified: Mon, Jan 12, 2026 07:25:34 PM
//Codeset: UTF-8
requires maya "2026";
...
fileInfo "UUID" "4CF7670E-4B4D-C61D-0E42-2D81F6B7E332";
createNode transform -s -n "persp";
	rename -uid "F20C779C-FF4E-EB47-D9C8-ECA6F6443F47";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -5.4334084388417487 9.6209824944753883 14.809392126639846 ;
	setAttr ".r" -type "double3" -28.800000000000644 -5.1999999999997311 -1.9960616700867147e-16 ;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -4.705741764640071 5.4804639047693238 13.092902853963022 ;
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 73 ".pt";
	setAttr ".pt[68]" -type "float3" 0.065291122 -0.04658531 1.0658141e-16 ;
	setAttr ".pt[69]" -type "float3" 0.065291122 -0.04658531 1.4210854e-16 ;
	setAttr ".pt[70]" -type "float3" 0.10168424 0.02597527 1.0658141e-16 ;
	setAttr ".pt[71]" -type "float3" 0.10168424 0.02597527 1.4210854e-16 ;
	setAttr ".pt[72]" -type "float3" -0.065291151 -0.046584249 1.0658141e-16 ;
	setAttr ".pt[73]" -type "float3" -0.065291151 -0.046584249 1.4210854e-16 ;
	setAttr ".pt[74]" -type "float3" -0.10168409 0.025975812 1.4210854e-16 ;
	setAttr ".pt[75]" -type "float3" -0.10168409 0.025975812 1.0658141e-16 ;
	setAttr ".pt[76]" -type "float3" 0.073149376 -0.026633345 0 ;
	setAttr ".pt[77]" -type "float3" 0.073149376 -0.026633345 0 ;
	setAttr ".pt[78]" -type "float3" 0.15349792 0 0 ;
	setAttr ".pt[79]" -type "float3" 0.15349792 0 0 ;
	setAttr ".pt[80]" -type "float3" -0.073149435 -0.026632538 0 ;
	setAttr ".pt[81]" -type "float3" -0.073149435 -0.026632538 0 ;
	setAttr ".pt[82]" -type "float3" -0.15349792 0 0 ;
	setAttr ".pt[83]" -type "float3" -0.15349792 0 0 ;
	setAttr ".pt[84]" -type "float3" 0.085919239 -0.017202498 0 ;
	setAttr ".pt[85]" -type "float3" 0.085919239 -0.017202498 0 ;
	setAttr ".pt[86]" -type "float3" 0.17483547 0 0 ;
	setAttr ".pt[87]" -type "float3" 0.17483546 0 0 ;
	setAttr ".pt[88]" -type "float3" -0.085919254 -0.017201684 0 ;
	setAttr ".pt[89]" -type "float3" -0.085919254 -0.017201684 0 ;
	setAttr ".pt[90]" -type "float3" -0.17483546 0 0 ;
	setAttr ".pt[91]" -type "float3" -0.17483547 0 0 ;
	setAttr ".pt[92]" -type "float3" 0.14053299 0.014406582 0 ;
	setAttr ".pt[93]" -type "float3" 0.14039686 0.014512744 0 ;
	setAttr ".pt[94]" -type "float3" 0.12511115 0 0 ;
	setAttr ".pt[95]" -type "float3" 0.12511112 0 0 ;
	setAttr ".pt[96]" -type "float3" -0.14053299 0.014407634 0 ;
	setAttr ".pt[97]" -type "float3" -0.14039688 0.014513842 0 ;
	setAttr ".pt[98]" -type "float3" -0.12511112 0 0 ;
	setAttr ".pt[99]" -type "float3" -0.12511115 0 0 ;
	setAttr ".pt[100]" -type "float3" 0.14234351 0.027491765 0 ;
	setAttr ".pt[101]" -type "float3" 0.1422547 0.027561018 0 ;
	setAttr ".pt[102]" -type "float3" 0.12511112 0 0 ;
	setAttr ".pt[103]" -type "float3" 0.12511112 0 0 ;
	setAttr ".pt[104]" -type "float3" -0.14234348 0.027492862 0 ;
	setAttr ".pt[105]" -type "float3" -0.14225468 0.027562132 0 ;
	setAttr ".pt[106]" -type "float3" -0.12511112 0 0 ;
	setAttr ".pt[107]" -type "float3" -0.12511112 0 0 ;
	setAttr ".pt[108]" -type "float3" 0.037464928 0 0 ;
	setAttr ".pt[109]" -type "float3" 0.037464928 0 0 ;
	setAttr ".pt[110]" -type "float3" 0.12511112 0 0 ;
	setAttr ".pt[111]" -type "float3" 0.12511112 0 0 ;
	setAttr ".pt[112]" -type "float3" -0.037464928 0 0 ;
	setAttr ".pt[113]" -type "float3" -0.037464928 0 0 ;
	setAttr ".pt[114]" -type "float3" -0.12511112 0 0 ;
	setAttr ".pt[115]" -type "float3" -0.12511112 0 0 ;
	setAttr ".pt[689]" -type "float3" -0.065291151 -0.046584249 7.1054272e-17 ;
	setAttr ".pt[690]" -type "float3" -0.073149435 -0.026632538 0 ;
	setAttr ".pt[691]" -type "float3" -0.085919254 -0.017201684 0 ;
	setAttr ".pt[692]" -type "float3" -0.14046572 0.014460108 0 ;
	setAttr ".pt[693]" -type "float3" -0.14229961 0.02752707 0 ;
	setAttr ".pt[694]" -type "float3" -0.037464928 0 0 ;
	setAttr ".pt[695]" -type "float3" -0.12511112 0 0 ;
	setAttr ".pt[696]" -type "float3" -0.12511112 0 0 ;
	setAttr ".pt[697]" -type "float3" -0.12511115 0 0 ;
	setAttr ".pt[698]" -type "float3" -0.17483547 0 0 ;
	setAttr ".pt[699]" -type "float3" -0.15349792 0 0 ;
	setAttr ".pt[700]" -type "float3" -0.10168409 0.025975812 1.4210854e-16 ;
	setAttr ".pt[727]" -type "float3" 0.10168424 0.02597527 1.4210854e-16 ;
	setAttr ".pt[728]" -type "float3" 0.15349792 0 0 ;
	setAttr ".pt[729]" -type "float3" 0.17483547 0 0 ;
	setAttr ".pt[730]" -type "float3" 0.12511115 0 0 ;
	setAttr ".pt[731]" -type "float3" 0.12511112 0 0 ;
	setAttr ".pt[732]" -type "float3" 0.12511112 0 0 ;
	setAttr ".pt[733]" -type "float3" 0.037464928 0 0 ;
	setAttr ".pt[734]" -type "float3" 0.14229959 0.027525971 0 ;
	setAttr ".pt[735]" -type "float3" 0.14046572 0.014459025 0 ;
	setAttr ".pt[736]" -type "float3" 0.085919239 -0.017202498 0 ;
	setAttr ".pt[737]" -type "float3" 0.073149376 -0.026633345 0 ;
	setAttr ".pt[738]" -type "float3" 0.065291122 -0.04658531 7.1054272e-17 ;
	setAttr ".dr" 1;
