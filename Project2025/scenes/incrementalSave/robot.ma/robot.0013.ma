...
//Name: robot.ma
//Last modified: Mon, Jan 12, 2026 11:39:14 PM
//Codeset: UTF-8
requires maya "2026";
...
fileInfo "UUID" "DC0727A4-8D4B-DE22-E79A-3E9DA2DA7E14";
createNode transform -s -n "persp";
	rename -uid "F20C779C-FF4E-EB47-D9C8-ECA6F6443F47";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -3.5352117109644867 9.3064573147340397 7.1392514560810731 ;
	setAttr ".r" -type "double3" -7.20000000000352 -6.0000000000135785 4.9969907278377318e-17 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 2.4809561116272563;
	setAttr ".ow" 0.1;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -3.188210901241856 8.2971869743804838 13.092902853963022 ;
...
createNode transform -n "imagePlane4";
	...
	setAttr ".t" -type "double3" -3.2526952461323426 9.2539802818354993 3.38232700826428 ;
...
createNode transform -n "imagePlane5";
	...
	setAttr ".t" -type "double3" -6.0200243713037791 9.4647634214755367 4.6545238068383989 ;
	setAttr ".r" -type "double3" 0 -89.999999999999972 0 ;
...
createNode mesh -n "pCubeShape3" -p "pCube3";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 15 ".pt";
	setAttr ".pt[41]" -type "float3" 0.018111985 0.0027685387 0.040865101 ;
	setAttr ".pt[44]" -type "float3" -0.018111985 0.0027685387 0.040865101 ;
	setAttr ".pt[61]" -type "float3" -0.015837103 0.0038413391 0.006746077 ;
	setAttr ".pt[200]" -type "float3" -0.0016059033 -0.0036160767 -0.026535191 ;
	setAttr ".pt[201]" -type "float3" 0.015368641 -0.0041524698 -0.0094756177 ;
	setAttr ".pt[208]" -type "float3" -0.015368567 -0.0041524828 -0.0094757825 ;
	setAttr ".pt[209]" -type "float3" 0.0016059796 -0.003616072 -0.026535239 ;
	setAttr ".pt[210]" -type "float3" 0.13398704 4.7683715e-09 -9.536743e-09 ;
	setAttr ".pt[211]" -type "float3" 0.13398702 7.1525572e-09 4.7683715e-09 ;
	setAttr ".pt[212]" -type "float3" 0.13398702 -2.3841857e-09 -2.3841857e-09 ;
	setAttr ".pt[213]" -type "float3" 0.13398699 2.3841857e-09 2.3841857e-09 ;
	setAttr ".pt[214]" -type "float3" -0.13398702 7.1525572e-09 4.7683715e-09 ;
	setAttr ".pt[215]" -type "float3" -0.13398704 4.7683715e-09 2.3841857e-09 ;
	setAttr ".pt[216]" -type "float3" -0.13398702 -7.1525572e-09 -2.3841857e-09 ;
	setAttr ".pt[217]" -type "float3" -0.13398699 4.7683715e-09 0 ;
...
connectAttr "polyExtrudeFace63.out" "pCubeShape3.i";
