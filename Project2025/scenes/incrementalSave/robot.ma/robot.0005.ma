...
//Name: robot.ma
//Last modified: Mon, Jan 12, 2026 06:26:12 PM
//Codeset: UTF-8
requires maya "2026";
...
fileInfo "UUID" "14C3479E-4D44-55F4-F5DF-A2893F702A73";
createNode transform -s -n "persp";
	rename -uid "F20C779C-FF4E-EB47-D9C8-ECA6F6443F47";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.535127466679437 4.7713030824674325 9.3351913967913998 ;
	setAttr ".r" -type "double3" 6.000000000000095 2.8000000000009213 -4.9755568212812499e-17 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 5.0533411464363738;
	setAttr ".ow" 0.1;
