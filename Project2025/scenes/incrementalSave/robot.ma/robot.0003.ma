...
//Name: robot.ma
//Last modified: Sun, Jan 11, 2026 10:10:56 PM
//Codeset: UTF-8
requires maya "2026";
...
fileInfo "UUID" "4F713E48-1740-C2C7-1F79-6F845C4613D3";
createNode transform -s -n "persp";
	rename -uid "F20C779C-FF4E-EB47-D9C8-ECA6F6443F47";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -5.1459139654462192 7.1684948858892472 6.0643364950153158 ;
	setAttr ".r" -type "double3" 0 -22.79999999999977 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 2.4611412798077352;
	setAttr ".ow" 0.1;
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".pt[13]" -type "float3" 7.6293944e-08 0 0 ;
	setAttr ".pt[15]" -type "float3" -7.6293944e-08 0 0 ;
	setAttr ".pt[32]" -type "float3" -0.08378686 -0.029140532 -3.5527136e-17 ;
	setAttr ".pt[33]" -type "float3" 0.083786897 0.029141285 -3.5527136e-17 ;
	setAttr ".pt[34]" -type "float3" 0.083786897 0.029141285 0 ;
	setAttr ".pt[35]" -type "float3" -0.08378686 -0.029140532 0 ;
	setAttr ".pt[36]" -type "float3" 0.083786868 -0.029140811 -3.5527136e-17 ;
	setAttr ".pt[37]" -type "float3" -0.083786853 0.029140854 -3.5527136e-17 ;
	setAttr ".pt[38]" -type "float3" 0.083786868 -0.029140811 0 ;
	setAttr ".pt[39]" -type "float3" -0.083786853 0.029140854 0 ;
	setAttr ".pt[72]" -type "float3" -0.14021824 1.0948621e-06 3.5527136e-17 ;
	setAttr ".pt[73]" -type "float3" -0.14021824 1.0948621e-06 1.4210854e-16 ;
	setAttr ".pt[74]" -type "float3" -0.042485312 0 0 ;
	setAttr ".pt[75]" -type "float3" -0.042485312 0 0 ;
	setAttr ".pt[76]" -type "float3" 0.14021838 -5.5043333e-08 3.5527136e-17 ;
	setAttr ".pt[77]" -type "float3" 0.14021838 -5.5043333e-08 1.4210854e-16 ;
	setAttr ".pt[78]" -type "float3" 0.042485312 0 0 ;
	setAttr ".pt[79]" -type "float3" 0.042485312 0 0 ;
