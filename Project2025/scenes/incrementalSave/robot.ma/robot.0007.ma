...
//Name: robot.ma
//Last modified: Mon, Jan 12, 2026 06:56:43 PM
//Codeset: UTF-8
requires maya "2026";
...
fileInfo "UUID" "7FFCB3BE-404F-3EA9-2ADE-489E52033FAB";
createNode transform -s -n "persp";
	rename -uid "F20C779C-FF4E-EB47-D9C8-ECA6F6443F47";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -5.7323909390015162 2.5485750044774611 7.7824418892502729 ;
	setAttr ".r" -type "double3" 0 -389.99999999959772 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 3.5645468015075159;
	setAttr ".ow" 0.1;
