...
//Name: walkFK.ma
//Last modified: Sun, Oct 05, 2025 08:42:31 PM
//Codeset: UTF-8
...
fileInfo "UUID" "D04005AB-A041-5E12-34F5-459F6641AB67";
createNode transform -s -n "persp";
	rename -uid "77886D74-1A45-2D7F-3DAC-2F9E12784B30";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 7.1301501771953388 2.9088002728907334 -6.6369990392044658 ;
	setAttr ".r" -type "double3" 352.66572912660763 131.39999999987046 359.99999999980253 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 9.8258887029075392;
...
createNode animCurveTA -n "walker_lf_ankle_fk_ctrl_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 -0.13216520071861143 2 -0.13216520071861143
		 4 0.13148520582221426 5 0.13148520582221426;
...
createNode animCurveTA -n "walker_lf_ankle_fk_ctrl_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 0.47100304171089424 2 0.47100304171089424
		 4 0.47119331755452037 5 0.47119331755452037;
	setAttr -s 4 ".kit[1:3]"  1 18 18;
	setAttr -s 4 ".kot[1:3]"  1 18 18;
	setAttr -s 4 ".kix[1:3]"  1 1 1;
	setAttr -s 4 ".kiy[1:3]"  0 0 0;
...
createNode animCurveTA -n "walker_lf_ankle_fk_ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  1 -28.369808747959603 2 -28.369808747959603
		 4 2.8965102330901202 5 2.8965102330901202;
	setAttr -s 4 ".kit[1:3]"  1 18 18;
	setAttr -s 4 ".kot[1:3]"  1 18 18;
	setAttr -s 4 ".kix[1:3]"  1 1 1;
	setAttr -s 4 ".kiy[1:3]"  0 0 0;
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "4F45E9EA-3148-BB35-9677-0AA1E808D501";
