...
//Name: dance.ma
//Last modified: Fri, May 22, 2026 08:49:46 PM
//Codeset: UTF-8
...
fileInfo "UUID" "70391436-6C40-A930-873F-6099FA8AC312";
createNode transform -s -n "persp";
	rename -uid "3D4623A0-C64A-3626-7B40-2AAB9A2B3524";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.54166695055172798 1.2354176836494772 5.6527815225480333 ;
	setAttr ".r" -type "double3" -5.9999999999999991 -4.0000000000000098 -4.9817519872456955e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 5.4808704548221758;
	setAttr ".ow" 0.1;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "5C180C7F-C940-F9B3-8C0D-4DBD3B6C617D";
	setAttr -s 7 ".lnk";
	setAttr -s 7 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "DA231638-9D40-26C8-6DC9-66AE01E0CDD6";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "F97D482C-BC48-447E-5883-AEA03B4178D4";
createNode displayLayerManager -n "layerManager";
	rename -uid "E89D9FE0-C34E-C78E-F798-ED8EF1A8F430";
createNode displayLayer -n "defaultLayer";
	rename -uid "55FC83C2-7C41-D5FB-AB25-3E9E8ECE921B";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "59F76C75-A346-6B0A-5EBC-D3B1E4ACEE02";
...
createNode animCurveTA -n "Hip_Ctrl_rotateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  4 0 9 0 14 0 26 0 43 0 51 4.9129739402689623
...
createNode animCurveTL -n "R_Leg_IK_End_Ctrl_translateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  3 0.57214761938617187 14 0.39911496469598712
		 26 -0.84520632782380201 43 -0.76612773270350143 51 -0.51959715638187232 59 -0.49682861743304041
		 61 -0.42562105962427976 63 -0.33143599086712877 67 -0.2447029129994277;
...
createNode animCurveTA -n "L_Foot_IK_Ball_Ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  4 0 10 0 14 36.171945434544739 26 0 43 45.711517213684594
		 51 0 63 37.153361913458255;
	setAttr -s 7 ".kit[0:6]"  18 18 9 18 9 9 9;
	setAttr -s 7 ".kot[0:6]"  18 18 9 18 9 9 9;
...
createNode animCurveTA -n "R_Arm_01_FK_Ctrl_rotateX";
	...
	setAttr -s 6 ".ktv[0:5]"  9 44.221680408467648 14 0 26 123.46226600558278
		 43 110.1462352603385 59 50.394669440673745 67 250.18401136225839;
	setAttr -s 6 ".kit[0:5]"  18 9 9 9 9 9;
	setAttr -s 6 ".kot[0:5]"  18 9 9 9 9 9;
...
createNode animCurveTA -n "R_Arm_02_FK_Ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  9 -182.35850059970261 14 0 26 9.9294482459291338
...
createNode animCurveTA -n "Spine_02_Ctrl_rotateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  14 1.4891029454152254 26 15.191019309694683
...
createNode animCurveTL -n "L_Leg_IK_End_Ctrl_translateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 10 ".ktv[0:9]"  2 0.898074856239089 4 0.79351867425507394
...
createNode animCurveTA -n "L_Arm_03_FK_Ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  14 0 59 -49.452700032820012 67 -17.325790086963273;
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "2EA655E2-494D-851D-5D56-80A5A29C7737";
