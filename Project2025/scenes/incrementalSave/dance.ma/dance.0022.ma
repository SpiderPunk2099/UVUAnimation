...
//Name: dance.ma
//Last modified: Fri, May 22, 2026 09:08:25 PM
//Codeset: UTF-8
...
fileInfo "UUID" "73F3208B-1240-3A87-FBC6-A8A9581EE636";
createNode transform -s -n "persp";
	rename -uid "3D4623A0-C64A-3626-7B40-2AAB9A2B3524";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.11132215288628945 1.2542577468652596 2.7600860325357575 ;
	setAttr ".r" -type "double3" -4.8000000000006615 0.79999999999991045 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 2.6571379730180542;
	setAttr ".ow" 0.1;
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "29C538AE-2F42-6F59-E115-5295943DA2BD";
