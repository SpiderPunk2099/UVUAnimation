...
//Name: dance.ma
//Last modified: Fri, May 22, 2026 09:05:20 PM
//Codeset: UTF-8
...
fileInfo "UUID" "7C78FAFC-7145-2015-0682-9882456F01AF";
createNode transform -s -n "persp";
	rename -uid "3D4623A0-C64A-3626-7B40-2AAB9A2B3524";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.14927234752472771 1.6335809794215401 4.4836623735822352 ;
	setAttr ".r" -type "double3" -10.80000000000059 0.79999999999999594 -2.4850505776603586e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 4.3992373418621478;
	setAttr ".ow" 0.1;
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 28 -max 101 -ast 2 -aet 200 ";
	setAttr ".st" 6;
...
createNode animCurveTA -n "R_Arm_02_FK_Ctrl_rotateY";
	...
	setAttr -s 8 ".ktv[0:7]"  9 81.394535092688528 14 53.499561389728257
		 26 33.969531417586104 37 36.068102289052291 43 0.69842795312405703 46 19.273010466466115
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "0BF12019-3B42-BBC3-EDCF-69AFDD7ECD79";
