...
//Name: dance.ma
//Last modified: Wed, May 20, 2026 05:32:06 PM
//Codeset: UTF-8
...
fileInfo "UUID" "0A3BB678-6040-1D12-3826-85A31A47E3CF";
createNode transform -s -n "persp";
	rename -uid "3D4623A0-C64A-3626-7B40-2AAB9A2B3524";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.089950891767103927 0.83671107917874732 7.8213185274492414 ;
	setAttr ".r" -type "double3" 0 -1.6000000000009202 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 7.7689026435812707;
	setAttr ".ow" 0.1;
...
createNode animCurveTA -n "L_Arm_01_FK_Ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 120.92075136619329 8 158.56686720358704
		 16 118.95583449412862 32 143.31515275712732;
createNode animCurveTA -n "L_Arm_01_FK_Ctrl_rotateY";
	rename -uid "2DD99893-DB48-4795-D57E-B993D939BB5B";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 -68.697134864030289 8 -31.470608661404203
		 16 -49.002908146544691 32 -52.964405880319099;
createNode animCurveTA -n "L_Arm_01_FK_Ctrl_rotateZ";
	rename -uid "E9620B12-B440-AC0E-7497-85A30BCC71C1";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 -22.787570174549543 8 -68.468370405192672
		 16 -36.782528719124649 32 -78.042209953468344;
...
createNode animCurveTA -n "Spine_02_Ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  2 0 8 0 16 0 32 -23.587814866744058 40 -36.106068975557911;
createNode animCurveTA -n "Spine_02_Ctrl_rotateY";
	rename -uid "577C2B1B-2B4A-55E0-54B7-988210D5D309";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  2 0 8 0 16 0 32 7.9513867036587939e-16 40 -1.590277340731758e-15;
createNode animCurveTA -n "Spine_02_Ctrl_rotateZ";
	rename -uid "E2D00E25-9246-9A22-2260-028676E73681";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  2 1.4891029454152251 8 15.191019309694683
		 16 38.439920630257255 32 38.439920630257284 40 38.439920630257305;
...
createNode animCurveTA -n "L_Arm_03_FK_Ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  2 0 32 -49.452700032820005;
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "78F19B94-3744-B1C1-7BB8-D9BA56E09618";
