...
//Name: dance.ma
//Last modified: Wed, May 20, 2026 05:26:54 PM
//Codeset: UTF-8
...
fileInfo "UUID" "5E655736-014E-1D35-C515-17B7C18C33F8";
createNode transform -s -n "persp";
	rename -uid "3D4623A0-C64A-3626-7B40-2AAB9A2B3524";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.071340738016885008 1.0523274725004734 4.1572053422998509 ;
	setAttr ".r" -type "double3" -4.800000000000038 -2.3999999999999857 1.2434949287704258e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 4.1243773604489666;
	setAttr ".ow" 0.1;
...
createNode animCurveTA -n "Hip_Ctrl_rotateZ";
	...
	setAttr -s 6 ".ktv[0:5]"  2 0 8 7.7176270975926009 16 21.274344367548839
		 24 22.464240638156411 32 15.833739313571016 40 15.833739313571016;
createNode animCurveTL -n "R_Leg_IK_End_Ctrl_translateX";
	rename -uid "CAC6CEF8-B34D-8338-30FE-4283405A99FC";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  2 1.1621105274316852e-16 8 -2.5679637447036418e-16
		 16 -1.757282329666042e-16 24 -2.129839222239625e-16 32 0.014302605580085849 36 0.12448942353938666
		 40 0.13834390964066534;
createNode animCurveTL -n "R_Leg_IK_End_Ctrl_translateY";
	rename -uid "F760DE13-C042-D468-A789-899CB4D7DD7A";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  2 -3.552713678800501e-17 8 -5.3290705182007512e-17
		 16 -7.105427357601002e-17 24 -5.3290705182007512e-17 32 -1.2434497875801754e-16 36 -6.927791673660977e-16
		 40 -1.3322676295501878e-15;
createNode animCurveTL -n "R_Leg_IK_End_Ctrl_translateZ";
	rename -uid "335C4ACA-1E48-6256-98BE-18A8F840A082";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  2 0.40557265873920445 8 -0.84520632782380201
		 16 -0.76612773270350143 24 -0.51959715638187232 32 -0.49682861743304041 36 -0.33143599086712877
		 40 -0.2447029129994277;
createNode animCurveTA -n "R_Leg_IK_End_Ctrl_rotateX";
	rename -uid "9F4C9231-1541-BD97-4ABE-F3A76DDDFEA1";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  2 0 8 0 16 0 24 0 32 0 36 0 40 0;
createNode animCurveTA -n "R_Leg_IK_End_Ctrl_rotateY";
	rename -uid "631C7E00-934C-6F8D-FF16-A5B77A4259DC";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  2 0 8 0 16 -22.24711146115348 24 -44.494222922306975
		 32 -68.762921973117614 36 -68.762921973117614 40 -68.762921973117614;
...
createNode animCurveTL -n "L_Leg_IK_End_Ctrl_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  2 -3.4191911714733328e-16 16 -4.0262491626797402e-16
		 20 -3.111103578045593e-16 24 -1.8406866255313981e-16 32 -1.8406866255313981e-16 36 0.041120089642339624
		 40 0.13834390964066537;
createNode animCurveTL -n "L_Leg_IK_End_Ctrl_translateY";
	rename -uid "250EC0EA-D344-F718-3099-2DAB849777CC";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  2 -8.8817841970012528e-17 16 -1.0658141036401502e-16
		 20 0.091366003559572931 24 -7.105427357601002e-17 32 -7.105427357601002e-17 36 -7.1054273576010023e-16
...
createNode animCurveTL -n "L_Leg_IK_End_Ctrl_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  2 0 16 -1.1635774920691324 20 -0.80903163605579265
		 24 -0.45448578004245321 32 -0.45448578004245321 36 -0.34275609540883478 40 -0.17959153666000877;
createNode animCurveTA -n "L_Leg_IK_End_Ctrl_rotateX";
	rename -uid "2A75473A-624D-858B-DDBE-8FBFC6D462E9";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  2 0 16 0 20 0 24 0 32 0 36 0 40 0;
createNode animCurveTA -n "L_Leg_IK_End_Ctrl_rotateY";
	rename -uid "193681B8-CF48-DFFC-5322-C0AF94C1A4D5";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  2 0 16 0 20 0 24 0 32 -24.268699050810568
		 36 -24.268699050810568 40 -24.268699050810568;
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "D4FF0D00-284B-6A26-C872-4AA311FAE608";
