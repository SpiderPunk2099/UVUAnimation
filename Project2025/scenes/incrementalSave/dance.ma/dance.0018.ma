...
//Name: dance.ma
//Last modified: Wed, May 20, 2026 05:58:43 PM
//Codeset: UTF-8
...
fileInfo "UUID" "96FDFD41-444C-92CC-EE95-7D8DF6B8399F";
createNode transform -s -n "persp";
	rename -uid "3D4623A0-C64A-3626-7B40-2AAB9A2B3524";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.093292223311231631 1.598984654920929 4.9966319387561979 ;
	setAttr ".r" -type "double3" -9.5999999999999783 -2.001667358171342e-16 -8.1270654513128681e-18 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 5.1630463022909021;
	setAttr ".ow" 0.1;
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 2 -max 75 -ast 2 -aet 200 ";
	setAttr ".st" 6;
...
createNode animCurveTL -n "Hip_Ctrl_translateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  4 0.017749343893818922 9 0.010598403864798963
		 14 0.0028421680140518651 26 -0.0069706007975014854 43 -0.019232890728248183 51 -0.01358868915767489
		 59 -0.01358868915767489 67 -0.0066648527526227833;
createNode animCurveTL -n "Hip_Ctrl_translateY";
	rename -uid "AFC6F83D-5B42-8A55-0C05-91BD0E4ADEFE";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  4 0.70447137289058082 9 0.42065059788958659
		 14 0.11280563466582758 26 -0.47431607322804531 43 -0.76335333953959161 51 -0.53933500663225775
		 59 -0.53933500663225775 67 -0.26452797336301481;
createNode animCurveTL -n "Hip_Ctrl_translateZ";
	rename -uid "963AE198-E149-DFC3-706C-34AEB701A5C6";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  4 1.7175956934037565e-16 9 0 14 0 26 0 43 0
		 51 0 59 0 67 0.13834390964066523;
createNode animCurveTA -n "Hip_Ctrl_rotateX";
	rename -uid "DA35805C-7F40-23E6-2F34-D78BDE874DE0";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  4 0 9 0 14 0 26 0 43 0 51 -45.193870936540762
		 59 -46.133488569728399 67 -62.340658612101954;
createNode animCurveTA -n "Hip_Ctrl_rotateY";
	rename -uid "633E65E6-2141-7BBD-0233-0C851710F20F";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  4 0 9 0 14 0 26 0 43 0 51 4.9129739402689614
		 59 11.337118897122391 67 15.929249254132612;
createNode animCurveTA -n "Hip_Ctrl_rotateZ";
	rename -uid "64A9A39D-3A41-E4AA-EEF7-B8A2D6545AB4";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  4 0 9 0 14 0 26 7.7176270975926009 43 21.274344367548839
		 51 22.464240638156411 59 15.833739313571016 67 7.2135575180575993;
createNode animCurveTL -n "R_Leg_IK_End_Ctrl_translateX";
	rename -uid "CAC6CEF8-B34D-8338-30FE-4283405A99FC";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  14 0 26 0 43 0 51 0 59 0.014302605580085849
		 61 0.066882320818023019 63 0.12448942353938666 67 0.13834390964066534;
createNode animCurveTL -n "R_Leg_IK_End_Ctrl_translateY";
	rename -uid "F760DE13-C042-D468-A789-899CB4D7DD7A";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  14 0 26 0 43 0 51 0 59 0 61 0 63 0.15800148245483578
		 67 0;
createNode animCurveTL -n "R_Leg_IK_End_Ctrl_translateZ";
	rename -uid "335C4ACA-1E48-6256-98BE-18A8F840A082";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  14 0.39911496469598712 26 -0.84520632782380201
		 43 -0.76612773270350143 51 -0.51959715638187232 59 -0.49682861743304041 61 -0.42562105962427976
		 63 -0.33143599086712877 67 -0.2447029129994277;
createNode animCurveTA -n "R_Leg_IK_End_Ctrl_rotateX";
	rename -uid "9F4C9231-1541-BD97-4ABE-F3A76DDDFEA1";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  14 0 26 0 43 0 51 0 59 0 61 0 63 0 67 0;
createNode animCurveTA -n "R_Leg_IK_End_Ctrl_rotateY";
	rename -uid "631C7E00-934C-6F8D-FF16-A5B77A4259DC";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 8 ".ktv[0:7]"  14 0 26 0 43 -22.24711146115348 51 -44.494222922306975
...
createNode animCurveTA -n "L_Foot_IK_Ball_Ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  14 36.171945434544739 43 45.711517213684594
		 51 0 63 37.153361913458255;
...
createNode animCurveTL -n "R_Arm_01_FK_Ctrl_translateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  9 0 14 0 26 0 43 0 59 0 67 0;
...
createNode animCurveTA -n "R_Arm_01_FK_Ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  9 44.221680408467648 14 0 26 123.46226600558278
		 43 110.14623526033849 59 50.394669440673745 67 250.18401136225839;
	setAttr -s 6 ".kit[0:5]"  18 9 9 9 9 9;
	setAttr -s 6 ".kot[0:5]"  18 9 9 9 9 9;
createNode animCurveTA -n "R_Arm_01_FK_Ctrl_rotateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  9 -69.226608325231794 14 -55.942744755101771
...
createNode animCurveTA -n "R_Arm_01_FK_Ctrl_rotateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  9 12.71405266472722 14 55.470127730314395
...
createNode animCurveTA -n "R_Arm_02_FK_Ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  9 -182.35850059970258 14 0 26 9.929448245929132
		 37 -94.281718394474339 43 -152.92146053149392 59 -22.539537750524349 67 -21.203722523024293;
	setAttr -s 7 ".kit[0:6]"  18 9 9 9 9 9 9;
	setAttr -s 7 ".kot[0:6]"  18 9 9 9 9 9 9;
createNode animCurveTA -n "R_Arm_02_FK_Ctrl_rotateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  9 81.394535092688528 14 53.499561389728257
		 26 33.969531417586104 37 36.068102289052291 43 0.69842795312405703 59 32.585963286120176
		 67 8.7708356262628406;
	setAttr -s 7 ".kit[0:6]"  18 9 9 9 9 9 9;
	setAttr -s 7 ".kot[0:6]"  18 9 9 9 9 9 9;
createNode animCurveTA -n "R_Arm_02_FK_Ctrl_rotateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 7 ".ktv[0:6]"  9 -149.8615729725384 14 0 26 -6.1574736815726938
		 37 -131.15469704827257 43 -151.03938095414512 59 -34.029848837046998 67 -5.7177766241497761;
	setAttr -s 7 ".kit[0:6]"  18 9 9 9 9 9 9;
	setAttr -s 7 ".kot[0:6]"  18 9 9 9 9 9 9;
...
createNode animCurveTA -n "L_Arm_01_FK_Ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  9 177.69361701893425 14 120.92075136619329
...
createNode animCurveTA -n "L_Arm_01_FK_Ctrl_rotateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  9 -32.757183688610795 14 -68.697134864030289
...
createNode animCurveTA -n "L_Arm_01_FK_Ctrl_rotateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  9 -78.608220184772264 14 -22.787570174549543
...
createNode animCurveTL -n "L_Arm_02_FK_Ctrl_translateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  5 0 14 0 43 0 67 0;
...
createNode animCurveTA -n "L_Arm_02_FK_Ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  5 -7.4553488465394775 14 4.1857890017990211
		 26 71.405561532547935 43 19.553814707447057 67 11.034901808157787;
...
createNode animCurveTA -n "L_Arm_02_FK_Ctrl_rotateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  5 59.22050058244686 14 27.852445333461382
		 26 79.633291828569583 43 59.363776473254951 67 48.501778786141998;
	setAttr -s 5 ".kit[0:4]"  18 9 9 9 9;
	setAttr -s 5 ".kot[0:4]"  18 9 9 9 9;
createNode animCurveTA -n "L_Arm_02_FK_Ctrl_rotateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  5 -8.9834010314359336 14 8.9030026644048057
		 26 83.821374386358812 43 29.695859628279866 67 0.85705155899330998;
	setAttr -s 5 ".kit[0:4]"  18 9 9 9 9;
	setAttr -s 5 ".kot[0:4]"  18 9 9 9 9;
...
createNode animCurveTA -n "Head_Ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  14 0 43 8.9164051850048178 59 2.3636432046862645
		 67 47.618027094524891;
createNode animCurveTA -n "Head_Ctrl_rotateY";
	rename -uid "FD9B4D06-7D43-65AE-81DF-57A359511153";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  14 0 43 0 59 -2.6412590722575251 67 -4.8918424753999288;
createNode animCurveTA -n "Head_Ctrl_rotateZ";
	rename -uid "0016378A-BF4D-AA6D-0A1F-C39040749183";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  14 15.335159130164126 43 15.335159130164108
		 59 2.8209613350962424 67 -8.8786132573366441;
...
createNode animCurveTA -n "R_Foot_IK_Ball_Ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  14 39.850816101941639 20 5.9942137406072584
		 26 49.735316024782584 43 47.033135196412744 51 0 63 22.109604937575291;
...
createNode animCurveTA -n "R_Finger_03_Knuckle_02_Ctrl_rotateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  26 0 43 -4.1130932263733078 59 -1.0215663426270416
...
createNode animCurveTA -n "R_Finger_05_Knuckle_01_Ctrl_rotateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  26 39.637169767682927 43 -4.2123727925732544
...
createNode animCurveTA -n "R_MetCarp_03_Ctrl_rotateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  26 39.637169767682927 59 6.9128081401575487
...
createNode animCurveTA -n "R_Finger_02_Knuckle_01_Ctrl_rotateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  26 39.637169767682927 43 -6.2412352382037337
...
createNode animCurveTA -n "R_Finger_05_Knuckle_03_Ctrl_rotateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  26 39.637169767682927 43 19.123323067276203
...
createNode animCurveTA -n "Spine_02_Ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  14 0 26 0 43 0 59 -23.587814866744058 67 -35.41635308679578;
createNode animCurveTA -n "Spine_02_Ctrl_rotateY";
	rename -uid "577C2B1B-2B4A-55E0-54B7-988210D5D309";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  14 0 26 0 43 0 59 0 67 -7.5337720796295011;
createNode animCurveTA -n "Spine_02_Ctrl_rotateZ";
	rename -uid "E2D00E25-9246-9A22-2260-028676E73681";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 5 ".ktv[0:4]"  14 1.4891029454152251 26 15.191019309694683
		 43 38.439920630257255 59 38.439920630257284 67 27.99310894461237;
...
createNode animCurveTA -n "Spine_03_Ctrl_rotateZ";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  14 -10 43 -13.932646451022885;
createNode animCurveTL -n "L_Leg_IK_End_Ctrl_translateX";
	rename -uid "C550A8D9-184D-4FA7-8C6D-ADBE5075D336";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  4 3.3462951265720244e-16 14 0 43 0 47 0
...
createNode animCurveTL -n "L_Leg_IK_End_Ctrl_translateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  4 -1.7763568394002505e-17 14 0 43 0 47 0.091366003559572931
		 51 0 54 0 59 0.15666580624517448 63 0 67 0;
createNode animCurveTL -n "L_Leg_IK_End_Ctrl_translateZ";
	rename -uid "C3D9111D-D44C-547A-10DF-71A5FA8067CE";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  4 0.79351867425507394 14 -0.12814274244425064
		 43 -1.1635774920691324 47 -0.80903163605579265 51 -0.45448578004245321 54 -0.41457754798452584
		 59 -0.39302607628879094 63 -0.34275609540883478 67 -0.17959153666000877;
createNode animCurveTA -n "L_Leg_IK_End_Ctrl_rotateX";
	rename -uid "2A75473A-624D-858B-DDBE-8FBFC6D462E9";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  4 0 14 0 43 0 47 0 51 0 54 0 59 0 63 0 67 0;
createNode animCurveTA -n "L_Leg_IK_End_Ctrl_rotateY";
	rename -uid "193681B8-CF48-DFFC-5322-C0AF94C1A4D5";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 9 ".ktv[0:8]"  4 0 14 0 43 0 47 0 51 0 54 -7.6787680590455336
		 59 -24.268699050810568 63 -24.268699050810568 67 -42.983909712109607;
...
createNode animCurveTL -n "L_Leg_PV_Ctrl_translateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  4 -0.057829800362253519 14 0 51 0.01061361827069188
		 59 0.089346944891761093 63 0.051567693108289792 67 0.041195636678435343;
createNode animCurveTL -n "L_Leg_PV_Ctrl_translateY";
	rename -uid "95CBAE70-CA48-3308-BE19-29868E0B305C";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  4 0.37677222915826508 14 0 51 -0.095437048583934508
		 59 -0.59605455371103222 63 -0.33300272897170852 67 -0.24851403299425362;
createNode animCurveTL -n "L_Leg_PV_Ctrl_translateZ";
	rename -uid "CA0A4A07-6A40-51DC-72A0-1B8019A87AB2";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  4 -1.6136188714777511e-16 14 0 51 0.25894250482291858
		 59 0.47609237486310074 63 0.37892103794257609 67 0.30551358208103635;
createNode animCurveTL -n "R_Leg_PV_Ctrl_translateX";
	rename -uid "162C381B-154A-0D38-61B6-DA85A0591BCF";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  4 0.034945641034115182 14 0 51 -0.025305112353070678
		 59 -0.10154396008072133 63 -0.049897211234179388 67 -0.059123291346541422;
createNode animCurveTL -n "R_Leg_PV_Ctrl_translateY";
	rename -uid "E40B7F52-4E4F-FC78-9925-87971C18E459";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  4 -0.22767754668546641 14 0 51 0.11363598519290877
		 59 0.65339028844195102 63 0.29998906341817816 67 0.34318598188352684;
createNode animCurveTL -n "R_Leg_PV_Ctrl_translateZ";
	rename -uid "7E83093A-7A44-223E-F2BE-DB85CDD96107";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 6 ".ktv[0:5]"  4 6.6403063547628843e-16 14 0 51 0.31047161746448859
		 59 0.57490771983232269 63 0.27391339902693052 67 0.42805722514824485;
createNode animCurveTA -n "R_Leg_PV_Ctrl_rotateX";
	rename -uid "1FB73DC2-3849-52BA-32F2-49A524998A2F";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  4 0 59 0 63 0 67 0;
...
createNode animCurveTA -n "L_Arm_03_FK_Ctrl_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  14 0 59 -49.452700032820005 67 -17.325790086963273;
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "CBB5DF3F-B144-57AD-9701-8D9CF0A324DC";
