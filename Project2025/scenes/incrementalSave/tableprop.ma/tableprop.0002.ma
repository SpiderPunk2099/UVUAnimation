...
//Name: tableprop.ma
//Last modified: Wed, Mar 18, 2026 09:23:51 PM
//Codeset: UTF-8
...
fileInfo "UUID" "F0C98CE9-174D-9940-EF20-E886B7D7A5F0";
createNode transform -s -n "persp";
	rename -uid "1F3EAEF2-354C-3BDF-D456-6EAA6A2FACEB";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 6.0300989451658857 4.4837011210492088 -0.44001524166059314 ;
	setAttr ".r" -type "double3" -21.938352730516929 -267.00000000001614 0 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 6.6624898323950257;
	setAttr ".ow" 0.1;
...
createNode transform -n "pCylinder6";
	...
	setAttr ".s" -type "double3" 1.3920763094005462 1.0184324697225047 1.1370909186932485 ;
...
createNode reference -n "SkeletonRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" 0.015172683761354371 0.98673771844612956 -2.22136564208130993"
...
createNode reference -n "SkeletonRN1";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" 0 0.97758286120958648 0"
		...
		"translate" " -type \"double3\" -0.072045765772941597 0.0018152122598693052 0"
