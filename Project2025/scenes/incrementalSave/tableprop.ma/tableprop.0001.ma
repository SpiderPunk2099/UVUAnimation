...
//Name: tableprop.ma
//Last modified: Wed, Mar 18, 2026 09:19:09 PM
//Codeset: UTF-8
...
fileInfo "UUID" "9069C3A5-F14B-A83A-206D-EAB64D0824D5";
createNode transform -s -n "persp";
	rename -uid "1F3EAEF2-354C-3BDF-D456-6EAA6A2FACEB";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.5061591123647851 2.5033961907646187 5.518806012318958 ;
	setAttr ".r" -type "double3" -5.1383527299098333 -370.19999999992615 -6.0593036378689897e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 5.9112091609557336;
	setAttr ".ow" 0.1;
...
createNode reference -n "SkeletonRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" 0.015172683761354371 0.98673771844612956 0"
