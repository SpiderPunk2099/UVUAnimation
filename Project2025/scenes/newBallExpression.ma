...
//Last modified: Sun, Feb 01, 2026 07:49:11 PM
//Codeset: UTF-8
...
fileInfo "UUID" "8A9E3C77-9648-C040-60E9-C8821D1AF568";
createNode transform -s -n "persp";
	rename -uid "BEF3ED4B-C145-D9C8-D984-8887B9622330";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.69142127999984204 1.5579510820979836 24.753268468773992 ;
	setAttr ".r" -type "double3" -3.6000000000000036 1.5999999999999639 3.7286662682375829e-17 ;
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 53 -max 71 -ast 2 -aet 160 ";
	setAttr ".st" 6;
...
createNode animCurveTL -n "CTRL_Main_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 20 ".ktv[0:19]"  2 0 7 0 10 0 13 0 16 0 19 0 22 0 25 0 28 0
		 31 0 34 0 37 0 41 0 44 0 47 0 50 0 53 0 59 0 62 0 65 0;
createNode animCurveTL -n "CTRL_Main_translateY";
	rename -uid "7019C399-6F47-7024-9EAC-8696B2A8AFE7";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 20 ".ktv[0:19]"  2 -1.8859221422663968 7 -1.8859221422663968
		 ...
		 62 0.69361447895395623 65 0.69361447895395623;
createNode animCurveTL -n "CTRL_Main_translateZ";
	rename -uid "E6874F78-DC46-DD0E-5505-F7953694C1CC";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 20 ".ktv[0:19]"  2 0 7 0 10 0.82692135945353584 13 0.82692135945353584
...
createNode animCurveTA -n "CTRL_Main_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 20 ".ktv[0:19]"  2 0 7 12.959007203081136 10 12.959007203081136
		 ...
		 50 -9.2707418391758214 53 2.8840179767084924 59 27.578111975578238 62 -0.73803633199278795
		 65 -9.8516292010548643;
...
createNode animCurveTL -n "CTRL_Top_translateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 21 ".ktv[0:20]"  2 0 7 0 10 0 13 0 16 0 19 0 22 0 25 0 28 0
		 31 0 34 0 37 0 41 0 44 0 47 0 50 0 53 0 56 0 59 0 62 0 65 0;
createNode animCurveTL -n "CTRL_Top_translateY";
	rename -uid "7D313D66-3940-4B3F-9333-F186ADC33E96";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 21 ".ktv[0:20]"  2 0 7 0.23226974008745663 10 0.090261194420439908
		 ...
		 62 0.038112876863027875 65 0.038112876863027875;
createNode animCurveTL -n "CTRL_Top_translateZ";
	rename -uid "F14B516D-4145-8FC6-A082-BC8CA695EFC5";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 21 ".ktv[0:20]"  2 0 7 -0.060858264920163739 10 -0.028180007896709908
		 ...
		 62 -0.25958325621194955 65 -0.25958325621194955;
