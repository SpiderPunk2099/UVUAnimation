...
//Name: robot.ma
//Last modified: Wed, Jan 21, 2026 11:03:05 AM
//Codeset: UTF-8
requires maya "2026";
...
fileInfo "UUID" "B146AD8B-4D43-5C11-AA59-B8812C2150B3";
createNode transform -s -n "persp";
	rename -uid "F20C779C-FF4E-EB47-D9C8-ECA6F6443F47";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.33281690090335331 8.7129438497084468 16.218478789513462 ;
	setAttr ".r" -type "double3" -21.600000000000339 372.39999999996002 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "CE79B1C7-F247-2D20-085A-9E89E13FBD77";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "036F91BA-5944-7DEF-CD67-0D947DD8CC41";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B66FE1D2-664D-A795-0009-16943C837C16";
createNode displayLayerManager -n "layerManager";
	rename -uid "AEF86C78-234B-C3DF-B3AD-7D88CE51886E";
createNode displayLayer -n "defaultLayer";
	rename -uid "5B32ADA8-E049-477D-3D6E-90898843A353";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "01D82F37-C041-29DA-DB1E-90AA42DE7403";
