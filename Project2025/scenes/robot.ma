...
//Name: robot.ma
//Last modified: Sun, Jan 11, 2026 10:15:03 PM
//Codeset: UTF-8
requires maya "2026";
...
fileInfo "UUID" "A0839EBE-1746-2204-567D-48B596CD2977";
createNode transform -s -n "persp";
	rename -uid "F20C779C-FF4E-EB47-D9C8-ECA6F6443F47";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -3.1440854692480884 3.7800664010590133 10.819486026942194 ;
	setAttr ".r" -type "double3" 25.199999999999992 9.9999999999994973 -4.0370248301447983e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 7.9795671652639557;
	setAttr ".ow" 0.1;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -3.2248755213702247 7.2715811709913298 13.092902853963022 ;
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 8 ".pt[112:119]" -type "float3"  0.066088274 0 0 0.066088274 
		0 0 0.066088274 0 0 0.066088274 0 0 -0.066088274 0 0 -0.066088274 0 0 -0.066088274 
		0 0 -0.066088274 0 0;
...
createNode polyTweak -n "polyTweak14";
	...
	setAttr ".uopa" yes;
	setAttr -s 9 ".tk";
	setAttr ".tk[72]" -type "float3" -2.545794 28.953484 12.088468 ;
	setAttr ".tk[73]" -type "float3" 8.2105522 1.8951256 12.088468 ;
	setAttr ".tk[74]" -type "float3" 8.2105522 1.8951256 -11.647851 ;
	setAttr ".tk[75]" -type "float3" -2.545794 28.953484 -12.088468 ;
	setAttr ".tk[76]" -type "float3" 2.545794 28.953447 12.088468 ;
	setAttr ".tk[77]" -type "float3" -8.2105055 1.8951256 12.088468 ;
	setAttr ".tk[78]" -type "float3" 2.545794 28.953447 -12.088468 ;
	setAttr ".tk[79]" -type "float3" -8.2105055 1.8951256 -11.647851 ;
...
createNode polyTweak -n "polyTweak16";
	...
	setAttr ".uopa" yes;
	setAttr -s 25 ".tk";
	setAttr ".tk[72]" -type "float3" 2.7635064 0.56944597 6.5652504 ;
	setAttr ".tk[73]" -type "float3" 2.7635064 0.56944597 -6.5652514 ;
	setAttr ".tk[74]" -type "float3" -2.7634771 -0.56945705 6.5652504 ;
	setAttr ".tk[75]" -type "float3" -2.7634771 -0.56945705 -6.5652514 ;
	setAttr ".tk[76]" -type "float3" -2.7634952 0.56946838 6.5652504 ;
	setAttr ".tk[77]" -type "float3" -2.7634952 0.56946838 -6.5652514 ;
	setAttr ".tk[78]" -type "float3" 2.7634952 -0.5694676 -6.5652514 ;
	setAttr ".tk[79]" -type "float3" 2.7634952 -0.5694676 6.5652504 ;
	setAttr ".tk[80]" -type "float3" -7.1840663 -1.480333 -17.828867 ;
	setAttr ".tk[81]" -type "float3" -7.1840663 -1.480333 17.828859 ;
	setAttr ".tk[82]" -type "float3" 7.1839595 1.4803746 -17.828867 ;
	setAttr ".tk[83]" -type "float3" 7.1839595 1.4803746 17.828859 ;
	setAttr ".tk[84]" -type "float3" 7.1840062 -1.4804084 -17.828867 ;
	setAttr ".tk[85]" -type "float3" 7.1840062 -1.4804084 17.828859 ;
	setAttr ".tk[86]" -type "float3" -7.1840067 1.4804084 17.828859 ;
	setAttr ".tk[87]" -type "float3" -7.1840067 1.4804084 -17.828867 ;
	setAttr ".tk[88]" -type "float3" 1.4161773 3.5762787e-07 0 ;
	setAttr ".tk[89]" -type "float3" 1.4161777 3.5762787e-07 -4.7683716e-07 ;
	setAttr ".tk[90]" -type "float3" 1.4161768 3.5762787e-07 0 ;
	setAttr ".tk[91]" -type "float3" 1.4161777 -5.9604645e-07 -4.7683716e-07 ;
	setAttr ".tk[92]" -type "float3" -1.4161773 3.5762787e-07 0 ;
	setAttr ".tk[93]" -type "float3" -1.416178 3.5762787e-07 -4.7683716e-07 ;
	setAttr ".tk[94]" -type "float3" -1.4161766 3.5762787e-07 -4.7683716e-07 ;
	setAttr ".tk[95]" -type "float3" -1.416177 3.5762787e-07 0 ;
...
createNode polyTweak -n "polyTweak17";
	...
	setAttr ".uopa" yes;
	setAttr -s 33 ".tk";
	setAttr ".tk[72]" -type "float3" 0.94411808 0 0 ;
	setAttr ".tk[73]" -type "float3" 0.94411808 0 0 ;
	setAttr ".tk[74]" -type "float3" 0.94411808 0 0 ;
	setAttr ".tk[75]" -type "float3" 0.94411808 0 0 ;
	setAttr ".tk[76]" -type "float3" -0.94411808 0 0 ;
	setAttr ".tk[77]" -type "float3" -0.94411808 0 0 ;
	setAttr ".tk[78]" -type "float3" -0.94411808 0 0 ;
	setAttr ".tk[79]" -type "float3" -0.94411808 0 0 ;
	setAttr ".tk[80]" -type "float3" 2.3602953 0 0 ;
	setAttr ".tk[81]" -type "float3" 2.3602953 0 0 ;
	setAttr ".tk[82]" -type "float3" 2.3602953 0 0 ;
	setAttr ".tk[83]" -type "float3" 2.3602953 0 0 ;
	setAttr ".tk[84]" -type "float3" -2.3602953 0 0 ;
	setAttr ".tk[85]" -type "float3" -2.3602953 0 0 ;
	setAttr ".tk[86]" -type "float3" -2.3602953 0 0 ;
	setAttr ".tk[87]" -type "float3" -2.3602953 0 0 ;
	setAttr ".tk[88]" -type "float3" 1.8882363 2.3841858e-07 0 ;
	setAttr ".tk[89]" -type "float3" 1.8882363 2.3841858e-07 0 ;
	setAttr ".tk[90]" -type "float3" 1.8882365 -2.3841858e-07 0 ;
	setAttr ".tk[91]" -type "float3" 1.8882365 -2.3841858e-07 0 ;
	setAttr ".tk[92]" -type "float3" -1.8882363 -9.5367432e-07 0 ;
	setAttr ".tk[93]" -type "float3" -1.8882363 -9.5367432e-07 0 ;
	setAttr ".tk[94]" -type "float3" -1.8882365 1.0728836e-06 0 ;
	setAttr ".tk[95]" -type "float3" -1.8882365 1.0728836e-06 0 ;
	setAttr ".tk[96]" -type "float3" 8.4348488 -0.29087278 -0.54168659 ;
	setAttr ".tk[97]" -type "float3" 8.4970646 -9.5367432e-07 -1.4210855e-14 ;
	setAttr ".tk[98]" -type "float3" 8.4348488 -0.29087171 -0.54168659 ;
	setAttr ".tk[99]" -type "float3" 8.4970646 4.7683716e-07 -1.4210855e-14 ;
	setAttr ".tk[100]" -type "float3" -8.4348488 -0.29087254 -0.54168659 ;
	setAttr ".tk[101]" -type "float3" -8.4970646 -4.7683716e-07 -1.4210855e-14 ;
	setAttr ".tk[102]" -type "float3" -8.4970627 4.7683716e-07 -1.4210855e-14 ;
	setAttr ".tk[103]" -type "float3" -8.4348488 -0.29087147 -0.54168659 ;
