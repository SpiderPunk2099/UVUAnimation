...
//Last modified: Mon, Sep 22, 2025 10:10:23 AM
//Codeset: UTF-8
requires maya "2024";
...
fileInfo "UUID" "36FD4F78-514B-E890-BEA8-93BD9E0F6827";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "BB70874E-134C-55CF-2045-98AEE31D60A7";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "DCF483D9-6A42-52A2-8D4D-0F8835B3D037";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "796F93B3-0343-AE02-E622-02A97C1C918E";
createNode displayLayerManager -n "layerManager";
	rename -uid "81637294-A54D-0E38-B81D-E18003B59C89";
createNode displayLayer -n "defaultLayer";
	rename -uid "9D1F9034-C846-DB6C-B57B-29B44BE4C9E6";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "675EC763-C34D-F6FA-5A55-43BAAF7FCAD0";
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "52720D56-D54F-F128-97AE-7A82AE748B57";
