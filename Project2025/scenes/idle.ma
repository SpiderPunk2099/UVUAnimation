...
//Name: idle.ma
//Last modified: Mon, Nov 17, 2025 12:16:05 PM
//Codeset: UTF-8
...
fileInfo "UUID" "0BE6C186-1D44-7B22-98FB-08846EC66960";
createNode transform -s -n "persp";
	rename -uid "3EBBE575-6E48-0E24-E94A-E4B30819795E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 8.5949226101154554 4.9959188504443706 15.262027163657505 ;
	setAttr ".r" -type "double3" -6.3383527295899276 1112.1999999994689 2.3491641807982024e-16 ;
...
createNode reference -n "Ultimate_Bony_v1_0_5RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" 36.4628070642563884 0 0"
		2 "|Ultimate_Bony_v1_0_5:Bony|Ultimate_Bony_v1_0_5:Bony_Main_CNT|Ultimate_Bony_v1_0_5:Bony_Spine02FKCG|Ultimate_Bony_v1_0_5:Bony_Spine02FKC" 
		"rotatePivotTranslate" " -type \"double3\" 0 0 0"
...
createNode animCurveTL -n "Bony_ROOTC_translateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 -2.1908435819613352 20 -2.0146757239311395
		 34 -2.3218306138911684 50 -2.1908435819613352;
...
createNode animCurveTL -n "Bony_ROOTC_translateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 0 20 0 34 0 50 0;
...
createNode animCurveTA -n "Bony_Spine02FKC_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 36.462807064256388 28 33.228016300842391
		 41 36.463;
createNode animCurveTA -n "Bony_lShoulderFKC_rotateY";
	rename -uid "0133DD67-3A49-7CB3-E764-118173C0DF29";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 -66.794625619163369 20 -60.58236247828755
		 34 -66.794625619163369;
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 2 -max 49 -ast 2 -aet 50 ";
	setAttr ".st" 6;
createNode animCurveTA -n "Bony_Neck01C_rotateX";
	rename -uid "41EE5E54-4142-F8CC-8B1B-06A9678BFEEA";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 15.467683791674343 20 14.847681549335938
		 34 15.467683791674343 50 15.467683791674343;
createNode animCurveTA -n "Bony_rElbowFKC_rotateY";
	rename -uid "ED56D73D-ED4A-629D-92E7-4997F807C817";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 -118.63975902711201 20 -113.69885125172019
		 34 -118.64;
createNode animCurveTA -n "Bony_rShoulderFKC_rotateX";
	rename -uid "1EEB9A56-0446-64C6-5FB3-65A4DC8C82EA";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 -40.353897321443448 20 -36.882070714251974
		 34 -40.353897321443448;
createNode animCurveTA -n "Bony_lElbowFKC_rotateY";
	rename -uid "7CFC3A4A-CF49-951A-DB7E-43AC0176A441";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 -31.865524047428128 20 -37.917088989151971
		 34 -31.866;
createNode animCurveTA -n "Bony_lShoulderFKC_rotateX";
	rename -uid "C183D4BA-6D40-3665-7D12-A1B6438724CD";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 52.617797787598384 20 39.601705317086612
		 34 52.617797787598384;
createNode animCurveTA -n "Bony_lShoulderFKC_rotateZ";
	rename -uid "50192A01-BA45-1DBC-6908-258C674B458D";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 -54.921493427959625 20 -40.437329966772239
		 34 -54.921493427959625;
...
createNode animCurveTA -n "Bony_HeadC_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 -52.136849679935345 20 -55.788133709957563
		 34 -52.136849679935345;
createNode animCurveTA -n "Bony_HeadC_rotateY";
	rename -uid "A787B449-8E4B-B890-016E-8183AAA72F1A";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 18.137998602678675 20 19.363944267795961
		 34 18.137998602678675;
createNode animCurveTA -n "Bony_HeadC_rotateZ";
	rename -uid "D7E54CE8-B14E-7604-A2FF-48A12D31398A";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 -6.5935049112928121 20 -8.4760223059143556
		 34 -6.5935049112928121;
...
createNode animCurveTA -n "Bony_Neck01C_rotateY";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 0.6432971672566743 20 0.64329716725667252
		 34 0.6432971672566743 50 0.6432971672566743;
createNode animCurveTA -n "Bony_Neck01C_rotateZ";
	rename -uid "0E109871-EF4E-4638-7EA4-2EADF92FDBCB";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 -0.81021183547331532 20 -0.8102118354733181
		 34 -0.81021183547331532 50 -0.81021183547331532;
createNode animCurveTA -n "Bony_rShoulderFKC_rotateY";
	rename -uid "77665E9B-B74D-25D2-3B30-CDAEC192926D";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 12.283122106727404 20 13.351882209960932
		 34 12.283122106727404;
createNode animCurveTA -n "Bony_rShoulderFKC_rotateZ";
	rename -uid "26EFF5A3-284D-9A48-A94B-99B0A7C002E0";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 7.7559737151811188 20 12.421247947908464
		 34 7.7559737151811188;
createNode animCurveTA -n "Bony_Spine03FKC_rotateX";
	rename -uid "3BD6F56F-C745-58FE-2278-F7AE990767C2";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 0 20 -3.9432559241249665 34 0;
createNode animCurveTA -n "Bony_Spine03FKC_rotateY";
	rename -uid "125AEEA9-B640-7295-02A8-42AF6D42FC5A";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 0 20 0 34 0;
...
createNode animCurveTA -n "Bony_lWristFKC_rotateX";
	...
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 0 20 -10.079874762247629 34 0;
createNode animCurveTA -n "Bony_lWristFKC_rotateY";
	rename -uid "C985A110-D94B-4FFA-0187-1084F59C5B2B";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 0 20 -0.72349095940908059 34 0;
createNode animCurveTA -n "Bony_lWristFKC_rotateZ";
	rename -uid "81AE488C-F246-EE63-8586-84856A8BE591";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 0 20 -5.3700858096279847 34 0;
