...
//Name: off chest.ma
//Last modified: Mon, Apr 06, 2026 12:34:34 PM
//Codeset: UTF-8
...
fileInfo "UUID" "3D8B1A13-A14D-68D2-40B8-198FE99A208A";
createNode transform -s -n "persp";
	rename -uid "59D701D5-2347-C01C-0996-DB9DAFD035AC";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 72.222672122140452 59.536666756671565 70.705014565757978 ;
	setAttr ".r" -type "double3" -27.938352729596772 36.200000000000472 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "02BF70E3-0D46-FFB6-0E02-12B202FC50CF";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 108.63140064503609;
...
createNode camera -n "persp1Shape" -p "persp1";
	...
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 73.810637809952937;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -n "pPlane1";
	rename -uid "11499B29-1744-11C4-8F29-7784C0C8A27A";
	setAttr ".t" -type "double3" 0 0.052960704552956095 0 ;
	setAttr ".s" -type "double3" 76.151307008138247 76.151307008138247 76.151307008138247 ;
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	rename -uid "B12E7056-754C-1037-B76D-5D9E2B9CA2EC";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "4E5F1ADA-9E48-47C9-D66B-17B82B83F875";
	setAttr -s 14 ".lnk";
	setAttr -s 14 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "99DA88D5-7946-1E10-1807-1CB9F75BFC6A";
	setAttr ".bsdt[0].bscd" -type "Int32Array" 2 0 1 ;
	setAttr -s 2 ".bspr";
	setAttr -s 2 ".obsv";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "C6E17368-C841-44EE-E766-B992236CC280";
createNode displayLayerManager -n "layerManager";
	rename -uid "8B6769F5-9A40-270C-08F6-76BD1C5AE4BD";
createNode displayLayer -n "defaultLayer";
	rename -uid "45ADD7A1-6C47-A0A4-8D94-B08932235F02";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "30A6BBBA-0A43-C367-2B8F-EF95F8D03B55";
...
createNode animCurveTA -n "Bony_lShoulderFKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 19.590022815525742 25 19.590022815525742
		 45 -108.01776361239349 76 -47.929081333758589;
	setAttr -s 4 ".kot[0:3]"  9 9 9 9;
createNode animCurveTA -n "Bony_lShoulderFKC_rotateY";
	rename -uid "9294BDBE-2844-3226-2421-52AB143BDBD1";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 -55.395391691197325 25 -55.395391691197325
		 45 -15.346904828088183 76 -21.889018578509631;
	setAttr -s 4 ".kot[0:3]"  9 9 9 9;
createNode animCurveTA -n "Bony_lShoulderFKC_rotateZ";
	rename -uid "73555E31-924A-9CD2-2169-5891B72185F6";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  2 -13.372509830590412 25 -13.372509830590412
		 45 -58.414927202607039 76 -86.791754108980157;
	setAttr -s 4 ".kot[0:3]"  9 9 9 9;
...
createNode animCurveTA -n "Bony_lWristFKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 0 41 -44.722192010869811 76 70.470858642324501;
	setAttr -s 3 ".kot[0:2]"  9 9 9;
...
createNode animCurveTA -n "Bony_lWristFKC_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  2 -46.555170573676918 41 20.529978374173734;
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".b" -type "string" "playbackOptions -min 2 -max 115 -ast 2 -aet 115 ";
	setAttr ".st" 6;
createNode animCurveTL -n "persp1_translateX";
	rename -uid "054EE713-A14C-6436-13CA-7FBA5BDBBA23";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 13.01707842811987 57 13.01707842811987
		 58 25.847409033895271;
	setAttr -s 3 ".kot[0:2]"  9 9 9;
createNode animCurveTL -n "persp1_translateY";
	rename -uid "E38B2D28-DD44-8870-5843-A4B9600F8C59";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 3.1814381792523232 57 3.1814381792523232
		 58 10.233559128406208;
	setAttr -s 3 ".kot[0:2]"  9 9 9;
createNode animCurveTL -n "persp1_translateZ";
	rename -uid "4D332ABE-834B-7C6A-03FE-E6A8FC666C7C";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 11.864655892916517 57 11.864655892916517
		 58 13.391644767292927;
	setAttr -s 3 ".kot[0:2]"  9 9 9;
createNode animCurveTA -n "persp1_rotateX";
	rename -uid "FA2A01AC-E64A-32B2-1373-72A2B5DA970E";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 -3.9383527296039302 57 -3.9383527296039302
		 58 -26.738352729604081;
	setAttr -s 3 ".kot[0:2]"  9 9 9;
createNode animCurveTA -n "persp1_rotateY";
	rename -uid "A2E9166B-EA47-B27C-0F9A-7F8420D70C42";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 42.6000000000016 57 42.6000000000016 58 28.200000000001594;
	setAttr -s 3 ".kot[0:2]"  9 9 9;
createNode reference -n "Ultimate_Bony_v1_0_5RN1";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		" -type \"double3\" 16.70085362226019399 0.57118033817070801 0.068088071216926949"
...
createNode reference -n "spatulasAndHolderRN1";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|spatulasAndHolder1:Spatula_holder:spatula" "translate" " -type \"double3\" 18.51292680555027914 -0.25943274441347119 -1.89009047605531855"
		
		2 "|spatulasAndHolder1:Spatula_holder:spatula" "rotate" " -type \"double3\" -114.85269559726364719 38.27598183390453812 -2.72366446536058593"
...
createNode animCurveTA -n "Bony_rWristFKC_rotateX1";
	...
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  75 0 84 0 88 0;
	setAttr -s 3 ".kit[0:2]"  18 1 18;
	setAttr -s 3 ".kot[0:2]"  9 1 9;
	setAttr -s 3 ".kix[1:2]"  1 1;
	setAttr -s 3 ".kiy[1:2]"  0 0;
...
createNode animCurveTA -n "Bony_rWristFKC_rotateZ1";
	...
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 4 ".ktv[0:3]"  75 -59.880277514993203 84 -59.880277514993203
		 86 -15.849960670433285 88 -59.880277514993203;
	setAttr -s 4 ".kit[0:3]"  18 1 1 1;
	setAttr -s 4 ".kot[0:3]"  9 1 1 1;
	setAttr -s 4 ".kix[1:3]"  1 1 1;
	setAttr -s 4 ".kiy[1:3]"  0 0 0;
	setAttr -s 4 ".kox[1:3]"  0.51223323845048541 0.30936133339976074 
		0.16054995300619657;
	setAttr -s 4 ".koy[1:3]"  0.85884638290355986 0.95094456483915091 
		0.98702771622164098;
...
createNode animCurveTA -n "Bony_rFootIKC_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  75 1.1772066593287509e-14;
	setAttr ".kot[0]"  9;
...
createNode animCurveTA -n "Bony_lFootIKC_rotateY1";
	...
	setAttr -s 3 ".ktv[0:2]"  75 -92.382084789655551 77 -18.683317943223695
		 79 -79.916995278759089;
	setAttr -s 3 ".kit[2]"  1;
	setAttr -s 3 ".kot[0:2]"  9 9 1;
	setAttr -s 3 ".kix[2]"  1;
	setAttr -s 3 ".kiy[2]"  0;
	setAttr -s 3 ".kox[2]"  0.26328127525605854;
	setAttr -s 3 ".koy[2]"  -0.96471911461292381;
...
createNode animCurveTA -n "Bony_SpineTopIKC_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  75 0.37152067035791331;
	setAttr ".kot[0]"  9;
...
createNode polyPlane -n "polyPlane1";
	rename -uid "0A3A1CE1-BD48-6050-732C-47B0F53A2EFA";
	setAttr ".cuv" 2;
createNode animCurveTL -n "Bony_Main_CNT_translateX";
	rename -uid "90DC0C9E-354C-CF8E-4FF9-8DAB8E37ADA7";
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 0 57 0 58 8.04310887723123;
	setAttr -s 3 ".kit[0:2]"  18 1 1;
	setAttr -s 3 ".kot[0:2]"  9 1 1;
	setAttr -s 3 ".kix[1:2]"  1 1;
	setAttr -s 3 ".kiy[1:2]"  0 0;
	setAttr -s 3 ".kox[1:2]"  0.27861606206108874 0.089402263653083375;
	setAttr -s 3 ".koy[1:2]"  0.96040256661546441 -0.99599560001724141;
createNode animCurveTL -n "Bony_Main_CNT_translateY";
	rename -uid "C2940731-1E41-10E5-1BC3-1C873424812F";
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 0 57 0 58 0;
	setAttr -s 3 ".kit[0:2]"  18 1 18;
	setAttr -s 3 ".kot[0:2]"  9 1 9;
	setAttr -s 3 ".kix[1:2]"  1 1;
	setAttr -s 3 ".kiy[1:2]"  0 0;
...
createNode animCurveTL -n "Bony_Main_CNT_translateZ";
	rename -uid "F51659F2-914F-5CE0-8CFB-DC90101EA38E";
	setAttr ".tan" 1;
	setAttr ".wgt" no;
	setAttr -s 3 ".ktv[0:2]"  2 0 57 0 58 -2.5294584096421211;
	setAttr -s 3 ".kit[0:2]"  18 1 1;
	setAttr -s 3 ".kot[0:2]"  9 1 1;
	setAttr -s 3 ".kix[1:2]"  1 1;
	setAttr -s 3 ".kiy[1:2]"  0 0;
	setAttr -s 3 ".kox[1:2]"  0.67803666066013768 0.18977531292602751;
	setAttr -s 3 ".koy[1:2]"  -0.73502808572247713 0.98182754626453028;
createNode animCurveTA -n "persp1_rotateZ";
	rename -uid "57E8295D-7546-5AA0-F51A-DFAA79634439";
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr ".ktv[0]"  57 4.5815298781423151e-16;
	setAttr ".kot[0]"  9;
select -ne :time1;
	setAttr ".o" 4;
	setAttr ".unw" 4;
...
connectAttr "Bony_lWristFKC_rotateY.o" "Ultimate_Bony_v1_0_5RN.phl[25]";
...
connectAttr "Bony_lFinger1J1C_rotateX.o" "Ultimate_Bony_v1_0_5RN.phl[30]";
...
connectAttr "Bony_lFinger1J2C_rotateX.o" "Ultimate_Bony_v1_0_5RN.phl[33]";
connectAttr "Bony_lFinger1J2C_rotateY.o" "Ultimate_Bony_v1_0_5RN.phl[34]";
connectAttr "Bony_lFinger1J2C_rotateZ.o" "Ultimate_Bony_v1_0_5RN.phl[35]";
...
connectAttr "Bony_lFinger1J3C_rotateZ.o" "Ultimate_Bony_v1_0_5RN.phl[38]";
...
connectAttr "Bony_lFinger2J2C_rotateZ.o" "Ultimate_Bony_v1_0_5RN.phl[44]";
...
connectAttr "Bony_lFinger2J3C_rotateZ.o" "Ultimate_Bony_v1_0_5RN.phl[47]";
connectAttr "Bony_rFootIKC_translateX.o" "Ultimate_Bony_v1_0_5RN.phl[48]";
...
connectAttr "Bony_rKneeIKC_translateX.o" "Ultimate_Bony_v1_0_5RN.phl[51]";
connectAttr "Bony_rKneeIKC_translateY.o" "Ultimate_Bony_v1_0_5RN.phl[52]";
connectAttr "Bony_rKneeIKC_translateZ.o" "Ultimate_Bony_v1_0_5RN.phl[53]";
connectAttr "Bony_rWristFKC_rotateZ.o" "Ultimate_Bony_v1_0_5RN.phl[54]";
connectAttr "Bony_rWristFKC_rotateX.o" "Ultimate_Bony_v1_0_5RN.phl[55]";
...
connectAttr "Bony_lThumbJ1C_rotateX.o" "Ultimate_Bony_v1_0_5RN.phl[61]";
connectAttr "Bony_lThumbJ1C_rotateY.o" "Ultimate_Bony_v1_0_5RN.phl[62]";
connectAttr "Bony_lThumbJ1C_rotateZ.o" "Ultimate_Bony_v1_0_5RN.phl[63]";
