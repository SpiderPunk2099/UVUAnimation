...
//Name: Run.ma
//Last modified: Mon, Oct 20, 2025 06:58:27 PM
//Codeset: UTF-8
...
fileInfo "UUID" "DFC63EFF-1648-D1CF-CDFB-5D919868D9FE";
createNode transform -s -n "persp";
	rename -uid "C0B330F1-4345-EFEA-BE9C-EF83DCC6FE1F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -18.415656650876635 3.6213591680365562 0.43458007364353773 ;
	setAttr ".r" -type "double3" -1.1999999998636959 -5129.9999999993643 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 19.578012456172761;
...
createNode reference -n "Ultimate_Bony_v1_0_5RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"translate" " -type \"double3\" 0 0.41132438010641481 -2.44232995884901705"
		...
		"translate" " -type \"double3\" 0 -1.77467195229354435 0.76333849151312572"
...
createNode animCurveTL -n "Bony_rFootIKC_translateY";
	...
	setAttr -s 10 ".ktv[0:9]"  1 0.012282282814967807 2 0 3 -0.58476625725339648
		 ...
		 8 -3.3280237856130945 9 -1.7783290624951058 10 -1.7746719522935444;
...
createNode animCurveTL -n "Bony_rFootIKC_translateZ";
	...
	setAttr -s 10 ".ktv[0:9]"  1 -1.2537231280940722 2 -1.2537231280940722
		 ...
		 7 2.4522105230982816 8 2.8381843360198475 9 2.4264672422953701 10 0.76333849151312572;
	setAttr -s 10 ".kit[7:9]"  1 1 1;
	setAttr -s 10 ".kot[7:9]"  1 1 1;
...
createNode animCurveTL -n "Bony_lFootIKC_translateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  1 3.4763080086242977 2 1.7651639573053246
		 3 1.7651639573053246 4 1.7651639573053246 5 2.2689921052156117 6 1.2104602440054344
		 7 -0.099615376470302719 8 -0.16497031864877354 9 -0.084217385844987724 10 0.34056927734403297
		 11 0.41132438010641481;
...
createNode animCurveTL -n "Bony_lFootIKC_translateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  1 -2.7744636900620847 2 -2.3219534951234859
		 3 -0.48010256570510346 4 0.68042025815902063 5 1.6235415354750056 6 2.8979469635612554
		 7 2.4886517544504625 8 1.8537050362518761 9 1.5337285532381206 10 -2.0642373243465117
		 11 -2.442329958849017;
	setAttr -s 11 ".kit[7:10]"  1 1 1 18;
	setAttr -s 11 ".kot[7:10]"  1 1 1 18;
	setAttr -s 11 ".kix[7:10]"  1 0.036296997751664187 0.027745130794832529 
		1;
	setAttr -s 11 ".kiy[7:10]"  0 0.99934104686749248 0.9996150297575449 
		0;
	setAttr -s 11 ".kox[7:10]"  1 0.03629699775166418 0.027745130794832536 
		1;
	setAttr -s 11 ".koy[7:10]"  0 0.99934104686749248 0.99961502975754513 
		0;
...
createNode animCurveTA -n "Bony_rFootIKC_rotateZ";
	...
	setAttr -s 10 ".ktv[0:9]"  1 1.2206625605590489 2 0.12128366139886751
		 ...
		 7 -11.880460373917598 8 -4.309 9 0.60796756143132702 10 -1.638964601622813;
	setAttr -s 10 ".kit[7:9]"  1 1 1;
	setAttr -s 10 ".kot[7:9]"  1 1 1;
...
createNode animCurveTA -n "Bony_rFootIKC_rotateY";
	...
	setAttr -s 10 ".ktv[0:9]"  1 -1.2610312414198932 2 4.3055038025887571
		 ...
		 7 0.60248564115012759 8 12.455 9 -6.386503293089782 10 -7.613016091255731;
	setAttr -s 10 ".kit[7:9]"  1 1 1;
	setAttr -s 10 ".kot[7:9]"  1 1 1;
	setAttr -s 10 ".kix[7:9]"  1 1 1;
	setAttr -s 10 ".kiy[7:9]"  0 0 0;
...
createNode animCurveTA -n "Bony_rFootIKC_rotateX";
	...
	setAttr -s 10 ".ktv[0:9]"  1 -38.213824271668919 2 -4.249730814002703
		 ...
		 7 130.60053168358391 8 127.205 9 118.81178622888335 10 92.383496468265918;
	setAttr -s 10 ".kit[7:9]"  1 1 1;
	setAttr -s 10 ".kot[7:9]"  1 1 1;
...
createNode animCurveTA -n "Bony_lFootIKC_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  1 -4.3092794044368699 2 -4.3092794044368699
...
createNode animCurveTA -n "Bony_lFootIKC_rotateY";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  1 12.455146124616089 2 12.455146124616089
...
createNode animCurveTA -n "Bony_lFootIKC_rotateX";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 11 ".ktv[0:10]"  1 127.205011589929 2 127.205011589929 3 97.272661393419156
		 4 11.420634746545719 5 -22.812193057576689 6 -32.446388499926407 7 -50.849723010717788
		 8 -46.927041657155065 9 -3.4700473396631564 10 39.498818223032416 11 32.325696797929282;
	setAttr -s 11 ".kit[7:10]"  1 1 1 18;
	setAttr -s 11 ".kot[7:10]"  1 1 1 18;
	setAttr -s 11 ".kix[7:10]"  1 1 0.041202396130081705 1;
	setAttr -s 11 ".kiy[7:10]"  0 0 -0.9991508207238482 0;
	setAttr -s 11 ".kox[7:10]"  1 1 0.041202396130081718 1;
	setAttr -s 11 ".koy[7:10]"  0 0 -0.99915082072384842 0;
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "6925C133-BC49-B001-F946-D99B261FD060";
