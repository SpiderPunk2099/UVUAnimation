...
//Name: sing.ma
//Last modified: Wed, Mar 04, 2026 05:15:44 PM
//Codeset: UTF-8
...
fileInfo "UUID" "91F012AD-C248-37B8-9C20-78952E6B07B0";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "B3C03EE3-E043-58AF-DAE3-8292950F945F";
	setAttr -s 7 ".lnk";
	setAttr -s 7 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "56C07D88-1048-0398-378E-E9901E02BE66";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "502B7760-5044-BE42-5D99-F7A595B8CA69";
createNode displayLayerManager -n "layerManager";
	rename -uid "A44788D7-3F44-5DB5-7B47-4CB8BC7BCDAA";
createNode displayLayer -n "defaultLayer";
	rename -uid "243B7A9F-D743-46F0-8B1B-1793372923CC";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "E10C4F98-624C-46F0-DDFE-F6A611862BF4";
...
createNode reference -n "SkeletonRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"rotate" " -type \"double3\" -24.31093296103781398 0 0"
		2 "|Skeleton:Skeleton_Asset|Skeleton:Controls|Skeleton:Transform_Ctrl_Grp|Skeleton:Transform_Ctrl|Skeleton:COG_Ctrl_Grp|Skeleton:COG_Ctrl|Skeleton:Redundancy_Controls|Skeleton:Chest_Redundancy_Ctrl_Grp|Skeleton:Chest_Redundancy_Ctrl" 
		"rotatePivotTranslate" " -type \"double3\" 0 0 0"
...
createNode animCurveTA -n "R_Arm_02_FK_Ctrl_rotateZ";
	...
	setAttr ".tan" 18;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  2 129.55490057062977 17 112.02394210368159;
	setAttr -s 2 ".kot[0:1]"  9 9;
...
createNode animCurveTA -n "Hip_Ctrl_rotateY";
	...
	setAttr -s 5 ".ktv[0:4]"  2 -15.160544954341814 6 -15.160544954341814
		 7 -22.361839430088935 14 -3.4894892938461881 17 -3.4894892938461881;
...
connectAttr "L_Arm_02_FK_Ctrl_rotateY.o" "SkeletonRN.phl[15]";
connectAttr "L_Arm_02_FK_Ctrl_rotateZ.o" "SkeletonRN.phl[16]";
...
connectAttr "R_Arm_02_FK_Ctrl_rotateY.o" "SkeletonRN.phl[23]";
connectAttr "R_Arm_02_FK_Ctrl_rotateZ.o" "SkeletonRN.phl[24]";
