...
//Last modified: Wed, Oct 29, 2025 11:32:06 AM
//Codeset: UTF-8
...
fileInfo "UUID" "1CE2F474-6A41-EE62-432B-4CAD63056586";
createNode transform -s -n "persp";
	rename -uid "C990E903-B14B-8259-EF2C-D998E960F101";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 24.079986801279553 9.3946581206739026 11.232557056905071 ;
	setAttr ".r" -type "double3" -19.199999999997793 63.19999999999748 -1.0581214612951988e-14 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 28.566770798572581;
	setAttr ".ow" 0.1;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "453BA525-C54A-DE8E-13C5-C6B43E132878";
	setAttr -s 6 ".lnk";
	setAttr -s 6 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "7979B2A0-E14E-8194-AD79-079B506FAF18";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "B3D22EB5-E04C-AB16-F9AC-26B277D52085";
createNode displayLayerManager -n "layerManager";
	rename -uid "87BD804F-8446-02F1-AE9C-5AB34E121080";
createNode displayLayer -n "defaultLayer";
	rename -uid "D4108135-FD4A-8DD6-0C92-BE9E115A4424";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "C0BCF0C9-8840-9494-053E-D2AF5FB81EF0";
...
createNode reference -n "lilGuyRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"lilGuyRN" 0
		"lilGuyRN" 4
		2 "|lilGuy:pCube2" "translate" " -type \"double3\" 5.21608267919904733 4.81222104868287381 0"
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "5704B388-0E4E-90BB-4720-DCAC5128B896";
