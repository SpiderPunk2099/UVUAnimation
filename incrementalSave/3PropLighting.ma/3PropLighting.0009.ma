...
//Last modified: Wed, Oct 29, 2025 04:05:37 PM
//Codeset: UTF-8
...
fileInfo "UUID" "01E7B1EE-5545-AD2B-5049-27A82DD9DB47";
createNode transform -s -n "persp";
	rename -uid "C990E903-B14B-8259-EF2C-D998E960F101";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 36.704212391073249 16.014620127834224 24.900030981927912 ;
	setAttr ".r" -type "double3" -15.600000000020266 56.800000000001255 1.4521403853499001e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 49.086097330622486;
	setAttr ".ow" 0.1;
...
createNode transform -n "pPlane1";
	...
	setAttr ".t" -type "double3" 0 0.33335395748092539 0 ;
...
createNode transform -n "spotLight1";
	...
	setAttr ".t" -type "double3" 7.7180572250600061 7.6310736742669052 17.157919196293022 ;
	setAttr ".r" -type "double3" -18.301256219201598 -4.5461886602242725 -30.123915638121478 ;
	setAttr ".s" -type "double3" 151.28314092755417 151.28314092755417 151.28314092755417 ;
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "CCC93EF4-CB41-FA2B-2142-50932E76E198";
