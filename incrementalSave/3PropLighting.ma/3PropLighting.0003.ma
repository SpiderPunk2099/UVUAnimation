...
//Last modified: Wed, Oct 29, 2025 12:13:58 PM
//Codeset: UTF-8
...
fileInfo "UUID" "45903706-2242-E69B-B9B0-E59EDB5D98E2";
createNode transform -s -n "persp";
	rename -uid "C990E903-B14B-8259-EF2C-D998E960F101";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 10.024021106671748 6.5370975791655068 9.1454053550854333 ;
	setAttr ".r" -type "double3" -17.99999999999233 42.399999999995941 2.153518639845983e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".fcp" 100;
	setAttr ".fd" 0.05;
	setAttr ".coi" 15.567063203534206;
	setAttr ".ow" 0.1;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "E525895A-2243-8F7A-59A8-0C9DEB49A8E9";
	setAttr -s 7 ".lnk";
	setAttr -s 7 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "067FBC94-3A4A-5BE3-86D7-FBA051A3B7AF";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "281C438F-294A-42FD-B58E-89B1C93904B7";
createNode displayLayerManager -n "layerManager";
	rename -uid "B14ED8A4-3A48-991B-8B63-709F42279AFD";
createNode displayLayer -n "defaultLayer";
	rename -uid "D4108135-FD4A-8DD6-0C92-BE9E115A4424";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "DE563292-0140-DC7C-0462-F7A0ECF1CB29";
...
createNode reference -n "lilGuyRN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		"lilGuyRN" 0
		"lilGuyRN" 10
		2 "|lilGuy:pCube2" "translate" " -type \"double3\" 5.59654765145927957 4.81222104868287381 0.38809317565630419"
		...
		"-na"
		5 0 "lilGuyRN" "|lilGuy:pCube2|lilGuy:pCubeShape2.instObjGroups" "lilGuy:set1.dagSetMembers" 
		"lilGuyRN.placeHolderList[1]" "lilGuyRN.placeHolderList[2]" ":initialShadingGroup.dsm";
	setAttr ".ptag" -type "string" "";
lockNode -l 1 ;
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "A67747FA-A140-7916-8F20-19ACF7840B21";
...
connectAttr "lilGuyRN.phl[1]" "lilGuyRN.phl[2]";
